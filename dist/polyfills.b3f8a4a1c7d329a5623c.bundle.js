  ...
  [1],
  {
      ...
      t.exports = function(t, e, n, d, g, y) {
        ...
        if (
          ...
          D ||
            ...
            (b.constructor = _)),
            (S || x) && (T('delete'), T('has'), g && T('get')),
            (x || O) && T(m),
            y && b.clear && delete b.clear;
        } else
          (_ = d.getConstructor(e, t, g, m)), a(_.prototype, n), (u.NEED = !0);
        return (
          h(_, t),
          (w[t] = _),
          o(o.G + o.W + o.F * (_ != k), w),
      ...
      var r = n('OzIq'),
        ...
        c = function(t, e, n) {
          var s,
            ...
            g = t & c.P,
            y = t & c.B,
            k = v ? r : d ? r[e] || (r[e] = {}) : (r[e] || {}).prototype,
            _ = v ? o : o[e] || (o[e] = {}),
            m = _.prototype || (_.prototype = {});
          for (s in (v && (n = e), n))
            (l = ((f = !h && k && void 0 !== k[s]) ? k : n)[s]),
              (p =
                y && f
                  ? u(l, r)
                  : g && 'function' == typeof l
    ...
    ZDXm: function(t, e, n) {
      ...
      var r,
        ...
        k = (t.exports = n('0Rih')('WeakMap', g, y, c, !0, !0));
      f(function() {
          ...
          Zone.__load_patch('ZoneAwarePromise', function(t, e, n) {
            ...
            function P(t, r, i) {
              ...
              if (t[d] === b) {
                ...
                if (
                  ...
                  Z(i), P(t, i[d], i[g]);
                else if (r !== T && 'function' == typeof c)
                  try {
                    c.call(i, u(O(t, r)), u(O(t, !1)));
                  } catch (e) {
                    u(function() {
                      P(t, !1, e);
                    })();
            ...
            (R && !R.configurable) ||
              ...
              (R.set = function(e) {
                e === I
                  ? (t[M] = e)
                  : ((t[u] = e), e.prototype[c] || q(e), n.setNativePromise(e));
              }),
              o(t, 'Promise', R)),
              (t.Promise = I);
            var L,
          ...
          function P(t, r, o) {
            ...
            if (i && i.configurable) {
              ...
              var a = i.get,
                ...
                c = r.substr(2),
                s = D[c];
              s || (s = D[c] = d('ON_PROPERTY' + c)),
                (i.set = function(e) {
                  var n = this;
                  (n || t !== k || (n = k), n) &&
                    (n[s] && n.removeEventListener(c, x),
                    u && u.apply(n, m),
                    'function' == typeof e
                      ? ((n[s] = e), n.addEventListener(c, x, !1))
                      : (n[s] = null));
                }),
                (i.get = function() {
                  var e = this;
                      ...
                      if (!u || u(e, h, s, arguments)) {
                        ...
                        if (j)
                          for (var _ = 0; _ < j.length; _++)
                            if (g === j[_]) return e.apply(this, arguments);
                        var m = !1;
                        void 0 === y
                          ? (d = !1)
                          : !0 === y
                ...
                (w[s] = function() {
                  ...
                  if (n) {
                    ...
                    if (r) {
                      ...
                      if (c)
                        for (p = c.slice(), g = 0; g < p.length; g++) {
                          var v;
                          h = (v = p[g]).originalDelegate
                            ? v.originalDelegate
                            : v.callback;
                          this[i].call(this, n, h, v.options);
                        }
                        ...
                        (n.WebSocket = function(t, n) {
                          ...
                          return (
                            l && !1 === l.configurable
                              ...
                              : (c = f),
                            z(c, ['close', 'error', 'message', 'open'], s),
                            c
                          );
                        });
                      var c = n.WebSocket;
                ...
                var _ = I(e, 'open', function() {
                  ...
                  m = I(e, 'send', function() {
                    return function(t, e) {
                      ...
                      return v('XMLHttpRequest.send', y, n, g, k);
                    };
                  }),
                  b = I(e, 'abort', function() {
                    return function(t) {
                      var e = t[n];
      ...
      ((e = t.exports = function(t, e, n, l, p) {
        ...
        if (i(y)) {
          ...
          for (d = y.call(t); !(v = d.next()).done; )
            if ((g = o(d, k, v.value, e)) === s || g === f) return g;
      }).BREAK = s),
        (e.RETURN = f);
    },
    vsh6: function(t, e, n) {
