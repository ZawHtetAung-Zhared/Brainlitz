...
!(function(e, t) {
  ...
  function x(e) {
    return (
      /\w/.test(e) ||
      (e > '\x80' && (e.toUpperCase() != e.toLowerCase() || Ja.test(e)))
    );
  }
  function k(e, t) {
  ...
  function T(e, t, n) {
    ...
    (o.mover = r('div', [a], null, 'position: relative')),
      ...
      Sa || (ya && Ea) || (o.scroller.draggable = !0),
  ...
  function j(e, t, n) {
    if ((void 0 === n && (n = null), !(this instanceof j)))
      return new j(e, t, n);
  ...
  function B(e, t) {
    ...
    return t.line > n
      ? j(n, M(e, n).text.length)
      : q(t, M(e, t.line).text.length);
  }
  function q(e, t) {
    var n = e.ch;
    ...
    if (e)
      for (var i = 0; i < e.length; ++i) {
        ...
        if (
          ...
          (r || (r = [])).push(
            new V(a, l ? null : o.from - t, null == o.to ? null : o.to - t)
          );
        }
      }
    return r;
    ...
    if (s)
      for (var p = 0; p < s.length; ++p) {
        ...
        if ((null != g.to && (g.to += u), null == g.from))
          G(l, g.marker) || ((g.from = u), c && (l || (l = [])).push(g));
    ...
    if (!c) {
      ...
      if (b > 0 && l)
        for (var x = 0; x < l.length; ++x)
          null == l[x].to &&
            (y || (y = [])).push(new V(l[x].marker, null, null));
  ...
  function ke(e) {
    var t = e.display,
      n = e.doc;
    (t.maxLine = M(n, n.first)),
      (t.maxLineLength = xe(t.maxLine)),
      (t.maxLineChanged = !0),
      n.iter(function(e) {
        var n = xe(e);
  ...
  function Ce(e, t, n) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && 'before' == n ? (r = i) : (rl = i)),
        o.from == t && (o.from != o.to && 'before' != n ? (r = i) : (rl = i));
    }
    return null != r ? r : rl;
  }
  function Se(e, t) {
    ...
    if (null == Ua) {
      ...
      n(e, r('span', [t, document.createTextNode('x')])),
        0 != e.firstChild.offsetHeight &&
          (Ua = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(wa && Ca < 8));
    }
    var i = Ua
      ? r('span', '\u200b')
      : r(
  ...
  function Qe(e, t, n, r) {
    ...
    for (o.start = o.pos = r || 0, '' == t && Je(i, n.state); !o.eol(); )
      et(i, o, n.state), (o.start = o.pos);
  }
  function Je(e, t) {
  ...
  function tt(e, t, n, r) {
    ...
    for (r && (o = []); (r || u.pos < t.ch) && !u.eol(); )
      (u.start = u.pos),
        (i = et(l, u, c.state)),
        r && o.push(new yl(u, i, Ke(a.mode, c.state)));
    ...
    for ('' == t && nt(Je(n, r.state), o); !f.eol(); ) {
      if (
        (f.pos > e.options.maxHighlightLength
          ? ((l = !1), a && Qe(e, t, r, f.pos), (f.pos = t.length), (s = null))
          : (s = nt(et(n, f, r.state, d), o)),
        d)
      ) {
        var h = d[0].name;
        h && (s = 'm-' + (s ? h + ' ' + s : h));
  ...
  function it(e, t, n) {
    for (
      ...
      if (
        c &&
        (!n || l + (c instanceof gl ? c.lookAhead : 0) <= o.modeFrontier)
      )
        return l;
    ...
    for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
      ...
      (r.pos = 0),
        ...
        We(e.display.measure) &&
          (l = Se(a, e.doc.direction)) &&
          (r.addToken = ht(r.addToken, l)),
        (r.map = []),
        mt(a, r, Ye(e, a, t != e.display.externalMeasured && N(a))),
        a.styleClasses &&
          (a.styleClasses.bgClass &&
            (r.bgClass = s(a.styleClasses.bgClass, r.bgClass || '')),
          a.styleClasses.textClass &&
            (r.textClass = s(a.styleClasses.textClass, r.textClass || ''))),
        0 == r.map.length &&
          r.map.push(0, 0, r.content.appendChild(_e(e.display.measure))),
        0 == o
  ...
  function ft(e, t, n, i, o, a, l) {
    if (t) {
      var s,
        c = e.splitSpaces ? dt(t, e.trailingSpace) : t,
      ...
      if (u.test(t)) {
        ...
        for (var d = 0; ; ) {
          ...
          if (m) {
            ...
            wa && Ca < 9 ? s.appendChild(r('span', [g])) : s.appendChild(g),
          ...
          if ('\t' == h[0]) {
            var y = e.cm.options.tabSize,
              b = y - (e.col % y);
            (v = s.appendChild(r('span', p(b), 'cm-tab'))).setAttribute(
              'role',
              'presentation'
            ),
            ...
            '\r' == h[0] || '\n' == h[0]
              ? ((v = s.appendChild(
                ...
                (e.col += 1))
              : ((v = e.cm.options.specialCharPlaceholder(h[0])).setAttribute(
                  'cm-text',
                  h[0]
                ),
                wa && Ca < 9 ? s.appendChild(r('span', [v])) : s.appendChild(v),
                (e.col += 1));
  ...
  function mt(e, t, n) {
    ...
    if (r)
      for (
        var a, l, s, c, u, f, d, h = i.length, p = 0, m = 1, g = '', v = 0;
        ;
          ...
          for (var y = [], b = void 0, x = 0; x < r.length; ++x) {
            ...
            'bookmark' == w.type && k.from == p && w.widgetNode
              ...
              ? (null != k.to &&
                ...
                w.endStyle &&
                  k.to == v &&
                  (b || (b = [])).push(w.endStyle, k.to),
                w.title && !f && (f = w.title),
                w.collapsed && (!d || ae(d.marker, w) < 0) && (d = k))
              : k.from > p && v > k.from && (v = k.from);
          }
          if (b)
      ...
      for (var z = 1; z < n.length; z += 2)
        t.addToken(t, i.slice(o, (o = n[z])), st(n[z + 1], t.cm.options));
  }
  function gt(e, t, n) {
    (this.line = t),
      (this.rest = pe(t)),
      (this.size = this.rest ? N(m(this.rest)) - n + 1 : 1),
  ...
  function yt(e) {
    Cl
      ? Cl.ops.push(e)
      : (e.ownsGroup = Cl = { ops: [e], delayedCallbacks: [] });
  }
  function bt(e) {
  ...
  function kt(e, t) {
    ...
    if (n.length) {
      ...
      Cl
        ? (r = Cl.delayedCallbacks)
        : Sl
        ? (r = Sl)
        : ((r = Sl = []), setTimeout(wt, 0));
      for (
        var o = function(e) {
            r.push(function() {
  ...
  function Mt(e, t) {
    ...
    t.text == t.node && (t.node = r.pre),
      ...
      r.bgClass != t.bgClass || r.textClass != t.textClass
        ? ((t.bgClass = r.bgClass), (t.textClass = r.textClass), zt(e, t))
    ...
    if (t.widgets)
      for (var a = St(n), l = 0, s = t.widgets; l < s.length; ++l) {
        ...
        c.handleMouseEvents || u.setAttribute('cm-ignore-events', 'true'),
          ...
          o && c.above
            ? a.insertBefore(u, n.gutter || n.text)
            : a.appendChild(u),
          kt(c, 'redraw');
      }
  }
    ...
    return (
      t.cache.hasOwnProperty(a)
        ...
        : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
          ...
          (o = Qt(e, t, n, r)).bogus || (t.cache[a] = o)),
      {
        left: o.left,
        right: o.right,
        top: i ? o.rtop : o.top,
    ...
    if (3 == a.nodeType) {
      for (var u = 0; u < 4; u++) {
        ...
        for (
          ...
          C(t.line.text.charAt(o.coverStart + s));

        )
          ++s;
        if (
          (i =
            wa && Ca < 9 && 0 == l && s == o.coverEnd - o.coverStart
              ? a.parentNode.getBoundingClientRect()
              : Zt(_a(a, l, s).getClientRects(), r)).left ||
          i.right ||
          0 == l
        )
          break;
  ...
  function an(e) {
    ...
    if (e.widgets)
      for (var n = 0; n < e.widgets.length; ++n)
        e.widgets[n].above && (t += jt(e.widgets[n]));
    return t;
  }
  function ln(e, t, n, r, i) {
    ...
    var a = be(t);
    if (
      ('local' == r ? (a += Dt(e.display)) : (a -= e.display.viewOffset),
      'page' == r || 'window' == r)
    ) {
  ...
  function hn(e, t, n) {
    ...
    var i = P(r, n),
      o = r.first + r.size - 1;
    if (i > o)
      return dn(r.first + r.size - 1, M(r, o).text.length, null, !0, 1);
    t < 0 && (t = 0);
    for (var a = M(r, i); ; ) {
      var l = vn(e, a, i, t, n),
    ...
    var l = L(
        function(l) {
          ...
          return gn(
            un(
              e,
              j(n, c ? s.to : s.from, c ? 'before' : 'after'),
              'line',
              t,
              r
            ),
  ...
  function xn(e) {
    ...
    if (null == xl) {
      xl = r('pre');
      for (var i = 0; i < 49; ++i)
        xl.appendChild(document.createTextNode('x')), xl.appendChild(r('br'));
  ...
  function Tn(e, t, n, r) {
    ...
    if (r && 1 == c.xRel && (s = M(e.doc, c.line).text).length == c.ch) {
      ...
      c = j(
        c.line,
        Math.max(0, Math.round((o - Wt(e.display).left) / kn(e.display)) - u)
      );
    }
    return c;
  }
    ...
    for (
      ...
      if (t || a != n.sel.primIndex) {
        ...
        if (
          ...
          var s = l.empty();
          (s || e.options.showCursorWhenSelecting) && On(e, l.head, i),
            s || Pn(e, l, o);
        }
      }
    return r;
  ...
  function On(e, t, n) {
    ...
    if (
      ...
      var a = n.appendChild(
        r('div', '\xa0', 'CodeMirror-cursor CodeMirror-secondarycursor')
      );
      (a.style.display = ''),
  ...
  function Pn(e, t, n) {
    ...
    function o(t, n, r) {
      ...
      var s,
        ...
        m = Se(h, l.direction);
      return (
        we(m, n || 0, null == r ? p : r, function(e, t, l, h) {
          var g = 'ltr' == l,
            v = o(e, g ? 'left' : 'right'),
          ...
          if (y.top - v.top <= 3) {
            ...
            g
              ...
              : ((T = d ? a(e, l, 'before') : u),
                ...
                (z = !d && x && w ? u : y.left),
                (A = d ? a(t, l, 'after') : f)),
              i(T, v.top, M - T, v.bottom),
              v.bottom < y.top && i(u, v.bottom, null, y.top),
              i(z, y.top, A - z, y.bottom);
          }
          (!s || Nn(v, s) < 0) && (s = v),
            Nn(y, s) < 0 && (s = y),
            (!c || Nn(v, c) < 0) && (c = v),
  ...
  function Dn(e, t) {
    e.state.delayingBlurEvent ||
      (e.state.focused &&
        (Me(e, 'blur', e, t),
        (e.state.focused = !1),
        Ha(e.display.wrapper, 'CodeMirror-focused')),
  ...
  function _n(e) {
    for (
      ...
      if (!i.hidden) {
        ...
        if (
          (o < 2 && (o = xn(t)),
          (s > 0.005 || s < -0.005) && (O(i.line, o), Wn(i.line), i.rest))
        )
  ...
  function Rn(e, t, n) {
    ...
    if (n && n.ensure) {
      var l = n.ensure.from.line,
        s = n.ensure.to.line;
      l < o
        ? ((o = l), (a = P(t, be(M(t, l)) + e.wrapper.clientHeight)))
        : Math.min(s, t.lastLine()) >= a &&
          ((o = P(t, be(M(t, s)) - e.wrapper.clientHeight)), (a = s));
    }
    ...
    if (!ze(e, 'scrollCursorIntoView')) {
      ...
      if (
        ...
        var a = r(
          ...
          null,
          'position: absolute;\n                         top: ' +
            (t.top - n.viewOffset - Dt(e.display)) +
            'px;\n                         height: ' +
            (t.bottom - t.top + Rt(e) + n.barHeight) +
            'px;\n                         left: ' +
            t.left +
            'px; width: ' +
    ...
    null == r && (r = 0),
      e.options.lineWrapping ||
        ...
        (n =
          'before' ==
          (t = t.ch
            ? j(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after')
            : t).sticky
            ? j(t.line, t.ch + 1, 'before')
            : t);
    for (var o = 0; o < 5; o++) {
      var a = !1,
        l = un(e, t),
      ...
      if (
        (null != c.scrollTop &&
          (Jn(e, c.scrollTop), Math.abs(e.doc.scrollTop - u) > 1 && (a = !0)),
        null != c.scrollLeft &&
          (tr(e, c.scrollLeft), Math.abs(e.doc.scrollLeft - f) > 1 && (a = !0)),
        !a)
      )
        break;
    }
  ...
  function $n(e, t) {
    ...
    null != n.scrollTop && Jn(e, n.scrollTop),
      null != n.scrollLeft && tr(e, n.scrollLeft);
  }
  function Kn(e, t) {
    var n = e.display,
      r = xn(e.display);
  ...
  function Zn(e) {
    ...
    t &&
      ...
      Qn(e, fn(e, t.from), fn(e, t.to), t.margin));
  }
  function Qn(e, t, n, r) {
    var i = Kn(e, {
  ...
  function Jn(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (ya || Nr(e, { top: t }), er(e, t, !0), ya && Nr(e), Sr(e, 100));
  }
  function er(e, t, n) {
    (t = Math.min(
  ...
  function rr(e, t) {
    ...
    for (
      ...
      n != e.display.barWidth && e.options.lineWrapping && _n(e),
        ir(e, nr(e)),
  ...
  function or(e) {
    e.display.scrollbars &&
      ...
      e.display.scrollbars.addClass &&
        Ha(e.display.wrapper, e.display.scrollbars.addClass)),
      (e.display.scrollbars = new zl[e.options.scrollbarStyle](
        function(t) {
    ...
    e.updatedDisplay && _n(t),
      ...
      n.maxLineChanged &&
        ...
        (e.barMeasure.scrollWidth = Math.max(
          ...
          n.sizer.offsetLeft + e.adjustWidthTo + Rt(t) + t.display.barWidth
        )),
        (e.maxScrollLeft = Math.max(
          0,
          n.sizer.offsetLeft + e.adjustWidthTo - Ht(t)
        ))),
  ...
  function dr(e) {
    ...
    null != e.adjustWidthTo &&
      ...
      e.maxScrollLeft < t.doc.scrollLeft &&
        tr(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
    ...
    e.preparedSelection &&
      ...
      (e.updatedDisplay || e.startHeight != t.doc.height) &&
        rr(t, e.barMeasure),
      e.updatedDisplay && Fr(t, e.barMeasure),
      e.selectionChanged && En(t),
  ...
  function hr(e) {
    ...
    null != e.scrollTop && er(t, e.scrollTop, e.forceScroll),
    ...
    e.scrollToPos) &&
      qn(
        ...
        Un(
          t,
          B(r, e.scrollToPos.from),
          B(r, e.scrollToPos.to),
  ...
  function yr(e, t, n, r) {
    ...
    if (
      ...
      nl && me(e.doc, t) < i.viewTo && xr(e);
    else if (n <= i.viewFrom)
      nl && ge(e.doc, n + r) > i.viewFrom
        ? xr(e)
  ...
  function kr(e, t, n, r) {
    var i,
      o = Mn(e, t),
      a = e.display.view;
    if (!nl || n == e.doc.first + e.doc.size) return { index: o, lineN: n };
  ...
  function wr(e, t, n) {
    ...
    0 == r.view.length || t >= r.viewTo || n <= r.viewFrom
      ? ((r.view = vt(e, t, n)), (r.viewFrom = t))
      : (r.viewFrom > t
          ? (r.view = vt(e, t, r.viewFrom).concat(r.view))
          : r.viewFrom < t && (r.view = r.view.slice(Mn(e, t))),
        (r.viewFrom = t),
        r.viewTo < n
          ? (r.view = r.view.concat(vt(e, r.viewTo, n)))
          : r.viewTo > n && (r.view = r.view.slice(0, Mn(e, n)))),
      (r.viewTo = n);
  }
  function Cr(e) {
  ...
  function Sr(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, c(Lr, e));
  }
  function Lr(e) {
    var t = e.doc;
      ...
      t.iter(
        ...
        function(o) {
          if (r.line >= e.display.viewFrom) {
            ...
            o.text.length <= e.options.maxHighlightLength && Qe(e, o.text, r),
  ...
  function Ar(e, n) {
    ...
    r.viewFrom < a &&
      a - r.viewFrom < 20 &&
      (a = Math.max(i.first, r.viewFrom)),
      r.viewTo > l && r.viewTo - l < 20 && (l = Math.min(o, r.viewTo)),
      nl && ((a = me(e.doc, a)), (l = ge(e.doc, l)));
    var s =
      a != r.viewFrom ||
      l != r.viewTo ||
    ...
    wr(e, a, l),
      (r.viewOffset = be(M(e.doc, r.viewFrom))),
    ...
    return (
      ...
      Pr(e, r.updateLineNumbers, n.dims),
  ...
  function Or(e, t) {
    for (
      ...
      ((r && e.options.lineWrapping && t.oldDisplayWidth != Ht(e)) ||
        (n &&
          null != n.top &&
          (n = { top: Math.min(e.doc.height + _t(e.display) - Bt(e), n.top) }),
        (t.visible = Rn(e.display, e.doc, n)),
        !(
  ...
  function Pr(e, n, r) {
    function i(t) {
      var n = t.nextSibling;
      return (
        Sa && Fa && e.display.currentWheelTarget == t
    ...
    for (
      ...
      if (h.hidden);
        ...
        h.changes && (d(h.changes, 'gutter') > -1 && (p = !1), Ct(e, h, u, r)),
          p &&
            (t(h.lineNumber),
            h.lineNumber.appendChild(document.createTextNode(F(e.options, u)))),
  ...
  function Wr(e, t) {
    ...
    if ((r && l) || (i && s)) {
      ...
      if (r && !ya && !Ma && null != Pl)
        return (
          i && s && Jn(e, Math.max(0, a.scrollTop + i * Pl)),
          tr(e, Math.max(0, a.scrollLeft + r * Pl)),
          (!i || (i && s)) && Pe(t),
  ...
  function Br(e) {
    return e.text
      ? j(
          ...
          m(e.text).length + (1 == e.text.length ? e.from.ch : 0)
        )
      : e.to;
  }
  function qr(e, t) {
  ...
  function Yr(e, t, n, r) {
    ...
    if (t.full)
      ...
      if (1 == c.length)
        o(u, u.text.slice(0, l.ch) + d + u.text.slice(s.ch), h);
      else {
        var v = a(1, c.length - 1);
        v.push(new bl(d + u.text.slice(s.ch), h, r)),
  ...
  function ni(e, t) {
    var n = { from: _(t.from), to: Br(t), text: z(e, t.from, t.to) };
    return (
      ci(e, n, t.from.line, t.to.line + 1),
      Zr(
        e,
        function(e) {
  ...
  function oi(e, t, n, r) {
    ...
    if (
      ...
      (a = m(o.changes)),
        0 == I(t.from, t.to) && 0 == I(t.from, a.to)
          ? (a.to = Br(t))
          : o.changes.push(ni(e, t));
    else {
      var s = m(i.done);
      for (
        (s && s.ranges) || si(e.sel, i.done),
  ...
  function mi(e, t, n, r, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      ki(e, new El([pi(e.sel.primary(), t, n, i)], 0), r);
  }
  function gi(e, t, n) {
    for (
    ...
    var r = {
      ...
      update: function(t) {
        ...
        for (var r = 0; r < t.length; r++)
          n.ranges[r] = new Fl(B(e, t[r].anchor), B(e, t[r].head));
      },
      origin: n && n.origin
    };
    return (
      ...
      r.ranges != t.ranges ? Rr(r.ranges, r.ranges.length - 1) : t
    );
  }
  function xi(e, t, n) {
  ...
  function wi(e, t, n) {
    (Oe(e, 'beforeSelectionChange') ||
      (e.cm && Oe(e.cm, 'beforeSelectionChange'))) &&
      (t = bi(e, t, n)),
      Ci(
        e,
        Li(
      ...
      (n && !1 === n.scroll) || !e.cm || Gn(e.cm);
  }
  function Ci(e, t) {
    t.equals(e.sel) ||
      ((e.sel = t),
      e.cm &&
        ((e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = !0), Ae(e.cm)),
      kt(e, 'cursorActivity', e));
  }
  function Si(e) {
  ...
  function Li(e, t, n, r) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      ...
      (i || s != a.anchor || c != a.head) &&
        (i || (i = t.ranges.slice(0, o)), (i[o] = new Fl(s, c)));
    }
        ...
        if (
          ...
          if (n) {
            ...
            if (
              ((r < 0 ? s.inclusiveRight : s.inclusiveLeft) &&
                (c = zi(e, c, -r, c && c.line == t.line ? o : null)),
              c && c.line == t.line && (u = I(c, n)) && (r < 0 ? u < 0 : u > 0))
            )
              return Ti(e, c, t, r, i);
          }
          ...
          return (
            (r < 0 ? s.inclusiveLeft : s.inclusiveRight) &&
              (f = zi(e, f, r, f.line == t.line ? o : null)),
            f ? Ti(e, f, t, r, i) : null
          );
        }
      }
  ...
  function zi(e, t, n, r) {
    return n < 0 && 0 == t.ch
      ? t.line > e.first
        ? B(e, j(t.line - 1))
        : null
      : n > 0 && t.ch == (r || M(e, t.line)).text.length
  ...
  function Ni(e, t, n) {
    ...
    if (
      !(Oe(e, 'beforeChange') || (e.cm && Oe(e.cm, 'beforeChange'))) ||
      (t = Oi(e, t, !0))
    ) {
  ...
  function Pi(e, t) {
    if (1 != t.text.length || '' != t.text[0] || 0 != I(t.from, t.to)) {
      ...
      var r = [];
      Zr(e, function(e, n) {
        n || -1 != d(r, e.history) || (Ri(e.history, t), r.push(e.history)),
          ji(e, t, null, J(e, t));
      });
    }
  }
    ...
    if (!r || n) {
      ...
      if (c != l.length) {
        for (o.lastOrigin = o.lastSelOrigin = null; ; ) {
          ...
          if ((si(i, s), n && !i.equals(e.sel)))
            return void ki(e, i, { clearRedo: !1 });
          a = i;
        }
        var u = [];
        si(a, s),
        ...
        for (
          var f = Oe(e, 'beforeChange') || (e.cm && Oe(e.cm, 'beforeChange')),
            h = function(n) {
              var r = i.changes[n];
              if (((r.origin = t), f && !Oi(e, r, !1)))
                return (l.length = 0), {};
              u.push(ni(e, r));
              var o = n ? Ur(e, r) : m(l);
              ji(e, r, o, di(e, r)),
                !n && e.cm && e.cm.scrollIntoView({ from: r.from, to: Br(r) });
              var a = [];
              Zr(e, function(e, t) {
                t ||
                  -1 != d(a, e.history) ||
                  (Ri(e.history, r), a.push(e.history)),
                  ji(e, r, null, di(e, r));
              });
            },
  ...
  function ji(e, t, n, r) {
    ...
    if (t.to.line < e.first)
      ...
      t.to.line > o &&
        ...
        (t.removed = z(e, t.from, t.to)),
        n || (n = Ur(e, t)),
        e.cm ? Ii(e.cm, t, r) : Yr(e, t, r),
        wi(e, n, Xa);
    }
  }
  function Ii(e, t, n) {
  ...
  function Di(e, t, n, r, i) {
    ...
    'string' == typeof t && (t = e.splitLines(t)),
      Ni(e, { from: n, to: r, text: t, origin: i });
  }
  function _i(e, t, n, r) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var l = 0; l < o.ranges.length; l++)
          _i(o.ranges[l].anchor, t, n, r), _i(o.ranges[l].head, t, n, r);
      } else {
        for (var s = 0; s < o.changes.length; ++s) {
          var c = o.changes[s];
          if (n < c.from.line)
            (c.from = j(c.from.line + r, c.from.ch)),
              (c.to = j(c.to.line + r, c.to.ch));
          else if (t <= c.to.line) {
            a = !1;
            break;
          }
  ...
  function Hi(e, t, n, r) {
    var i = t,
      o = t;
    return (
      'number' == typeof t ? (o = M(e, H(e, t))) : (i = N(t)),
      null == i ? null : (r(o, i) && e.cm && br(e.cm, i, n), o)
    );
  }
  function Bi(e) {
    var t = this;
  ...
  function $i(e, t, n, r) {
    ...
    return (
      ...
      o && kt(o, 'lineWidgetAdded', o, i, 'number' == typeof t ? t : N(t)),
      i
    );
  }
  function Ki(e, t, n, r, o) {
    ...
    var a = new Dl(e, o),
      l = I(t, n);
    if ((r && u(r, a, !1), l > 0 || (0 == l && !1 !== a.clearWhenEmpty)))
      return a;
    if (
      (a.replacedWith &&
        ((a.collapsed = !0),
      ...
      if (
        fe(e, t.line, t, n, a) ||
        (t.line != n.line && fe(e, n.line, t, n, a))
      )
        throw new Error(
    ...
    a.addToHistory && oi(e, { from: t, to: n, origin: 'markText' }, e.sel, NaN);
    var s,
      c = t.line,
      f = e.cm;
    if (
      (e.iter(c, n.line + 1, function(e) {
        f &&
          ...
          de(e) == f.display.maxLine &&
          (s = !0),
          a.collapsed && c != t.line && O(e, 0),
          Y(e, new V(a, c == t.line ? t.ch : null, c == n.line ? n.ch : null)),
          ++c;
      }),
      a.collapsed &&
          ...
          try {
            ...
            if (c) {
              ...
              if (
                ...
                for (var f = 0; f < u.length; ++f)
                  Di(t.doc, '', u[f].anchor, u[f].head, 'drag');
  ...
  function Qi(e, t) {
    if (wa && (!e.state.draggingText || +new Date() - Hl < 100)) je(t);
      ...
      t.dataTransfer.setDragImage && !za)
    ) {
  ...
  function co(e, t, n) {
    ...
    return (
      ...
      (Wa ? t.metaKey : t.ctrlKey) && 'Ctrl' != r && (e = 'Ctrl-' + e),
      (Wa ? t.ctrlKey : t.metaKey) && 'Cmd' != r && (e = 'Cmd-' + e),
  ...
  function uo(e, t) {
    ...
    return (
      null != n &&
      !e.altGraphKey &&
      (3 == e.keyCode && e.code && (n = e.code), co(n, e, t))
    );
  }
  function fo(e) {
  ...
  function ho(e, t) {
    ...
    pr(e, function() {
      for (var t = r.length - 1; t >= 0; t--)
        Di(e.doc, '', r[t].from, r[t].to, '+delete');
      Gn(e);
    });
  }
  function po(e, t, n) {
  ...
  function vo(e, t, n, r) {
    ...
    if ('rtl' == e.doc.direction || 1 == a.level) {
      ...
      if (
        null != d &&
        (f ? d <= a.to && d <= u.end : d >= a.from && d >= u.begin)
      ) {
  ...
  function wo(e, t, n) {
    ...
    return (
      (e.options.extraKeys && lo(t, e.options.extraKeys, n, e)) ||
      lo(t, e.options.keyMap, n, e)
    );
  }
  function Co(e, t, n, r) {
  ...
  function So(e, t, n, r) {
    ...
    return (
      ...
      'handled' == i && kt(e, 'keyHandled', e, t, n),
      ('handled' != i && 'multi' != i) || (Pe(n), En(e)),
      !!i
    );
  }
  function Lo(e, t) {
  ...
  function zo(e) {
    function t(e) {
      (18 != e.keyCode && e.altKey) ||
        (Ha(n, 'CodeMirror-crosshair'),
        Te(document, 'keyup', t),
        Te(document, 'mouseover', t));
    }
  ...
  function No(e, t) {
    var n = +new Date();
    return Xl && Xl.compare(n, e, t)
      ? ((Gl = Xl = null), 'triple')
      : Gl && Gl.compare(n, e, t)
      ? ((Xl = new es(n, e, t)), (Gl = null), 'double')
      : ((Gl = new es(n, e, t)), (Xl = null), 'single');
  }
  function Po(e) {
    var t = this,
      n = t.display;
    if (!(ze(t, e) || (n.activeTouch && n.input.supportsTouch())))
      if ((n.input.ensurePolled(), (n.shift = e.shiftKey), It(n, e)))
        Sa ||
  ...
  function Eo(e, t, n, r, i) {
    ...
    return (
      ...
      Co(
        e,
        co((o = (1 == t ? 'Left' : 2 == t ? 'Middle' : 'Right') + o), i),
        i,
        function(t) {
  ...
  function Fo(e, t, n) {
    ...
    return (
      ...
      null == i.moveOnDrag && (i.moveOnDrag = !(Fa ? n.altKey : n.ctrlKey)),
      i
    );
  }
  function jo(e, t, n, r) {
    ...
    'single' == n &&
    (i = l.contains(t)) > -1 &&
    (I((i = l.ranges[i]).from(), t) < 0 || t.xRel > 0) &&
    (I(i.to(), t) > 0 || t.xRel < 0)
      ? Io(e, r, t, o)
      : _o(e, r, t, o);
  }
  function Io(e, t, n, r) {
    var i = e.display,
      o = !1,
      a = mr(e, function(t) {
        Sa && (i.scroller.draggable = !1),
          (e.state.draggingText = !1),
          Te(i.wrapper.ownerDocument, 'mouseup', a),
          Te(i.wrapper.ownerDocument, 'mousemove', l),
          Te(i.scroller, 'dragstart', s),
          Te(i.scroller, 'drop', a),
          o ||
            (Pe(t),
    ...
    Sa && (i.scroller.draggable = !0),
      (e.state.draggingText = a),
      (a.copy = !r.moveOnDrag),
      i.scroller.dragDrop && i.scroller.dragDrop(),
      al(i.wrapper.ownerDocument, 'mouseup', a),
      al(i.wrapper.ownerDocument, 'mousemove', l),
      al(i.scroller, 'dragstart', s),
      al(i.scroller, 'drop', a),
      jn(e),
      setTimeout(function() {
  ...
  function _o(e, t, n, r) {
      ...
      if (0 != I(v, t))
        if (((v = t), 'rectangle' == r.unit)) {
          for (
            var i = [],
              o = e.options.tabSize,
              a = f(M(c, n.line).text, n.ch, o),
              l = f(M(c, t.line).text, t.ch, o),
              s = Math.min(a, l),
              m = Math.max(a, l),
            ...
            var b = M(c, g).text,
              x = h(b, s, o);
            s == m
              ? i.push(new Fl(j(g, x), j(g, x)))
              : b.length > x && i.push(new Fl(j(g, x), j(g, h(b, m, o))));
          }
          i.length || i.push(new Fl(n, n)),
            ki(c, Rr(p.ranges.slice(0, d).concat(i), d), {
              origin: '*mouse',
              scroll: !1
            }),
            e.scrollIntoView(t);
          ...
          var k,
            ...
            S = w.anchor;
          I(C.anchor, S) > 0
            ? ((k = C.head), (S = R(w.from(), C.anchor)))
            : ((k = C.anchor), (S = W(w.to(), C.head)));
    ...
    function l(t) {
      (e.state.selectingText = !1),
        ...
        Pe(t),
        s.input.focus(),
        Te(s.wrapper.ownerDocument, 'mousemove', x),
        Te(s.wrapper.ownerDocument, 'mouseup', k),
    ...
    if (
      (r.addNew && !r.extend
        ? ((d = c.sel.contains(n)), (u = d > -1 ? m[d] : new Fl(n, n)))
        : ((u = c.sel.primary()), (d = c.sel.primIndex)),
      'rectangle' == r.unit)
    )
      r.addNew || (u = new Fl(n, n)), (n = Tn(e, t, !0, !0)), (d = -1);
    else {
      var g = Do(e, n, r.unit);
    ...
    r.addNew
      ? -1 == d
        ? ((d = m.length),
          ki(c, Rr(m.concat([u]), d), { scroll: !1, origin: '*mouse' }))
        : m.length > 1 && m[d].empty() && 'char' == r.unit && !r.extend
        ? (ki(c, Rr(m.slice(0, d).concat(m.slice(d + 1)), 0), {
            scroll: !1,
            origin: '*mouse'
          }),
          (p = c.sel))
        : vi(c, d, u, Ya)
      : ((d = 0), ki(c, new El([u], 0), Ya), (p = c.sel));
    var v = n,
    ...
    (e.state.selectingText = k),
      al(s.wrapper.ownerDocument, 'mousemove', x),
      al(s.wrapper.ownerDocument, 'mouseup', k);
  }
  function Wo(e, t) {
    var n = t.anchor,
      r = t.head,
  ...
  function Ro(e, t, n, r) {
    ...
    for (var s = 0; s < e.options.gutters.length; ++s) {
      ...
      if (c && c.getBoundingClientRect().right >= i)
        return Me(e, n, e, P(e.doc, o), e.options.gutters[s], t), Fe(t);
    }
  }
  function Ho(e, t) {
  ...
  function $o(e) {
    ...
    (e.defineOption = t),
      ...
      t('lineSeparator', null, function(e, t) {
        if (((e.doc.lineSep = t), t)) {
          ...
          for (var i = n.length - 1; i >= 0; i--)
            Di(e.doc, t, n[i], j(n[i].line, n[i].ch + t.length));
        }
      }),
      t(
        'specialChars',
      ...
      t('cursorHeight', 1, zn, !0),
      t('singleCursorHeightPerLine', !0, zn, !0),
      t('workTime', 100),
      t('workDelay', 100),
      t('flattenSpans', !0, Gr, !0),
      t('addModeClass', !1, Gr, !0),
      t('pollInterval', 100),
  ...
  function Go(e) {
    e.options.lineWrapping
      ...
      : (Ha(e.display.wrapper, 'CodeMirror-wrap'), ke(e)),
      Ln(e),
      yr(e),
      nn(e),
      setTimeout(function() {
  ...
  function Xo(e, t) {
    ...
    var r = t.value;
    'string' == typeof r
      ? (r = new Rl(r, t.mode, null, t.lineSeparator, t.direction))
    ...
    Qr(this, r),
    (t.autofocus && !Ea) || this.hasFocus()
      ? setTimeout(c(In, this), 20)
      : Dn(this),
    rs))
      rs.hasOwnProperty(a) && rs[a](n, t[a], ts);
  ...
  function Yo(e) {
    ...
    var i = e.display;
    al(i.scroller, 'mousedown', mr(e, Po)),
      al(
        i.scroller,
        'dblclick',
        wa && Ca < 11
      ...
      Ra ||
        al(i.scroller, 'contextmenu', function(t) {
          return Bo(e, t);
        });
    var o,
      a = { end: 0 };
    al(i.scroller, 'touchstart', function(t) {
        ...
        if (
          ...
          (a =
            !o.prev || r(o, o.prev)
              ...
              ? e.findWordAt(l)
              : new Fl(j(l.line, 0), B(e.doc, j(l.line + 1, 0)))),
      ...
      al(i.scroller, 'scroll', function() {
        i.scroller.clientHeight &&
          (Jn(e, i.scroller.scrollTop),
          tr(e, i.scroller.scrollLeft, !0),
          Me(e, 'scroll', e));
      }),
    ...
    al(l, 'keyup', function(t) {
      ...
      al(l, 'keydown', mr(e, Mo)),
      al(l, 'keypress', mr(e, Oo)),
      al(l, 'focus', function(t) {
        return In(e, t);
      }),
  ...
  function Zo(e, t, n, r) {
    var i,
      o = e.doc;
    null == n && (n = 'add'),
      'smart' == n && (o.mode.indent ? (i = Ze(e, t).state) : (n = 'prev'));
    ...
    if (r || /\S/.test(l.text)) {
      if (
        'smart' == n &&
        ((c = o.mode.indent(i, l.text.slice(u.length), l.text)) == Ga ||
          c > 150)
      ) {
        if (!r) return;
        n = 'prev';
    ...
    'prev' == n
      ? (c = t > o.first ? f(M(o, t - 1).text, null, a) : 0)
      : 'add' == n
    ...
    if ((h < c && (d += p(c - h)), d != u))
      return (
        Di(o, d, j(t, 0), j(t, u.length), '+input'), (l.stateAfter = null), !0
      );
    ...
    if (l && r.ranges.length > 1)
      if (os && os.text.join('\n') == t) {
        if (r.ranges.length % os.text.length == 0) {
          c = [];
          for (var u = 0; u < os.text.length; u++)
            c.push(o.splitLines(os.text[u]));
        }
      } else
    ...
    for (var f = r.ranges.length - 1; f >= 0; f--) {
      ...
      d.empty() &&
        (n && n > 0
          ...
          ? (p = j(
              p.line,
              Math.min(M(o, p.line).text.length, p.ch + m(s).length)
            ))
          : os &&
            os.lineWise &&
            os.text.join('\n') == t &&
          ...
          if (o.electricChars) {
            ...
            o.electricInput &&
              o.electricInput.test(
                M(e.doc, i.head.line).text.slice(0, i.head.ch)
              ) &&
              (a = Zo(e, i.head.line, 'smart'));
  ...
  function ia() {
    ...
    return (
      Sa ? (e.style.width = '1000px') : e.setAttribute('wrap', 'off'),
      Na && (e.style.border = '1px solid black'),
      ra(e),
      t
    );
  }
  function oa(e) {
    ...
    (e.prototype = {
      ...
      setOption: function(e, n) {
        ...
        (r[e] == n && 'mode' != e) ||
          ((r[e] = n),
          t.hasOwnProperty(e) && mr(this, t[e])(this, n, i),
      ...
      removeOverlay: gr(function(e) {
        for (var t = this, n = this.state.overlays, r = 0; r < n.length; ++r) {
          ...
          if (i == e || ('string' == typeof e && i.name == e))
            return n.splice(r, 1), t.state.modeGen++, void yr(t);
        }
      }),
      ...
      getStateAfter: function(e, t) {
        var n = this.doc;
        return Ze(this, (e = H(n, null == e ? n.first + n.size - 1 : e)) + 1, t)
          .state;
      },
      ...
      lineAtHeight: function(e, t) {
        return (
          (e = sn(this, { top: e, left: 0 }, t || 'page').top),
          P(this.doc, e + this.display.viewOffset)
        );
      },
      ...
      findPosH: function(e, t, n, r) {
        ...
        t < 0 && ((o = -1), (t = -t));
        for (
          var a = B(this.doc, e), l = 0;
          l < t && !(a = aa(i.doc, a, o, n, r)).hitSide;
          ++l
        );
        return a;
      },
      moveH: gr(function(e, t) {
        ...
        this.extendSelectionsBy(function(r) {
          return n.display.shift || n.doc.extend || r.empty()
            ? aa(n.doc, r.head, e, t, n.options.rtlMoveVisually)
            : e < 0
            ? r.from()
            : r.to();
        }, Za);
      ...
      toggleOverwrite: function(e) {
        (null != e && e == this.state.overwrite) ||
          ((this.state.overwrite = !this.state.overwrite)
            ...
            : Ha(this.display.cursorDiv, 'CodeMirror-overwrite'),
      ...
      scrollIntoView: gr(function(e, t) {
        null == e
          ...
          e.to || (e.to = e.from),
          (e.margin = t || 0),
          null != e.from.line ? Yn(this, e) : Qn(this, e.from, e.to, e.margin);
      }),
      setSize: gr(function(e, t) {
        ...
        null != e && (this.display.wrapper.style.width = r(e)),
          ...
          this.options.lineWrapping && tn(this);
      ...
      refresh: gr(function() {
        ...
        yr(this),
          ...
          Er(this),
          (null == e || Math.abs(e - xn(this.display)) > 0.5) && Ln(this),
          Me(this, 'refresh', this);
      }),
  ...
  function aa(e, t, n, r, i) {
    function o() {
      ...
      return (
        ...
        ((t = new j(r, t.ch, t.sticky)), (c = M(e, r)))
      );
    }
    function a(r) {
      var a;
  ...
  function la(e, t, n, r) {
    ...
    if ('page' == r) {
      var s = Math.min(
        ...
        c = Math.max(s - 0.5 * xn(e.display), 3);
      i = (n > 0 ? t.bottom : t.top) + n * c;
    } else 'line' == r && (i = n > 0 ? t.bottom + 3 : t.top - 3);
    for (; (o = hn(e, l, i)).outside; ) {
  ...
  function da(e, t, n) {
    ...
    if (t == e.display.lineDiv) {
      if (!(r = e.display.lineDiv.childNodes[n]))
        return ua(e.clipPos(j(e.display.viewTo - 1)), !0);
      (t = null), (n = 0);
    } else
  ...
  function ma(e) {
    (e.off = Te),
      ...
      (e.StringStream = ml),
      (e.SharedTextMarker = _l),
      (e.TextMarker = Dl),
      (e.LineWidget = jl),
      (e.e_preventDefault = Pe),
      (e.e_stopPropagation = Ee),
      (e.e_stop = je),
      (e.addClass = l),
      (e.contains = o),
      (e.rmClass = Ha),
  ...
  var ga = navigator.userAgent,
    ...
    Pa = /Android/.test(ga),
    Ea =
      Na || Pa || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(ga),
    Fa = Na || /Mac/.test(va),
    ja = /\bCrOS\b/.test(ga),
    Ia = /win/i.test(va),
  ...
  var Ua,
    ...
    il = (function() {
      ...
      return function(n, r) {
        ...
        for (var v = 0, y = c; v < u; ++v) {
          ...
          '1' == b && 'r' == y
            ? (f[v] = 'n')
            : a.test(b) && ((y = b), 'r' == b && (f[v] = 'R'));
        }
        for (var x = 1, k = f[0]; x < u - 1; ++x) {
          var w = f[x];
          '+' == w && '1' == k && '1' == f[x + 1]
            ? (f[x] = '1')
            : ',' != w || k != f[x + 1] || ('1' != k && 'n' != k) || (f[x] = k),
            (k = w);
        }
        for (var C = 0; C < u; ++C) {
          var S = f[C];
        ...
        return (
          'ltr' == r &&
            (1 == D[0].level &&
              (I = n.match(/^\s+/)) &&
              ((D[0].from = I[0].length), D.unshift(new t(0, 0, I[0].length))),
            1 == m(D).level &&
              (I = n.match(/\s+$/)) &&
              ((m(D).to -= I[0].length), D.push(new t(0, u - I[0].length, u)))),
          'rtl' == r ? D.reverse() : D
        );
      };
    })(),
    ...
    ul =
      'oncopy' in (Ka = r('div')) ||
      (Ka.setAttribute('oncopy', 'return;'), 'function' == typeof Ka.oncopy),
    fl = null,
    dl = {},
    hl = {},
    pl = {},
  ...
  (vl.prototype.lookAhead = function(e) {
    ...
    (vl.fromSaved = function(e, t, n) {
      return t instanceof gl
        ? new vl(e, Ke(e.mode, t.state), n, t.lookAhead)
        : new vl(e, Ke(e.mode, t), n);
    }),
    ...
    (Tl.prototype.zeroWidthHack = function() {
      ...
      (this.horiz.style.height = this.vert.style.width = e),
        (this.horiz.style.pointerEvents = this.vert.style.pointerEvents =
          'none'),
        (this.disableHoriz = new qa()),
        (this.disableVert = new qa());
    }),
  ...
  (Ml.prototype.update = function() {
    ...
    (Ml.prototype.setScrollLeft = function() {}),
    (Ml.prototype.setScrollTop = function() {}),
    (Ml.prototype.clear = function() {});
  var zl = { native: Tl, null: Ml },
    Al = 0,
    Ol = function(e, t, n) {
      var r = e.display;
      (this.viewport = t),
        (this.visible = Rn(r, e.doc, t)),
  ...
  var Nl = 0,
    Pl = null;
  wa ? (Pl = -0.53) : ya ? (Pl = 15) : Ta ? (Pl = -0.7) : za && (Pl = -1 / 3);
  var El = function(e, t) {
  ...
  (El.prototype.primary = function() {
    ...
    (El.prototype.deepCopy = function() {
      for (var e = this, t = [], n = 0; n < this.ranges.length; n++)
        t[n] = new Fl(_(e.ranges[n].anchor), _(e.ranges[n].head));
  ...
  (Fl.prototype.from = function() {
    ...
    (qi.prototype = {
      ...
      removeInner: function(e, t) {
        ...
        if (
          this.size - t < 25 &&
          (this.children.length > 1 || !(this.children[0] instanceof Bi))
        ) {
          var s = [];
          this.collapse(s),
            (this.children = [new Bi(s)]),
  ...
  (jl.prototype.clear = function() {
    ...
    (jl.prototype.changed = function() {
      ...
      var i = jt(this) - t;
      i &&
        (ve(this.doc, r) || O(r, r.height + i),
        n &&
          pr(n, function() {
            (n.curOp.forceUpdate = !0),
              Ui(n, r, i),
              kt(n, 'lineWidgetChanged', n, e, N(r));
          }));
    }),
    Ne(jl);
  var Il = 0,
  ...
  (Dl.prototype.clear = function() {
    ...
    if (!this.explicitlyCleared) {
      ...
      for (var i = null, o = null, a = 0; a < this.lines.length; ++a) {
        ...
        t && !e.collapsed
          ? br(t, N(l), 'text')
          : t && (null != s.to && (o = N(l)), null != s.from && (i = N(l))),
          (l.markedSpans = X(l.markedSpans, s)),
          null == s.from &&
            e.collapsed &&
            !ve(e.doc, l) &&
            t &&
      ...
      null != i && t && this.collapsed && yr(t, i, o + 1),
        (this.lines.length = 0),
        (this.explicitlyCleared = !0),
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t && Si(t.doc)),
        t && kt(t, 'markerCleared', t, this, i, o),
        n && lr(t),
    ...
    (Dl.prototype.find = function(e, t) {
      ...
      for (var o = 0; o < this.lines.length; ++o) {
        var a = i.lines[o],
          l = G(a.markedSpans, i);
        if (null != l.from && ((n = j(t ? a : N(a), l.from)), -1 == e))
          return n;
    ...
    (Dl.prototype.changed = function() {
      ...
      t &&
        ...
        pr(r, function() {
          ...
          if (
            (a &&
              (en(a), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
  ...
  var Wl = 0,
    Rl = function(e, t, n, r, i) {
      ...
      null == n && (n = 0),
        qi.call(this, [new Bi([new bl('', null)])]),
        (this.first = n),
  ...
  (Rl.prototype = b(qi.prototype, {
    ...
    setSelections: vr(function(e, t, n) {
      ...
      if (e.length) {
        for (var i = [], o = 0; o < e.length; o++)
          i[o] = new Fl(B(r, e[o].anchor), B(r, e[o].head));
    ...
    addSelection: vr(function(e, t, n) {
      ...
      r.push(new Fl(B(this, e), B(this, t || e))),
        ki(this, Rr(r, r.length - 1), n);
    }),
    ...
    replaceSelections: vr(function(e, t, n) {
      ...
      for (
        var s = t && 'end' != t && Kr(this, i, t), c = i.length - 1;
        c >= 0;
        c--
      )
        Ni(r, i[c]);
    ...
    clearGutter: vr(function(e) {
      ...
      this.iter(function(n) {
        n.gutterMarkers &&
          n.gutterMarkers[e] &&
          Hi(t, n, 'gutter', function() {
            return (
              (n.gutterMarkers[e] = null),
              w(n.gutterMarkers) && (n.gutterMarkers = null),
              !0
            );
          });
      });
        ...
        return pr(e, function() {
          for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
            if (t[r].empty()) {
              ...
              if (o)
                if (
                  (i.ch == o.length && (i = new j(i.line, i.ch - 1)), i.ch > 0)
                )
  ...
  (as.prototype.init = function(e) {
    ...
    ra(o, i.options.spellcheck),
      ...
      al(o, 'compositionend', function(e) {
        n.composing &&
          (e.data != n.composing.data && n.readFromDOMSoon(),
          (n.composing.done = !0));
      }),
    ...
    (as.prototype.pollSelection = function() {
      if (
        ...
        var e = this.getSelection(),
          t = this.cm;
        if (Pa && Ta && this.cm.options.gutters.length && ca(e.anchorNode))
          return (
    ...
    (as.prototype.pollContent = function() {
      ...
      if (
        (0 == a.ch &&
          a.line > r.firstLine() &&
          (a = j(a.line - 1, M(r.doc, a.line - 1).length)),
        l.ch == M(r.doc, l.line).text.length &&
          l.line < r.lastLine() &&
          (l = j(l.line + 1, 0)),
        a.line < i.viewFrom || l.line > i.viewTo - 1)
      )
        return !1;
      a.line == i.viewFrom || 0 == (e = Mn(r, a.line))
        ? ((t = N(i.view[0].line)), (n = i.view[0].node))
        : ((t = N(i.view[e].line)), (n = i.view[e - 1].node.nextSibling));
      var s,
        c,
        u = Mn(r, l.line);
      if (
        (u == i.view.length - 1
          ...
          : ((s = N(i.view[u + 1].line) - 1),
            (c = i.view[u + 1].node.previousSibling)),
        !n)
      )
        return !1;
      for (
        var f = r.doc.splitLines(fa(r, n, c, t, s)),
          d = z(r.doc, j(t, 0), j(s, M(r.doc, s).text.length));
      ...
      for (
        var h = 0, p = 0, g = f[0], v = d[0], y = Math.min(g.length, v.length);
        h < y && g.charCodeAt(h) == v.charCodeAt(h);
      ...
      return f.length > 1 || f[0] || I(w, C)
        ? (Di(r.doc, f, w, C, '+input'), !0)
        : void 0;
    }),
    ...
    function t(e) {
      if (!ze(i, e)) {
        if (i.somethingSelected())
          ...
          Qo({ lineWise: !0, text: t.text }),
            'cut' == e.type
              ? i.setSelections(t.ranges, null, Xa)
      ...
      if (!this.contextMenuPending && !this.composing) {
        ...
        if (t.somethingSelected()) {
          ...
          (this.textarea.value = n),
            t.state.focused && Ba(this.textarea),
            wa && Ca >= 9 && (this.hasSelection = n);
        } else
          e ||
            ((this.prevInput = this.textarea.value = ''),
            wa && Ca >= 9 && (this.hasSelection = null));
      }
    }),
    ...
    (ls.prototype.onContextMenu = function(e) {
      ...
      function n() {
        if (
          ...
          (a.style.cssText = c),
          wa && Ca < 9 && o.scrollbars.setScrollTop((o.scroller.scrollTop = s)),
  ...
  for (var cs in Rl.prototype)
    Rl.prototype.hasOwnProperty(cs) &&
      d(ss, cs) < 0 &&
      (Xo.prototype[cs] = (function(e) {
        return function() {
  ...
  return (
    Ne(Rl),
    (Xo.inputStyles = { textarea: ls, contenteditable: as }),
  ...
  (function(e) {
    ...
    (e.commands.toggleComment = function(e) {
        ...
        for (
          ...
          s.line >= r ||
            ...
            null == a
              ? t.uncomment(s, c, e)
                ? (a = 'un')
                : (t.blockComment(s, c, e), (a = 'block'))
              : 'un' == a
              ? t.uncomment(s, c, e)
              : t.blockComment(s, c, e));
        }
      }),
            ...
            l.operation(function() {
              if (a.indent) {
                ...
                for (o = e.line; o < u; ++o) {
                  ...
                  (d || r.test(h)) &&
                    (h.slice(0, p) != n && (p = t(h)),
                    l.replaceRange(n + c + f, i(o, 0), i(o, p)));
                }
              } else for (o = e.line; o < u; ++o) (d || r.test(l.getLine(o))) && l.replaceRange(c + f, i(o, 0));
            });
          }
        } else
          (a.blockCommentStart || s.blockCommentStart) &&
      ...
      e.defineExtension('blockComment', function(e, t, o) {
        ...
        if (
          (u && a.indentSelection('add'),
          f && a.indentLine(e.line, 'subtract'),
          s && c)
        ) {
          var d = null == o.padding ? ' ' : o.padding,
            h = Math.min(t.line, a.lastLine());
          h != e.line && 0 == t.ch && r.test(a.getLine(h)) && --h,
            e.line > h ||
              a.operation(function() {
                if (0 != o.fullLines) {
                  var n = r.test(a.getLine(h));
                  ' ' !== c && a.replaceRange(d + c, i(h)),
                    a.replaceRange(s + d, i(e.line, 0));
                  var u = o.blockCommentLead || l.blockCommentLead;
                  if (null != u)
                    for (var f = e.line + 1; f <= h; ++f)
                      (f != h || n) && a.replaceRange(u + d, i(f, 0));
                } else a.replaceRange(d + c, t), a.replaceRange(s + d, e);
              });
        } else
          (o.lineComment || l.lineComment) &&
            0 != o.fullLines &&
            a.lineComment(e, t, o);
      }),
      e.defineExtension('uncomment', function(e, t, o) {
        ...
        e: if (p) {
          for (var b = f; b <= u; ++b) {
            ...
            if (
              ...
              -1 == k && (k = x.indexOf(p)),
              k > -1 &&
                !/comment/.test(s.getTokenTypeAt(i(b, k + 1))) &&
                (k = -1),
              -1 == k && (b != u || b == f) && r.test(x))
            )
              break e;
            ...
            (s.operation(function() {
              for (var e = f; e <= u; ++e) {
                var t = y ? g : p,
                  ...
                  o = r + t.length;
                r < 0 ||
                  (n.slice(o, o + v.length) == v && (o += v.length),
                  (l = !0),
                  s.replaceRange('', i(e, r), i(e, o)));
              }
            }),
            a(),
            l)
        ...
        if (
          (-1 == A && f != u && ((M = s.getLine(--u)), (A = M.lastIndexOf(C))),
          a(),
          -1 == z ||
            (!S && -1 == A) ||
            !/comment/.test(s.getTokenTypeAt(i(f, z + 1))) ||
            (!S && !/comment/.test(s.getTokenTypeAt(i(u, A + 1)))))
        )
          return !1;
        ...
        return (
          ...
          (-1 == N || -1 == O || O == t.ch) &&
            (s.operation(function() {
              ...
              s.replaceRange(
                '',
                i(u, A - (v && M.slice(A - v.length, A) == v ? v.length : 0)),
                i(u, A + e)
              );
              var t = z + w.length;
              if (
                (v && T.slice(t, t + v.length) == v && (t += v.length),
                s.replaceRange('', i(f, z), i(f, t)),
                L)
              )
                for (var n = f + 1; n <= u; ++n) {
                  var o = s.getLine(n),
                  ...
                  if (-1 != a && !r.test(o.slice(0, a))) {
                    var l = a + L.length;
                    v && o.slice(l, l + v.length) == v && (l += v.length),
                      s.replaceRange('', i(n, a), i(n, l));
                  }
                }
            }),
            !0)
      ...
      return (
        f
          ? (f.focus(),
            ...
            !1 !== o.closeOnBlur && e.on(f, 'blur', a))
          : (l = s.getElementsByTagName('button')[0]) &&
            (e.on(l, 'click', function() {
              a(), u.focus();
            }),
            !1 !== o.closeOnBlur && e.on(l, 'blur', a),
            l.focus()),
        a
      );
    }),
  ...
  (function(e) {
    ...
    function o(n) {
      ...
      for (
        var o = t(r, 'pairs'), a = n.listSelections(), l = 0;
        l < a.length;
        l++
      ) {
    ...
    function s(n, r) {
      ...
      for (
        ...
        if (m && !y.empty()) v = 'surround';
          ...
          if (
            ...
            b.ch > 1 &&
            f.indexOf(r) >= 0 &&
            n.getRange(d(b.line, b.ch - 2), b) == r + r
          ) {
            if (
              b.ch > 2 &&
              /\bstring/.test(n.getTokenTypeAt(d(b.line, b.ch - 2)))
            )
              return e.Pass;
            v = 'addFour';
          } else if (h) {
          ...
          v =
            h && u(n, b)
              ? 'both'
              : f.indexOf(r) >= 0 &&
                n.getRange(b, d(b.line, b.ch + 3)) == r + r + r
              ? 'skipThree'
              : 'skip';
        if (c) {
      ...
      n.operation(function() {
        if ('skip' == c) n.execCommand('goCharRight');
          ...
          'both' == c
            ? (n.replaceSelection(w + C, null),
              n.triggerElectric(w + C),
              n.execCommand('goCharLeft'))
            : 'addFour' == c &&
              (n.replaceSelection(w + w + w + w, 'before'),
    ...
    var f = { pairs: '()[]{}\'\'""', triples: '', explode: '[]{}' },
      d = e.Pos;
    e.defineOption('autoCloseBrackets', !1, function(r, i, o) {
      o && o != e.Init && (r.removeKeyMap(h), (r.state.closeBrackets = null)),
        i && (n(t(i, 'pairs')), (r.state.closeBrackets = i), r.addKeyMap(h));
    });
  ...
  (function(e) {
    ...
    function t(t) {
        ...
        if (
          ...
          ('string' == f.type &&
            (f.end != u.ch ||
              ...
              1 == f.string.length)) ||
          ('tag' == f.type && 'closeTag' == h.type) ||
          f.string.indexOf('/') == f.string.length - 1 ||
          (m && i(m, y) > -1) ||
          o(t, v, u, h, !0)
        )
          return e.Pass;
      ...
      for (c = n.length - 1; c >= 0; c--) {
        ...
        (w[c] = { head: k.newPos, anchor: k.newPos }),
          t.setSelections(w),
          !x &&
            k.indent &&
    ...
    function n(t, n) {
      for (
        ...
        if (
          ...
          return e.Pass;
        if ('xml' != h.mode.name)
          if ('htmlmixed' == t.getMode().name && 'javascript' == h.mode.name)
            u = a + 'script';
          else {
            if ('htmlmixed' != t.getMode().name || 'css' != h.mode.name)
              return e.Pass;
            u = a + 'style';
          }
        else {
          if (!p.context || !p.context.tagName || o(t, p.context.tagName, f, p))
            return e.Pass;
    ...
    function o(t, n, r, i, o) {
      ...
      for (var s = i.context, c = o ? 1 : 0; s && s.tagName == n; s = s.prev)
        ++c;
      r = l.to;
      for (var u = 1; u < c; u++) {
    ...
    e.defineOption('autoCloseTags', !1, function(n, i, o) {
      if ((o != e.Init && o && n.removeKeyMap('autoCloseTags'), i)) {
        ...
        ('object' != typeof i || i.whenClosing) &&
          (a["'/'"] = function(e) {
            return r(e);
          }),
          ('object' != typeof i || i.whenOpening) &&
            (a["'>'"] = function(e) {
              return t(e);
            }),
          n.addKeyMap(a);
  ...
  (function(e) {
    ...
    function t(e, t, r) {
      var i = e.getLineHandle(t.line),
        ...
        s = r && r.afterCursor;
      null == s &&
        (s = /(^| )cm-fat-cursor($| )/.test(e.getWrapperElement().className));
    ...
    function n(e, t, n, r, i) {
      for (
        var o = (i && i.maxScanLineLength) || 1e4,
          s = (i && i.maxScanLines) || 1e3,
          c = [],
          u = i && i.bracketRegex ? i.bracketRegex : /[(){}[\]]/,
          f =
            n > 0
        ...
        if (h) {
          ...
          if (!(h.length > o))
            for (d == t.line && (p = t.ch - (n < 0 ? 1 : 0)); p != m; p += n) {
              ...
              if (
                u.test(g) &&
                (r === undefined || e.getTokenTypeAt(a(d, p + 1)) == r)
              )
                if (('>' == l[g].charAt(1)) == n > 0) c.push(g);
                else {
                  if (!c.length) return { pos: a(d, p), ch: g };
                  c.pop();
                }
            }
        }
    ...
    function r(e, n, r) {
      for (
        ...
        if (u && e.getLine(u.from.line).length <= i) {
          ...
          l.push(
            e.markText(u.from, a(u.from.line, u.from.ch + 1), { className: f })
          ),
            u.to &&
              e.getLine(u.to.line).length <= i &&
              l.push(
                e.markText(u.to, a(u.to.line, u.to.ch + 1), { className: f })
              );
        }
      }
      if (l.length) {
    ...
    function i(e) {
      e.operation(function() {
        e.state.matchBrackets.currentlyHighlighted &&
          ...
          (e.state.matchBrackets.currentlyHighlighted = r(
            e,
            !1,
    ...
    e.defineOption('matchBrackets', !1, function(t, n, r) {
      ...
      e.defineExtension('findMatchingBracket', function(e, n, r) {
        return (
          (r || 'boolean' == typeof n) &&
            (r ? ((r.strict = n), (n = r)) : (n = n ? { strict: !0 } : null)),
          t(this, e, n)
        );
      }),
  ...
  (function(e) {
    ...
    e.registerHelper('fold', 'brace', function(t, n) {
      function r(r) {
        for (var l = n.ch, s = 0; ; ) {
          ...
          if (-1 != c) {
            if (1 == s && c < n.ch) break;
            if (
              ((i = t.getTokenTypeAt(e.Pos(o, c + 1))),
      ...
      if ((null == c && ((l = '['), (s = ']'), (c = r('['))), null != c)) {
        ...
        if (null != u && (o != u || f != c))
          return { from: e.Pos(o, c), to: e.Pos(u, f) };
      }
    }),
    ...
    e.registerGlobalHelper(
      ...
      function(t, n) {
        ...
        if (i && o) {
            ...
            if (-1 != f) {
              ...
              if (
                ...
                (0 == f ||
                  ...
                  !/comment/.test(t.getTokenTypeAt(e.Pos(l, f))))
              ) {
                a = f + i.length;
                break;
              }
          ...
          if (null != d && (l != d || h != a))
            return { from: e.Pos(l, a), to: e.Pos(d, h) };
        }
      }
    );
  }),
  ...
  (function(e) {
    ...
    function n(e, t) {
      ...
      if ('string' == typeof n) {
        ...
        (n = document.createElement('span')).appendChild(i),
  ...
  (function(e) {
      ...
      for (var n = []; ; ) {
        ...
        if ('selfClose' != r)
          if (i[1]) {
            ...
            if (c < 0 && (!t || t == i[2]))
              return { tag: i[2], from: d(o, l), to: d(e.line, e.ch) };
          } else n.push(i[2]);
      }
    }
    function f(e, t) {
      for (var n = []; ; ) {
        ...
        if ('selfClose' != r) {
          ...
          if (a[1]) n.push(a[2]);
            ...
            if (s < 0 && (!t || t == a[2]))
              return { tag: a[2], from: d(e.line, e.ch), to: d(i, o) };
          }
        } else l(e);
      }
    }
    ...
    e.registerHelper('fold', 'xml', function(e, r) {
      ...
      (e.scanForClosingTag = function(e, t, r, i) {
        return u(new n(e, t.line, t.ch, i ? { from: 0, to: i } : null), r);
      });
  }),
  // CodeMirror, copyright (c) by Marijn Haverbeke and others
  (function(e) {
    ...
    e.registerHelper('hint', 'css', function(n) {
      ...
      if ('css' == a.mode.name) {
        ...
        var u = e.resolveMode('text/css'),
          ...
          d = a.state.state;
        return (
          'pseudo' == d || 'variable-3' == o.type
            ? r(t)
            : 'block' == d || 'maybeprop' == d
            ? r(u.propertyKeywords)
            : 'prop' == d || 'parens' == d || 'at' == d || 'params' == d
            ? (r(u.valueKeywords), r(u.colorKeywords))
            : ('media' != d && 'media_parens' != d) ||
              (r(u.mediaTypes), r(u.mediaFeatures)),
          f.length
            ? { list: f, from: e.Pos(i.line, l), to: e.Pos(i.line, s) }
            : void 0
        );
      }
    });
  ...
  (function(e) {
      ...
      if (!/\b(?:string|comment)\b/.test(a.type)) {
        ...
        if ('json' !== l.mode.helperType) {
          (a.state = l.state),
            /^[\w$_]*$/.test(a.string)
              ? a.end > o.ch &&
                ((a.end = o.ch), (a.string = a.string.slice(0, o.ch - a.start)))
              : (a = {
                  start: o.ch,
                  end: o.ch,
                  string: '',
        ...
        for (
          g.type && 0 === g.type.indexOf('variable')
            ? (o && o.additionalContext && (m = o.additionalContext[g.string]),
              (o && !1 === o.useGlobalScope) || (m = m || p[g.string]))
            : 'string' == g.type
            ? (m = '')
            : 'atom' == g.type
            ? (m = 1)
    ...
    e.registerHelper('hint', 'javascript', i),
      e.registerHelper('hint', 'coffeescript', a);
  ...
  (function(e) {
    ...
    function n(e, t, n) {
      ...
      if (r) for (var o in r) r[o] !== undefined && (i[o] = r[o]);
      if (n) for (var o in n) n[o] !== undefined && (i[o] = n[o]);
    ...
    function a(t, n) {
      ...
      (s.className = 'CodeMirror-hints ' + c),
      ...
      for (var d = n.list, h = 0; h < d.length; ++h) {
        ...
        null != m.className && (g = m.className + ' ' + g),
          ...
          m.render
            ? m.render(p, n, m)
            : p.appendChild(document.createTextNode(m.displayText || r(m))),
          (p.hintId = h);
      }
      ...
      if (S > 0) {
        ...
        if (v.top - (v.bottom - C.top) - M > 0)
          (s.style.top = (b = v.top - M) + 'px'), (x = !1);
        else if (M > w) {
          (s.style.height = w - 5 + 'px'),
            (s.style.top = (b = v.bottom - C.top) + 'px');
          var z = l.getCursor();
          n.from.ch != z.ch &&
            ((v = l.cursorCoords(z)),
            (s.style.left = (y = v.left) + 'px'),
      ...
      if (
        (O > 0 &&
          (C.right - C.left > k &&
            ((s.style.width = k - 5 + 'px'), (O -= C.right - C.left - k)),
          (s.style.left = (y = v.left - O) + 'px')),
        L)
      )
        for (var N = s.firstChild; N; N = N.nextSibling)
          N.style.paddingRight = l.display.nativeBarWidth + 'px';
      (l.addKeyMap(
        (this.keyMap = i(t, {
      ...
      return (
          ...
          (this.onScroll = function() {
            var e = l.getScrollInfo(),
              ...
              i =
                ...
                (window.pageYOffset ||
                  (document.documentElement || document.body).scrollTop);
            if ((x || (i += s.offsetHeight), i <= n.top || i >= n.bottom))
              return t.close();
            (s.style.top = r + 'px'),
              (s.style.left = y + T.left - e.left + 'px');
          })
        ),
        ...
        e.on(s, 'click', function(e) {
          ...
          n &&
            null != n.hintId &&
            (a.changeActive(n.hintId),
            t.options.completeOnSingleClick && a.pick());
        }),
        ...
        e.signal(
          ...
          'select',
          d[this.selectedHint],
          s.childNodes[this.selectedHint]
        ),
        !0
      );
    }
    ...
    (e.showHint = function(e, t, n) {
      ...
      e.defineExtension('showHint', function(r) {
        ...
        if (!(i.length > 1)) {
          ...
          a.options.hint &&
            (e.signal(this, 'startCompletion', this), a.update(!0));
        }
      });
    var d =
    ...
    (t.prototype = {
      ...
      cursorActivity: function() {
        ...
        if (
          ...
          t.length - e.ch != this.startLen - this.startPos.ch ||
          e.ch < this.startPos.ch ||
          this.cm.somethingSelected() ||
          !e.ch ||
          this.options.closeCharacters.test(t.charAt(e.ch - 1))
        )
          this.close();
        else {
          var n = this;
      ...
      (a.prototype = {
        ...
        changeActive: function(t, n) {
          if (
            ...
            r && (r.className = r.className.replace(' ' + f, '')),
              ((r = this.hints.childNodes[(this.selectedHint = t)]).className +=
                ' ' + f),
              r.offsetTop < this.hints.scrollTop
                ? (this.hints.scrollTop = r.offsetTop - 3)
                : r.offsetTop + r.offsetHeight >
                    this.hints.scrollTop + this.hints.clientHeight &&
                  (this.hints.scrollTop =
                    r.offsetTop + r.offsetHeight - this.hints.clientHeight + 3),
              e.signal(
                this.data,
                'select',
    ...
    function t(t, r) {
      ...
      if (i) {
        var a = t.getCursor(),
          l = t.getTokenAt(a);
        l.end > a.ch &&
          ((l.end = a.ch), (l.string = l.string.slice(0, a.ch - l.start)));
          ...
          if ((!h && !s.state.tagName) || g) {
            ...
            if (b && 'close' != g)
              for (var x = 0; x < b.length; ++x)
                (c && 0 != b[x].lastIndexOf(c, 0)) || f.push('<' + b[x]);
            else if ('close' != g)
              for (var k in i)
                !i.hasOwnProperty(k) ||
                  '!top' == k ||
                  '!attrs' == k ||
                  (c && 0 != k.lastIndexOf(c, 0)) ||
                  f.push('<' + k);
            v &&
              (!c || ('close' == g && 0 == v.tagName.lastIndexOf(c, 0))) &&
              f.push('</' + v.tagName + '>');
          } else {
            ...
            if ('string' == l.type || '=' == l.string) {
              var T,
                M = (m = t.getRange(
                  n(a.line, Math.max(0, a.ch - 60)),
                  n(a.line, 'string' == l.type ? l.start : l.end)
                )).match(/([^\s\u00a0=<>\"\']+)=$/);
              if (!M || !w.hasOwnProperty(M[1]) || !(T = w[M[1]])) return;
              if (
                ('function' == typeof T && (T = T.call(this, t)),
                'string' == l.type)
              ) {
                c = l.string;
                var z = 0;
                /['"]/.test(l.string.charAt(0)) &&
                  ((o = l.string.charAt(0)), (c = l.string.slice(1)), z++);
                var A = l.string.length;
                /['"]/.test(l.string.charAt(A - 1)) &&
                  ((o = l.string.charAt(A - 1)),
                  (c = l.string.substr(z, A - 2))),
                  (d = !0);
              }
              for (x = 0; x < T.length; ++x)
                (c && 0 != T[x].lastIndexOf(c, 0)) || f.push(o + T[x] + o);
            } else
              for (var O in ('attribute' == l.type &&
                ((c = l.string), (d = !0)),
              w))
                !w.hasOwnProperty(O) ||
                  (c && 0 != O.lastIndexOf(c, 0)) ||
                  f.push(O);
          }
          return {
            list: f,
        ...
        s.open(
          ...
          (s.onload = function() {
            4 === s.readyState &&
              200 === s.status &&
              ((o = s.responseText),
              2 == ++n && (t = new Typo('en_US', o, a, { platform: 'any' })));
          }),
          s.send(null);
      }
      if (!i) {
...
var Typo = function(e, t, n, r) {
  if (
    ...
    for (var o = 0, a = this.compoundRules.length; o < a; o++)
      for (var l = this.compoundRules[o], s = 0, c = l.length; s < c; s++)
        this.compoundRuleCodes[l[s]] = [];
    for (var o in ('ONLYINCOMPOUND' in this.flags &&
    ...
    for (o = 0, a = this.compoundRules.length; o < a; o++) {
      ...
      for (s = 0, c = u.length; s < c; s++) {
        ...
        d in this.compoundRuleCodes
          ? (f += '(' + this.compoundRuleCodes[d].join('|') + ')')
          : (f += d);
      }
...
(Typo.prototype = {
  ...
  _parseAFF: function(e) {
    for (
      var t = {},
        n = (e = this._removeAffixComments(e)).split('\n'),
        r = 0,
        i = n.length;
      r < i;
      r++
      ...
      if ('PFX' == a || 'SFX' == a) {
        for (
          ...
          var m = this.parseRuleCodes(h[1]),
            ...
            v = {};
          (v.add = p),
            m.length > 0 && (v.continuationClasses = m),
            '.' !== g &&
              (v.match =
                'SFX' === a ? new RegExp(g + '$') : new RegExp('^' + g)),
            '0' != d && (v.remove = 'SFX' === a ? new RegExp(d + '$') : d),
            c.push(v);
        }
        (t[l] = { type: a, combineable: 'Y' == s, entries: c }), (r += y);
        ...
        3 === (x = b.split(/\s+/)).length &&
          this.replacementTable.push([x[1], x[2]]);
      } else this.flags[a] = o[1];
    }
    return t;
  },
  _removeAffixComments: function(e) {
    return (e = (e = (e = (e = e.replace(/#.*$/gm, ''))
      .replace(/^\s\s*/m, '')
  ...
  _parseDIC: function(e) {
    ...
    for (
      var n = (e = this._removeDicComments(e)).split('\n'),
        r = {},
        i = 1,
        o = n.length;
      i < o;
      ...
      if (a.length > 1) {
        ...
        ('NEEDAFFIX' in this.flags && -1 != s.indexOf(this.flags.NEEDAFFIX)) ||
          t(l, s);
        for (var c = 0, u = s.length; c < u; c++) {
          ...
          if (d)
            for (
              var h = this._applyRule(l, d), p = 0, m = h.length;
              p < m;
              p++
            ) {
              var g = h[p];
              if ((t(g, []), d.combineable))
                for (var v = c + 1; v < u; v++) {
                  ...
                  if (b && b.combineable && d.type != b.type)
                    for (
                      var x = this._applyRule(g, b), k = 0, w = x.length;
                      k < w;
                      k++
                    ) {
                      t(x[k], []);
  ...
  suggest: function(e, t) {
    function n(e) {
      for (var t = [], n = 0, r = e.length; n < r; n++) {
        for (var i = e[n], o = [], a = 0, l = i.length + 1; a < l; a++)
        ...
        for (a = 0, l = o.length; a < l; a++) {
          (m = o[a])[1].length > 1 &&
            u.push(m[0] + m[1][1] + m[1][0] + m[1].substring(2));
        }
        var f = [];
        for (a = 0, l = o.length; a < l; a++) {
          if ((m = o[a])[1])
            for (var d = 0, h = c.alphabet.length; d < h; d++)
              f.push(m[0] + c.alphabet[d] + m[1].substring(1));
        }
        var p = [];
        for (a = 0, l = o.length; a < l; a++) {
          var m;
          if ((m = o[a])[1])
            for (d = 0, h = c.alphabet.length; d < h; d++)
              f.push(m[0] + c.alphabet[d] + m[1]);
        }
    ...
    function i(e) {
      ...
      d.sort(i).reverse();
      var h = [];
      for (u = 0, f = Math.min(t, d.length); u < f; u++)
        c.hasFlag(d[u][0], 'NOSUGGEST') || h.push(d[u][0]);
      return h;
    }
      ...
      if (r.appendChild) {
        ...
        (s.innerHTML = ''),
          (r = function(e, t) {
            if ('\n' == e)
              return (
                s.appendChild(document.createTextNode(a ? '\r' : e)),
                void (c = 0)
              );
            for (var n = '', r = 0; ; ) {
              var i = e.indexOf('\t', r);
  ...
  (function(e) {
    ...
    (t.prototype.setPos = function(e, t) {
      return (
        ...
        !(!t && e == this.pos) &&
          ((this.pos = e),
          (this.inner.style['horizontal' == this.orientation ? 'left' : 'top'] =
    ...
    (t.prototype.update = function(e, t, n) {
      ...
      o < r && ((this.size -= r - o), (o = r)),
        (this.inner.style[
          'horizontal' == this.orientation ? 'width' : 'height'
        ] = o + 'px'),
        this.setPos(this.pos, i);
    }),
      (n.prototype.update = function(e) {
        ...
        return (
          (this.vert.node.style.display = i ? 'block' : 'none'),
          ...
          r &&
            (this.horiz.update(
              e.scrollWidth,
              e.clientWidth,
              e.viewWidth - (i ? n : 0) - e.barLeft
            ),
            (this.horiz.node.style.right = i ? n + 'px' : '0'),
            (this.horiz.node.style.left = e.barLeft + 'px')),
          { right: i ? n : 0, bottom: r ? n : 0 }
        );
      }),
  ...
  (function(e) {
    ...
    (e.commands.jumpToLine = function(e) {
      var i = e.getCursor();
      t(e, n(e), e.phrase('Jump to line:'), i.line + 1 + ':' + i.ch, function(
        t
      ) {
        var n;
        if (t)
      ...
      if (
        ...
        a(t, m(t), c, d, function(n, i) {
          ...
          'findPersistentPrev' == l
            ? (e.e_stop(n), f(t, r(t), i), t.execCommand(l))
            : ('find' != l && 'findPersistent' != l) || (e.e_stop(n), d(i, n));
        }),
          o && c && (f(t, s, c), h(t, n));
      } else
  ...
  (function(e) {
    ...
    function n(e, n) {
      for (var r = t(e), i = r, o = 0; o < n.length; o++)
        -1 == i.indexOf(n.charAt(o)) && (i += n.charAt(o));
      ...
      for (var i, o = 1, l = r.line, s = e.firstLine(); l >= s; ) {
        ...
        if (f) {
          ...
          return {
            ...
            to: m(
              p + h.length - 1,
              1 == h.length ? g + h[0].length : h[h.length - 1].length
            ),
            match: f
          };
        }
    ...
    function u(e, t, n, r) {
      ...
      var i = r ? h : p,
        o = i(t).split(/\r|\n\r?/);
      e: for (
        var a = n.line, l = n.ch, s = e.lastLine() + 1 - o.length;
        a <= s;
        a++, l = 0
      ) {
    ...
    function f(e, t, n, r) {
      ...
      var i = r ? h : p,
        o = i(t).split(/\r|\n\r?/);
      e: for (
        var a = n.line, l = n.ch, s = e.firstLine() - 1 + o.length;
        a >= s;
        a--, l = -1
      ) {
        var u = e.getLine(a);
    ...
    function d(e, t, r, a) {
      ...
      (this.atOccurrence = !1),
        (this.doc = e),
        (r = r ? e.clipPos(r) : m(0, 0)),
        (this.pos = { from: r, to: r }),
        'object' == typeof a ? (c = a.caseFold) : ((c = a), (a = null)),
        'string' == typeof t
          ? (null == c && (c = !1),
      ...
      (d.prototype = {
        ...
        find: function(t) {
          for (
            ...
            t
              ? n.from.ch
                ? (n.from = m(n.from.line, n.from.ch - 1))
                : (n =
                    n.from.line == this.doc.firstLine()
                      ? null
                      : this.matches(t, this.doc.clipPos(m(n.from.line - 1))))
              : n.to.ch < this.doc.getLine(n.to.line).length
              ? (n.to = m(n.to.line, n.to.ch + 1))
              : (n =
                  n.to.line == this.doc.lastLine()
                    ? null
                    : this.matches(t, m(n.to.line + 1, 0)));
          if (n)
            return (
  ...
  (function(e) {
    ...
    function t(e, t, n) {
      for (
        var r = n.paragraphStart || e.getHelper(t, 'paragraphStart'),
          i = t.line,
          o = e.firstLine();
        i > o;
        --i
      ...
      for (
        var l = n.paragraphEnd || e.getHelper(t, 'paragraphEnd'),
          s = t.line + 1,
          c = e.lastLine();
        s <= c;
        ++s
    ...
    function n(e, t, n, r) {
      ...
      for (var o = !0; ; o = !1) {
        var a = i;
        if (r) for (; ' ' == e.charAt(a - 1); ) --a;
        if (0 != a || !o) return { from: a, to: i };
        i = t;
      }
    }
    function r(t, r, o, a) {
      ...
      for (var m = 0; m < h.length; ++m) {
        ...
        f &&
          g &&
          !s.test(f.charAt(f.length - 1) + g.charAt(0)) &&
          ((f += ' '), (y = 1));
        var b = '';
        if (
          (m && ((b = g.match(/^\s*/)[0]), (g = g.slice(b.length))),
          (f += g),
          m)
        ) {
        ...
        for (; f.length > l; ) {
          var k = n(f, l, s, c);
          u.push({ text: ['', p], from: i(d, k.from), to: i(d, k.to) }),
            (f = p + f.slice(k.to)),
            ++d;
        }
      }
        ...
        u.length &&
          t.operation(function() {
            for (var n = 0; n < u.length; ++n) {
              var r = u[n];
              (r.text || e.cmpPos(r.from, r.to)) &&
                t.replaceRange(r.text, r.from, r.to);
            }
          }),
        u.length ? { from: u[0].from, to: e.changeEnd(u[u.length - 1]) } : null
      );
    }
    var i = e.Pos;
    e.defineExtension('wrapParagraph', function(e, n) {
      ...
      (e.commands.wrapLines = function(e) {
        e.operation(function() {
          for (
            var n = e.listSelections(), o = e.lastLine() + 1, a = n.length - 1;
            a >= 0;
            a--
          ) {
            var l,
            ...
            if (s.empty()) {
              var c = t(e, s.head, {});
              l = { from: i(c.from, 0), to: i(c.to - 1) };
            } else l = { from: s.from(), to: s.to() };
          ...
          l.length &&
            a.operation(function() {
              for (var e = l.length - 1; e >= 0; --e)
                u = u || r(a, i(l[e].from, 0), i(l[e].to - 1), o);
            }),
          u
        );
      });
  ...
  (function(e) {
    ...
    'use strict';
    function t(e) {
      (l = e.getModeAt({ line: 0, ch: 0 })),
        (s = l.helperType || l.name),
        (c = u.cmModeToType(s));
    }
    function n(e) {
      var t = i(),
    ...
    function o() {
      ...
      switch (c) {
        ...
        case 'js':
          if ('coffeescript' === s) return { start: '###', end: '###' };
      }
    ...
    (d.macExtendedBase = {
      ...
      e.normalizeKeyMap(d.macExtendedBase),
      (d.pcExtendedBase = {
  ...
  (function(e) {
    ...
    function t(t, n, r) {
      ...
      for (
        var o, a = 'start', l = n.ch, s = r < 0 ? 0 : i.length, c = 0;
        l != s;
        l += r, c++
      ) {
    ...
    function n(e, n) {
      e.extendSelectionsBy(function(r) {
        return e.display.shift || e.doc.extend || r.empty()
          ? t(e.doc, r.head, n)
          : n < 0
          ? r.from()
          : r.to();
    ...
    function r(t, n) {
      ...
      t.operation(function() {
        for (
          var e = t.listSelections().length, r = [], i = -1, o = 0;
          o < e;
          o++
        ) {
    ...
    function i(t, n) {
      for (
        var r = n.ch, i = r, o = t.getLine(n.line);
        r && e.isWordChar(o.charAt(r - 1));

      )
        --r;
      for (; i < o.length && e.isWordChar(o.charAt(i)); ) ++i;
      return { from: h(n.line, r), to: h(n.line, i), word: o.slice(r, i) };
    }
    function o(e, t) {
    ...
    function s(t, n) {
      ...
      for (var r, i = t.listSelections(), o = [], a = 0; a < i.length; a++) {
        ...
        if (!l.empty()) {
          for (
            var s = l.from().line, c = l.to().line;
            a < i.length - 1 && i[a + 1].from().line == c;
            ...
            n
              ...
              : u.sort(function(e, t) {
                  var n = e.toUpperCase(),
                    r = t.toUpperCase();
                  return (
                    n != r && ((e = n), (t = r)), e < t ? -1 : e == t ? 0 : 1
                  );
                }),
              t.replaceRange(u, s, c),
              r && e.push({ anchor: s, head: h(l + 1, 0) });
          }
    ...
    function c(t, n) {
      t.operation(function() {
        for (
          var r = t.listSelections(), o = [], a = [], l = 0;
          l < r.length;
          l++
        ) {
          (c = r[l]).empty()
    ...
    function f(e, t) {
      ...
      if (n) {
        ...
        : i.findPrevious())
          ...
          : ((i = e.getSearchCursor(
              r,
              t ? h(e.firstLine(), 0) : e.clipPos(h(e.lastLine()))
            )),
            (t
            ? i.findNext()
            : i.findPrevious())
    ...
    (d.goSubwordLeft = function(e) {
      ...
      (d.selectLine = function(e) {
        for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
          var i = t[r];
          n.push({ anchor: h(i.from().line, 0), head: h(i.to().line + 1, 0) });
        }
        e.setSelections(n);
      }),
      ...
      (d.selectNextOccurrence = function(t) {
        ...
        if (0 == e.cmpPos(n, r)) {
          ...
          if (
            (f ||
              (f = (u = t.getSearchCursor(c, h(t.firstLine(), 0))).findNext()),
            !f || a(t.listSelections(), u.from(), u.to()))
          )
            return e.Pass;
    ...
    (d.selectScope = function(e) {
      ...
      (d.swapLineUp = function(t) {
        ...
        for (
          ...
          o.push({
            ...
            0 != l.to().ch || l.empty() || --c,
            s > i ? r.push(s, c) : r.length && (r[r.length - 1] = c),
            (i = c);
        }
        t.operation(function() {
          for (var e = 0; e < r.length; e += 2) {
            var n = r[e],
              i = r[e + 1],
              a = t.getLine(n);
            t.replaceRange('', h(n, 0), h(n + 1, 0), '+swapLine'),
              i > t.lastLine()
                ? t.replaceRange('\n' + a, h(t.lastLine()), null, '+swapLine')
                : t.replaceRange(a + '\n', h(i, 0), null, '+swapLine');
          }
      ...
      (d.swapLineDown = function(t) {
        ...
        for (
          ...
          var a = n[o],
            ...
            s = a.from().line;
          0 != a.to().ch || a.empty() || l--,
            l < i ? r.push(l, s) : r.length && (r[r.length - 1] = s),
            (i = s);
        }
        t.operation(function() {
          for (var e = r.length - 2; e >= 0; e -= 2) {
            var n = r[e],
              ...
              o = t.getLine(n);
            n == t.lastLine()
              ? t.replaceRange('', h(n - 1), h(n), '+swapLine')
              : t.replaceRange('', h(n, 0), h(n + 1, 0), '+swapLine'),
              t.replaceRange(o + '\n', h(i, 0), null, '+swapLine');
          }
          t.scrollIntoView();
      ...
      (d.joinLines = function(e) {
        for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
          for (
            var i = t[r], o = i.from(), a = o.line, l = i.to().line;
            r < t.length - 1 && t[r + 1].from().line == l;

          )
            l = t[++r].to().line;
          n.push({ start: a, end: l, anchor: !i.empty() && o });
        }
        e.operation(function() {
          for (var t = 0, r = [], i = 0; i < n.length; i++) {
            for (
              var o,
                a = n[i],
                l = a.anchor && h(a.anchor.line - t, a.anchor.ch),
                s = a.start;
              s <= a.end;
              s++
            ) {
              var c = s - t;
              s == a.end && (o = h(c, e.getLine(c).length + 1)),
                c < e.lastLine() &&
                  (e.replaceRange(
                    ' ',
                    h(c),
                    h(c + 1, /^\s*/.exec(e.getLine(c + 1))[0].length)
                  ),
                  ++t);
            }
            r.push({ anchor: l || o, head: o });
          }
          e.setSelections(r, 0);
        });
      }),
      ...
      (d.toggleBookmark = function(e) {
        for (
          ...
          for (
            var i = t[r].from(),
              o = t[r].to(),
              a = t[r].empty() ? e.findMarksAt(i) : e.findMarks(i, o),
              l = 0;
            l < a.length;
            l++
          )
            if (a[l].sublimeBookmark) {
              ...
              for (var s = 0; s < n.length; s++)
                n[s] == a[l] && n.splice(s--, 1);
              break;
            }
          l == a.length &&
            n.push(
              e.markText(i, o, { sublimeBookmark: !0, clearWhenEmpty: !1 })
            );
        }
      }),
      ...
      (d.delLineRight = function(e) {
        e.operation(function() {
          for (var t = e.listSelections(), n = t.length - 1; n >= 0; n--)
            e.replaceRange('', t[n].anchor, h(t[n].to().line), '+delete');
          e.scrollIntoView();
        });
      }),
      ...
      (d.showInCenter = function(e) {
        ...
        e.scrollTo(
          null,
          (t.top + t.bottom) / 2 - e.getScrollInfo().clientHeight / 2
        );
      }),
      ...
      (d.findAllUnder = function(e) {
        ...
        if (t) {
          for (
            var n = e.getSearchCursor(t.query), r = [], i = -1;
            n.findNext();
    ...
    e.defineMode('css', function(t, n) {
      ...
      function i(e, t) {
        ...
        return '@' == n
          ...
          ? /[,+>*\/]/.test(n)
            ...
            : /[:;{}\[\]\(\)]/.test(n)
            ? r(null, n)
            : (('u' == n || 'U' == n) && e.match(/rl(-prefix)?\(/i)) ||
              (('d' == n || 'D' == n) && e.match('omain(', !0, !0)) ||
              (('r' == n || 'R' == n) && e.match('egexp(', !0, !0))
            ? (e.backUp(1), (t.tokenize = a), r('property', 'word'))
            : /[\w\\\-]/.test(n)
        ...
        N = {
          ...
          block: function(e, t, n) {
            if ('word' == e) {
              ...
              return w.hasOwnProperty(r)
                ...
                : C.hasOwnProperty(r)
                ? ((m = 'string-2'), 'maybeprop')
                : z
                ? ((m = t.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'),
                  'block')
                : ((m += ' error'), 'maybeprop');
            }
            return 'meta' == e
              ? 'block'
              : z || ('hash' != e && 'qualifier' != e)
              ? N.top(e, t, n)
              : ((m = 'error'), 'block');
          },
          ...
          pseudo: function(e, t, n) {
            return 'meta' == e
              ? 'pseudo'
              : 'word' == e
              ? ((m = 'variable-3'), n.context.type)
              : u(e, t, n);
          },
          documentTypes: function(e, t, n) {
            return 'word' == e && y.hasOwnProperty(t.current())
              ? ((m = 'tag'), n.context.type)
              : N.atBlock(e, t, n);
          },
            ...
            return '}' == e
              ...
              ? ((m =
                  ('@font-face' == n.stateArg &&
                    !S.hasOwnProperty(t.current().toLowerCase())) ||
                  ('@counter-style' == n.stateArg &&
                    !L.hasOwnProperty(t.current().toLowerCase()))
                    ? 'error'
                    : 'property'),
                'maybeprop')
              : 'restricted_atBlock';
      ...
      return {
        ...
        token: function(e, t) {
          ...
          return (
            n && 'object' == typeof n && ((p = n[1]), (n = n[0])),
            (m = n),
            'comment' != p && (t.state = N[t.state](p, e, t)),
            m
          );
        },
        indent: function(e, t) {
  ...
  (function(e) {
    ...
    e.defineMode(
      ...
      function(t) {
        ...
        var o = e.getMode(t, { name: 'htmlmixed' }),
          a = e.getMode(t, 'ruby');
        return {
          startState: function() {
            return {
          ...
          token: function(e, t) {
            ...
            if (
              ...
              n &&
                'commentLine' != n &&
                (t.previousToken = { style: n, indented: t.indented }),
              e.eol() && t.tokenize == r)
            ) {
              e.backUp(1);
              var o = e.peek();
      ...
      function(n, r) {
        function s(r, o) {
          ...
          if (
            d &&
            !/[<>\s\/]/.test(r.current()) &&
            (l = o.htmlState.tagName && o.htmlState.tagName.toLowerCase()) &&
            u.hasOwnProperty(l)
          )
            o.inTag = l + ' ';
    ...
    e.defineMode(
      ...
      function(t) {
        ...
        function u(e, t) {
          if (e.match(/^when\b/))
            return (
              (t.javaScriptLine = !0), (t.javaScriptLineExcludesColon = !0), K
            );
        }
        function f(e) {
        ...
        function m(e, t) {
          if (e.match(/^block\b *(?:(prepend|append)\b)?/))
            return (t.restOfLine = 'variable'), K;
        }
        function g(e, t) {
        ...
        function v(e, t) {
          if (e.match(/^include:([a-zA-Z0-9\-]+)/, !1) && e.match('include'))
            return (t.isIncludeFiltered = !0), K;
        }
        function y(e, t) {
        ...
        function x(e, t) {
          return e.match(/^\+([-\w]+)/)
            ? (e.match(/^\( *[-\w]+ *=/, !1) ||
              ...
              'variable')
            : e.match(/^\+#{/, !1)
            ? (e.next(), (t.mixinCallAfter = !0), l(e, t))
            : void 0;
        }
        function k(e, t) {
          if (t.mixinCallAfter)
        ...
        function S(e, t) {
          if (t.isEach) {
            if (e.match(/^ in\b/))
              return (t.javaScriptLine = !0), (t.isEach = !1), K;
        ...
        function D(e, t) {
          return e.match(/^(?:\| ?| )([^\n]+)/)
            ? 'string'
            : e.match(/^(<[^\n]*)/, !1)
            ? (R(e, t, 'htmlmixed'), (t.innerModeForLine = !0), H(e, t, !0))
            : void 0;
        }
        function _(e, t) {
          if (e.eat('.')) {
        ...
        return (
          (n.prototype.copy = function() {
            ...
            return (
              ...
              (t.jsState = e.copyState(Z, this.jsState)),
          ...
          { startState: q, copyState: U, token: $ }
        );
      },
      'javascript',
      'css',
  ...
  (function(e) {
    ...
    e.defineMode('javascript', function(t, n) {
      ...
      function k() {
        (Ze.state.context = new b(Ze.state.context, Ze.state.localVars, !1)),
          (Ze.state.localVars = Qe);
      }
      function w() {
        (Ze.state.context = new b(Ze.state.context, Ze.state.localVars, !0)),
          (Ze.state.localVars = null);
      }
      function C() {
      ...
      function M(e, t) {
        return 'var' == e
          ...
          ? p()
          : 'if' == e
          ? ('else' == Ze.state.lexical.info &&
              Ze.state.cc[Ze.state.cc.length - 1] == L &&
              Ze.state.cc.pop()(),
            p(S('form'), N, M, L, he))
          : 'function' == e
          ? p(be)
          : 'for' == e
          ? p(S('form'), pe, M, L)
          : 'class' == e || (Ue && 'interface' == t)
          ? ((Ze.marked = 'keyword'), p(S('form'), we, L))
          : 'variable' == e
          ? Ue && 'declare' == t
            ? ((Ze.marked = 'keyword'), p(M))
            : Ue &&
              ('module' == t || 'enum' == t || 'type' == t) &&
              Ze.stream.match(/^\s*\w/, !1)
            ? ((Ze.marked = 'keyword'),
              'enum' == t
                ? p(Fe)
                : 'type' == t
                ? p(ee, T('operator'), ee, T(';'))
                : p(S('form'), ce, T('{'), S('}'), Y, L, L))
            : Ue && 'namespace' == t
            ? ((Ze.marked = 'keyword'), p(S('form'), A, Y, L))
            : Ue && 'abstract' == t
            ? ((Ze.marked = 'keyword'), p(M))
            : p(S('stat'), q)
          : 'switch' == e
          ? p(S('form'), N, T('{'), S('}', 'switch'), w, Y, L, L, C)
          : 'case' == e
          ? p(A, T(':'))
          : 'default' == e
          ? p(T(':'))
      ...
      function P(e, t, n) {
        ...
        var i = n ? j : F;
        return Ye.hasOwnProperty(e)
          ? p(i)
          : 'function' == e
          ? p(be, i)
          : 'class' == e || (Ue && 'interface' == t)
          ? ((Ze.marked = 'keyword'), p(S('form'), ke, L))
          : 'keyword c' == e || 'async' == e
          ? p(n ? O : A)
          : '(' == e
          ? p(S(')'), E, T(')'), L, i)
      ...
      function j(e, t, n) {
        ...
        return '=>' == e
          ...
          ? '(' == e
            ...
            ? p(S(']'), E, T(']'), L, r)
            : Ue && 'as' == t
            ? ((Ze.marked = 'keyword'), p(ee, r))
            : 'regexp' == e
            ? ((Ze.state.lastType = Ze.marked = 'operator'),
              Ze.stream.backUp(Ze.stream.pos - Ze.stream.start - 1),
              p(i))
            : void 0
          : void 0;
      }
      ...
      function D(e) {
        if ('}' == e)
          return (Ze.marked = 'string-2'), (Ze.state.tokenize = s), p(I);
      }
      function _(e) {
        ...
        if ('variable' == e || 'keyword' == Ze.style) {
          return (
            ...
            'get' == t || 'set' == t
              ? p(K)
              : (Ue &&
                  Ze.state.fatArrowAt == Ze.stream.start &&
                  (n = Ze.stream.match(/^\s*:\s*/, !1)) &&
                  (Ze.state.fatArrowAt = Ze.stream.pos + n[0].length),
                p(V))
          );
          var n;
        } else {
          if ('number' == e || 'string' == e)
            return (Ze.marked = Be ? 'property' : Ze.style + ' property'), p(V);
      ...
      function Q(e) {
        if (Ue && ':' == e)
          return Ze.stream.match(/^\s*\w+\s+is\b/, !1) ? p(A, J, ee) : p(ee);
      }
      function J(e, t) {
      ...
      function ee(e, t) {
        return 'keyof' == t || 'typeof' == t
          ? ((Ze.marked = 'keyword'), p('keyof' == t ? ee : O))
          : 'variable' == e || 'void' == t
          ? ((Ze.marked = 'type'), p(ie))
      ...
      function ne(e, t) {
        return 'variable' == e || 'keyword' == Ze.style
          ? ((Ze.marked = 'property'), p(ne))
          : '?' == t
          ? p(ne)
          : ':' == e
          ? p(ee)
      ...
      function re(e, t) {
        return ('variable' == e && Ze.stream.match(/^\s*[?:]/, !1)) || '?' == t
          ? p(re)
          : ':' == e
          ? p(ee)
          : h(ee);
      ...
      function se(e, t) {
        return 'enum' == t
          ? ((Ze.marked = 'keyword'), p(Fe))
          : h(ce, Z, fe, de);
      }
      function ce(e, t) {
        return Ue && y(t)
          ? ((Ze.marked = 'keyword'), p(ce))
          : 'variable' == e
          ? (g(t), p())
          : 'spread' == e
          ? p(ce)
      ...
      function ue(e, t) {
        return 'variable' != e || Ze.stream.match(/^\s*:/, !1)
          ? ('variable' == e && (Ze.marked = 'property'),
            'spread' == e ? p(ce) : '}' == e ? h() : p(T(':'), ce, fe))
          : (g(t), p(fe));
      }
      function fe(e, t) {
        if ('=' == t) return p(O);
      ...
      function Ce(e, t) {
        return '<' == t
          ? p(S('>'), G(ae, '>'), L, Ce)
          : 'extends' == t || 'implements' == t || (Ue && ',' == e)
          ? ('implements' == t && (Ze.marked = 'keyword'), p(Ue ? ee : A, Ce))
          : '{' == e
          ? p(S('}'), Se, L)
          : void 0;
      }
      function Se(e, t) {
        return 'async' == e ||
          ('variable' == e &&
            ('static' == t || 'get' == t || 'set' == t || (Ue && y(t))) &&
            Ze.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
          ? ((Ze.marked = 'keyword'), p(Se))
          : 'variable' == e || 'keyword' == Ze.style
          ? ((Ze.marked = 'property'), p(Ue ? Le : be, Se))
          : '[' == e
          ? p(A, Z, T(']'), Ue ? Le : be, Se)
          : '*' == t
          ? ((Ze.marked = 'keyword'), p(Se))
      ...
      function Te(e, t) {
        return '*' == t
          ? ((Ze.marked = 'keyword'), p(Pe, T(';')))
          : 'default' == t
          ? ((Ze.marked = 'keyword'), p(A, T(';')))
          : '{' == e
          ? p(G(Me, '}'), Pe, T(';'))
          : h(M);
      }
      function Me(e, t) {
        return 'as' == t
          ? ((Ze.marked = 'keyword'), p(T('variable')))
          : 'variable' == e
          ? h(O, Me)
          : void 0;
      }
        ...
        (L.lex = !0),
        {
          ...
          indent: function(t, r) {
            ...
            return 'vardef' == f
              ...
              ? s.indented + Re
              : 'stat' == f
              ? s.indented + (Ie(t, r) ? He || Re : 0)
              : 'switch' != s.info || d || 0 == n.doubleIndentSwitch
              ? s.align
                ? s.column + (d ? 0 : 1)
                : s.indented + (d ? 0 : Re)
              : s.indented + (/^(?:case|default)\b/.test(r) ? Re : 2 * Re);
          },
    ...
    e.defineMode(
      ...
      function(r, i) {
        ...
        function l(n, i, l) {
          if (2 == l.depth)
            return (
              n.match(/^.*?\*\//) ? (l.depth = 1) : n.skipToEnd(), 'comment'
            );
          if ('{' == n.peek()) {
            ...
            if (f && n.match(/^[^>]*>\s*$/, !1)) {
              ...
              f.startOfLine
                ? (s -= r.indentUnit)
                : l.prev.state.lexical && (s = l.prev.state.lexical.indented);
            } else 1 == l.depth && (s += r.indentUnit);
            return (
              (i.context = new t(e.startState(u, s), u, 0, i.context)), null
            );
          }
          if (1 == l.depth) {
            if ('<' == n.peek())
          ...
          return (
            /\btag\b/.test(h)
              ? />$/.test(p)
                ...
                : /^</.test(p) && (l.depth = 1)
              : !h && (d = p.indexOf('{')) > -1 && n.backUp(p.length - d),
            h
          );
        }
        function s(n, r, i) {
        ...
        return {
          startState: function() {
            return { context: new t(e.startState(u), u) };
          },
      ...
      if (l.splice)
        for (var s = 0, c = l.length; s < c; ++s) {
          ...
          'string' == typeof u.regex &&
            (o[a][s].regex = new RegExp('^' + u.regex));
        }
      else
        'string' == typeof u.regex && (o[a].regex = new RegExp('^' + l.regex));
    }
      ...
      function(t, n) {
        ...
        function s(t, o) {
          ...
          if (
            ...
            ((o.indentationDiff = o.indentation), h)
          ) {
            for (
              o.em = !1,
                o.strong = !1,
                ...
                o.strikethrough = !1,
                o.list = null;
              m < o.listStack[o.listStack.length - 1];
              ...
              o.listStack.pop(),
                o.listStack.length
                  ...
                  : (o.list = !1);
            !1 !== o.list &&
              (o.indentationDiff = m - o.listStack[o.listStack.length - 1]);
          }
          var g = !(
              s ||
              d ||
          ...
          if (
            o.indentationDiff >= 4 &&
            (c || o.prevLine.fencedCodeEnd || o.prevLine.header || s)
          )
            return t.skipToEnd(), (o.indentedCode = !0), w.code;
          if (t.eatSpace()) return null;
          if (l && o.indentation <= p && (b = t.match(M)) && b[1].length <= 6)
            return (
              (o.quote = 0),
              (o.header = b[1].length),
              (o.thisLine.header = !0),
          ...
          if (!y && !o.setext && l && o.indentation <= p && (b = t.match(L))) {
            var x = b[1] ? 'ol' : 'ul';
            return (
              (o.indentation = m + t.current().length),
              (o.list = !0),
              (o.quote = 0),
          ...
          return l && o.indentation <= p && (b = t.match(O, !0))
            ? ((o.quote = 0),
              (o.fencedEndRE = new RegExp(b[1] + '+ *$')),
              (o.localMode = n.fencedCodeBlockHighlighting && r(b[2])),
        ...
        function c(t, n) {
          ...
          if (!k) {
            ...
            (('xml' == i.mode.name &&
              ...
              ((n.f = h), (n.block = s), (n.htmlState = null));
          }
          return r;
        }
        function u(e, t) {
        ...
        function h(t, r) {
          ...
          if (
            ...
            return n.highlightFormatting && (r.formatting = 'header'), f(r);
          var a = t.next();
          if (r.linkTitle) {
            r.linkTitle = !1;
            var l = a;
          ...
          if (']' === a && r.imageAltText) {
            ...
            var v = f(r);
            return (
              (r.imageAltText = !1), (r.image = !1), (r.inline = r.f = m), v
            );
          }
          if ('[' === a && !r.image)
          ...
          if (n.xml && '<' === a && t.match(/^\/\w*?>/))
            return (r.md_inside = !1), 'tag';
          if ('*' === a || '_' === a) {
            for (
              var C = 1, S = 1 == t.pos ? ' ' : t.string.charAt(t.pos - 2);
              C < 3 && t.eat(a);
            ...
            if (
              ...
              n.highlightFormatting &&
                (r.formatting =
                  null == A ? 'strong' : null == O ? 'em' : 'strong em'),
                !0 === A && (r.em = a),
                !0 === O && (r.strong = a);
              g = f(r);
    ...
    e.registerHelper('hintWords', 'python', i.concat(o)),
      e.defineMode('python', function(a, l) {
          ...
          if ((r && (t.indent = e.indentation()), r && 'py' == n(t).type)) {
            ...
            if (e.eatSpace()) {
              ...
              return (
                o > i
                  ? d(t)
                  : o < i && p(e, t) && '#' != e.peek() && (t.errorToken = !0),
                null
              );
            }
            var a = c(e, t);
            ...
            for (; !r.eol(); )
              if ((r.eatWhile(/[^'"\{\}\\]/), r.eat('\\'))) {
                ...
                if (r.match('{', !1))
                  return (
                    (a.tokenize = n),
                    r.current() ? o : (r.next(), 'punctuation')
                  );
                if (r.match('}}')) return o;
                if (r.match('}')) return g;
                r.eat(/['"]/);
        ...
        function h(e, t, n) {
          ...
          t.scopes.push({ offset: t.indent + x, type: n, align: r });
        }
        function p(e, t) {
          for (
            var r = e.indentation();
            t.scopes.length > 1 && n(t).offset > r;
        ...
        function m(e, t) {
          ...
          if (t.beginningOfLine && '@' == i)
            return e.match(S, !1) ? 'meta' : C ? 'operator' : g;
          if (
            (/\S/.test(i) && (t.beginningOfLine = !1),
            ('variable' != r && 'builtin' != r) ||
              'meta' != t.lastToken ||
              (r = 'meta'),
            ('pass' != i && 'return' != i) || (t.dedent += 1),
            'lambda' == i && (t.lambda = !0),
            ':' != i || t.lambda || 'py' != n(t).type || d(t),
            1 == i.length && !/string|comment/.test(r))
          ) {
            var o = '[({'.indexOf(i);
            if (
              (-1 != o && h(e, t, '])}'.slice(o, o + 1)),
              -1 != (o = '])}'.indexOf(i)))
            ) {
        ...
        for (
          var g = 'error',
            v =
              l.delimiters || l.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
            y = [
              l.singleOperators,
              l.doubleOperators,
              l.doubleDelimiters,
        ...
        var x = l.hangingIndent || a.indentUnit,
          k = i,
          w = o;
        l.extra_keywords != undefined && (k = k.concat(l.extra_keywords)),
          l.extra_builtins != undefined && (w = w.concat(l.extra_builtins));
        ...
        if (C) {
          ...
          (k = k.concat([
            ...
            (w = w.concat(['ascii', 'bytes', 'exec', 'print']));
    ...
    e.defineMode('ruby', function(e) {
      ...
      function r(e, t) {
        ...
        if ('%' == o) {
          ...
          e.eat('s')
            ...
            : e.eat(/[r]/)
            ? (a = 'string-2')
            : e.eat(/[wxq]/) && ((a = 'string'), (f = !1));
          var d = e.eat(/[^\w\s=]/);
          return d
            ? (p.propertyIsEnumerable(d) && (d = p[d]), n(l(d, a, f, !0), e, t))
            : 'operator';
        }
      ...
      function l(e, t, n, r) {
        return function(i, l) {
          var s,
            c = !1;
          for (
            'read-quoted-paused' === l.context.type &&
            ((l.context = l.context.prev), i.eat('}'));
            null != (s = i.next());
            ...
            if (n && '#' == s && !c) {
              if (i.eat('{')) {
                '}' == e &&
                  (l.context = { prev: l.context, type: 'read-quoted-paused' }),
                  l.tokenize.push(o());
                break;
              }
              if (/[@\$]/.test(i.peek())) {
      ...
      return {
        ...
        token: function(e, t) {
          ...
          var n,
            r = t.tokenize[t.tokenize.length - 1](e, t),
            i = u;
          if ('ident' == r) {
            var o = e.current();
            'keyword' ==
              (r =
                '.' == t.lastTok
                  ? 'property'
                  : f.propertyIsEnumerable(e.current())
                  ? 'keyword'
                  : /^[A-Z]/.test(o)
                  ? 'tag'
              ...
              d.propertyIsEnumerable(o)
                ? (n = 'indent')
                : h.propertyIsEnumerable(o)
                ? (n = 'dedent')
                : ('if' != o && 'unless' != o) || e.column() != e.indentation()
                ? 'do' == o && t.context.indented < t.indented && (n = 'indent')
                : (n = 'indent'));
          }
          return (
            (u || (r && 'comment' != r)) && (t.lastTok = i),
            '|' == u && (t.varList = !t.varList),
            'indent' == n || /[\(\[\{]/.test(u)
              ? (t.context = {
                  prev: t.context,
                  type: u || r,
            ...
            e.eol() && (t.continuedLine = '\\' == u || 'operator' == r),
            r
          );
        },
        indent: function(t, n) {
      ...
      function(t) {
          ...
          function n(i, o) {
            ...
            return ('\\' !== a && s === e) || (a === e && '\\' !== c)
              ? (a !== e && t && i.next(),
                ...
                'string')
              : '#' === a && '{' === s
              ? ((o.tokenizer = l(n)), i.next(), 'operator')
              : 'string';
          }
          return null == t && (t = !0), n;
        }
          ...
          if (t.cursorHalf) {
            ...
            if (e.eatWhile(/[\w-]/)) {
              if (e.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                d = e.current().toLowerCase();
                var f = t.prevProp + '-' + d;
                return p.hasOwnProperty(f)
                  ? 'property'
                  : p.hasOwnProperty(d)
                  ? ((t.prevProp = d), 'property')
                  : v.hasOwnProperty(d)
                  ? 'property'
                  : 'tag';
              }
        ...
        function f(e, n) {
          ...
          if ((('@return' !== i && '}' !== i) || c(n), null !== r)) {
            for (
              var o = e.pos - i.length + t.indentUnit * n.indentCount,
                a = [],
                l = 0;
              l < n.scopes.length;
              l++
  ...
  (function(e) {
    ...
    e.defineMode(
      ...
      function(t) {
        ...
        function d(e, t) {
          return e.match(/^#\{/)
            ? ((t.tokenize = s('}', t.tokenize)), null)
            : r(e, t, /[^\\]#\{/, 1, _.token(e, t.htmlState));
        }
        function h(e) {
          return function(t, n) {
            var r = f(t, n);
        ...
        function b(e, t) {
          var n = e.peek();
          return '"' == n || "'" == n
            ? ((t.tokenize = I(n, 'string', !0, !1, v)),
              e.next(),
              t.tokenize(e, t))
            : '[' == n
            ? c(v)(e, t)
            : e.match(/^(true|false|nil)\b/)
            ? ((t.tokenize = v), 'keyword')
            : c(v)(e, t);
        }
        function x(e, t, n) {
          return (
        ...
        function C(n) {
          ...
          var o = e.modes[r];
          return o ? o(t, { name: r }) : e.getMode(t, 'null');
        }
        function S(e) {
        ...
        function M(e, t) {
          ...
          if (e.match(/^(-|==?[<>]?)/))
            return (t.tokenize = a(e.column(), l(e.column(), u))), 'slimSwitch';
        ...
        function P(e, t) {
          return e.match(/^([\[\{\(])/)
            ? x(t, U[RegExp.$1], P)
            : e.match(G)
            ? ((t.tokenize = E), 'slimAttribute')
            : '*' == e.peek()
            ? (e.next(), (t.tokenize = c(D)), null)
            : D(e, t);
        }
        function E(e, t) {
        ...
        function I(e, t, n, r, a) {
          return function(l, c) {
            ...
            if (l.match(/^#\{/, u))
              return u ? ((c.tokenize = s('}', c.tokenize)), null) : t;
        ...
        function D(e, t) {
          return e.match(/^==?/)
            ...
            ? ((t.tokenize = z), null)
            : e.match(/^:/)
            ? ((t.tokenize = A), 'slimSwitch')
            : (p(e, t, 0), t.tokenize(e, t));
        }
        var _ = e.getMode(t, { name: 'htmlmixed' }),
          W = e.getMode(t, 'ruby'),
          R = { html: _, ruby: W },
          H = {
            ruby: 'ruby',
  ...
  (function(e) {
    ...
    e.defineMode('stylus', function(e) {
      function g(e, t) {
        if (
          ...
          (t.context.line.firstWord = ie ? ie[0].replace(/^\s*/, '') : ''),
        ...
        if ('"' == I || "'" == I)
          return e.next(), (t.tokenize = y(I)), t.tokenize(e, t);
        if ('@' == I)
          return e.next(), e.eatWhile(/[\w\\-]/), ['def', e.current()];
        if ('#' == I) {
          if (
            (e.next(), e.match(/^[0-9a-f]{3}([0-9a-f]([0-9a-f]{2}){0,2})?\b/i))
          )
            return ['atom', 'atom'];
      ...
      for (
        var I,
          ...
          ee = t(h),
          te = n(p),
          ne = new RegExp(/^\-(moz|ms|o|webkit)-/i),
          re = n(m),
          ie = '',
          oe = {};
        H.length < R;
        ...
        H += ' ';
      return (
        (oe.block = function(e, t, n) {
          if (('comment' == e && E(t)) || (',' == e && F(t)) || 'mixin' == e)
            return k(n, t, 'block', 0);
          ...
          if ('variable-name' == e)
            return t.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || M(j(t))
              ? k(n, t, 'variableName')
              : k(n, t, 'variableName', 0);
          if ('=' == e)
            return F(t) || M(j(t)) ? k(n, t, 'block') : k(n, t, 'block', 0);
          if ('*' == e && (F(t) || t.match(/\s*(,|\.|#|\[|:|{)/, !1)))
            return (W = 'tag'), k(n, t, 'block');
          if (P(e, t)) return k(n, t, 'pseudo');
          if (/@(font-face|media|supports|(-moz-)?document)/.test(e))
            return k(n, t, F(t) ? 'block' : 'atBlock');
          if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test(e))
            return k(n, t, 'keyframes');
          ...
          if ('word' == e) {
            var r = t.current();
            if ('property' == (W = A(r)))
              return E(t) ? k(n, t, 'block', 0) : ((W = 'atom'), 'block');
            if ('tag' == W) {
              ...
              if (
                ...
                return (
                  (W = 'variable-2'), M(j(t)) ? 'block' : k(n, t, 'block', 0)
                );
            ...
            if ('block-keyword' == W)
              return (
                (W = 'keyword'),
                t.current(/(if|unless)/) && !E(t) ? 'block' : k(n, t, 'block')
              );
            if ('return' == r) return k(n, t, 'block', 0);
            if ('variable-2' == W && t.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/))
              return k(n, t, 'block');
          }
          return n.context.type;
        }),
        (oe.parens = function(e, t, n) {
          ...
          if (')' == e)
            return 'parens' == n.context.prev.type
              ? w(n)
              : (t.string.match(/^[a-z][\w-]*\(/i) && F(t)) ||
                M(j(t)) ||
                /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(j(t)) ||
                (!t.string.match(/^-?[a-z][\w-\.\[\]\'\"]*\s*=/) && L(j(t)))
              ? k(n, t, 'block')
          ...
          if (
            ...
            var r = t.current();
            'tag' == (W = A(r)) && q.test(r) && (W = 'variable-2'),
              ('property' != W && 'to' != r) || (W = 'atom');
          }
        ...
        (oe.atBlock_parens = function(e, t, n) {
          ...
          if ('word' == e) {
            ...
            return (
              (W = A(r)),
              /^(max|min)/.test(r) && (W = 'property'),
              'tag' == W && (W = q.test(r) ? 'variable-2' : 'atom'),
              n.context.type
            );
          }
        ...
        (oe.keyframes = function(e, t, n) {
          return '0' == t.indentation() &&
            ...
            ? k(n, t, 'keyframes')
            : 'word' == e && 'block-keyword' == (W = A(t.current()))
            ? ((W = 'keyword'), k(n, t, 'keyframes'))
            : /@(font-face|media|supports|(-moz-)?document)/.test(e)
            ? k(n, t, F(t) ? 'block' : 'atBlock')
            : 'mixin' == e
            ? k(n, t, 'block', 0)
            : n.context.type;
        }),
        (oe.interpolation = function(e, t, n) {
          return (
            ...
            '}' == e
              ...
              : 'variable-name' == e
              ? k(n, t, 'variableName', 0)
              : ('word' == e && 'tag' == (W = A(t.current())) && (W = 'atom'),
                n.context.type)
          );
        }),
        ...
        (oe.variableName = function(e, t, n) {
          return 'string' == e ||
            ...
            ']' == e ||
            t.current().match(/^(\.|\$)/)
            ? (t.current().match(/^\.[\w-]+/i) && (W = 'variable-2'),
              'variableName')
            : S(e, t, n);
        }),
        {
    ...
    e.registerHelper('hintWords', 'stylus', v),
  ...
  (function(e) {
    ...
    e.defineMode('vue-template', function(t, n) {
      ...
      e.defineMode(
        'vue',
        function(n) {
          return e.getMode(n, { name: 'htmlmixed', tags: t });
        },
        'htmlmixed',
        'xml',
        'javascript',
  ...
  (function(e) {
    ...
    e.defineMode('xml', function(r, i) {
      ...
      function p(e, t, n) {
        return 'word' == e
          ? ((n.tagName = t.current()), (C = 'tag'), y)
          : L.allowMissingTagName && 'endTag' == e
          ? ((C = 'tag bracket'), y(e, t, n))
          : ((C = 'error'), p);
      }
      function m(e, t, n) {
        if ('word' == e) {
      ...
      function b(e, t, n) {
        return 'equals' == e
          ? x
          : (L.allowMissing || (C = 'error'), y(e, t, n));
      }
      function x(e, t, n) {
        return 'string' == e
          ? k
          ...
          token: function(e, t) {
            ...
            return (
              (n || w) &&
                'comment' != n &&
                ((C = null),
                (t.state = t.state(w || n, e, t)),
                C && (n = 'error' == C ? n + ' error' : C)),
              n
            );
          },
          indent: function(t, n, r) {
  ...
  (function(e) {
    ...
    function i(e, t, n) {
      return (
        ...
        (!!/\S(?:[^- ]>|[*\]])\s*$|\*$/.test(e.string.slice(0, n)) ||
          (!(!t.typeAtEndOfLine || e.column() != e.indentation()) || void 0))
      );
    }
    function o(e) {
      for (;;) {
    ...
    function f(e, t) {
      if ((e.backUp(1), e.match(/(R|u8R|uR|UR|LR)/))) {
        ...
        return (
          !!n && ((t.cpp11RawStringDelim = n[1]), (t.tokenize = p), p(e, t))
        );
      }
    ...
    e.defineMode('clike', function(a, s) {
      function c(e, t) {
        ...
        if ((e.eatWhile(E), z)) for (; e.match(z); ) e.eatWhile(E);
        var i = e.current();
        return l(y, i)
          ? (l(k, i) && (h = 'newstatement'), l(w, i) && (p = !0), 'keyword')
          : l(b, i)
          ? 'type'
          : l(x, i)
          ? (l(k, i) && (h = 'newstatement'), 'builtin')
          : l(C, i)
          ? 'atom'
          : 'variable';
      }
        ...
        token: function(e, t) {
          ...
          if (
            ...
            h == a.type
              ...
              : T &&
                ((('}' == a.type || 'top' == a.type) && ';' != h) ||
                  ('statement' == a.type && 'newstatement' == h)) &&
    ...
    var x =
        'auto if break case register continue return default do sizeof static else struct switch extern typedef union for goto while enum const volatile',
      k =
    ...
    m(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
      ...
      types: a(
        k +
          ' bool _Complex _Bool float_t double_t intptr_t intmax_t int8_t int16_t int32_t int64_t uintptr_t uintmax_t uint8_t uint16_t uint32_t uint64_t'
      ),
      ...
      m('text/x-objectivec', {
        ...
        keywords: a(
          x +
            'inline restrict _Bool _Complex _Imaginary BOOL Class bycopy byref id IMP in inout nil oneway out Protocol SEL self super atomic nonatomic retain copy readwrite readonly'
        ),
        types: a(k),
    ...
    m('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function(e, t) {
          return (
            (t.tokenize = b(e.match('""') ? 'triple' : 'single')),
            t.tokenize(e, t)
          );
        },
        '`': function(e, t) {
