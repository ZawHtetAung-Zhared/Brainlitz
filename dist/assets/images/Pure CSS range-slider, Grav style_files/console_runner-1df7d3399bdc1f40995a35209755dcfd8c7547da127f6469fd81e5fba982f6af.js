!(function() {
  ...
  function c(n) {
    ...
    if ('[object Object]' === r) {
      ...
      for (t = 0; t < o.length; t++) {
        var c = n[o[t]];
        if (
          '[object Function]' === (u = {}.toString.call(c)) ||
          '[object Object]' === u ||
          '[object Array]' === u
        )
          return 2;
  ...
  function i(n, t, r) {
    ...
    if (
      ('[object Object]' == (a = e(n)) && (a = 'Object'),
      '[object Number]' == a)
    )
      return '' + n;
    if ('[object Boolean]' == a) return n ? 'true' : 'false';
    if ('[object Function]' == a)
      return n
        .toString()
        .split('\n  ')
        .join('\n' + r);
        ...
        !(function() {
          ...
          window.console[t] &&
            (window.console[t] = function() {
              for (
                var n = [].slice.call(arguments), e = [], o = [], u = 0;
                u < n.length;
                u++
              )
                r(n[u])
                  ? (o.push(i(n[u].outerHTML)), e.push(1))
                  : (o.push(i(n[u])), e.push(c(n[u])));
              s.postMessage(
                [
                  'console',
                  {
  ...
  function a(n) {
    return (
      !!n.origin.match(/codepen/) &&
      ('object' == typeof n.data && 'command' === n.data.type)
    );
  }
  function l(n) {
    if (a(n)) {
