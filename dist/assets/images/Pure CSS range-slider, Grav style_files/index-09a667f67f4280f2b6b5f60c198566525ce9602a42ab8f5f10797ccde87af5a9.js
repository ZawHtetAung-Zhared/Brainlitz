...
var Love = {
  ...
  _createSaveLoveToDBFunc: function() {
    this._saveLoveToDBFunc = _.throttle(
      this._saveLoveChange,
      this.THROTTLE_DELAY,
  ...
  _bindToDOM: function() {
    $('body').on(
      'click',
      'a[id*="loves_"], button[id*="loves_"], span[id*="loves_"]',
      $.proxy(this._onHeartClick, this)
    );
  },
  _onHeartClick: function(e) {
    if ((e.preventDefault(), this._userNeedsToLogin()))
  ...
  _showAsHearted: function(e, t) {
    this._isHeartingComment(e)
      ? this._showCommentHeartAsHearted(e, t)
      : this._showStandardHeartAsHearted(e, t);
  },
  ...
  _showStandardHeartAsHearted: function(e, t) {
    ...
    $.each(s, function(e, n) {
      ...
      if (!s.hasClass('count')) {
        ...
        i
          .removeClass('loved-1 loved-2 loved-3 loved-0')
          .attr('aria-pressed', !1)
          .addClass('loved-' + t),
...
var URLBuilder = {
    getHostURL: function(e, t, n) {
      ...
      return _.template(c, { protocol: i, subdomain: r, host: o, port: a });
    },
    ...
    getItemViewURL: function(e, t, n, s, i) {
      return this.getItemViewURLSimple(
        e,
        t.base_url,
        n,
        s.getActiveSlugHash(),
    ...
    getShortViewURL: function(e, t) {
      return e
        ? [this.SHORT_HOST, e, t.getActiveSlugHash()].join('/')
        : [this.SHORT_HOST, t.getActiveSlugHash()].join('/');
    }
  },
  LocalDataLoader = {
...
var User = Class.extend({
    ...
    saveAccomplishment: function(e) {
      AJAXUtil.post('/accomplishments', { name: e });
    },
    isAnon: function() {
      return +this.id < 2;
    },
...
!(function() {
  ...
  function n(e, t) {
    ...
    var n = t.data('dropdown'),
      i = $(n);
    i.hasClass('open')
      ? (t.attr('aria-expanded', !1), i.removeClass('open'))
      : (t.attr('aria-expanded', !0), s(i, t), i.addClass('open')),
      $('.is-dropdown')
        .not(i[0])
        .removeClass('open');
  }
  function s(e, t) {
    if ('css' !== e.data('dropdown-position')) {
      var n,
        ...
        o = i ? 'right' : 'left';
      (n = i
        ? document.body.offsetWidth - s.left - t.outerWidth()
        : s.left - e.outerWidth() / 2 + 25),
        (n = Math.max(10, n));
      var r = {};
      (r[o] = n), e.css(r);
    }
  ...
  function o() {
    Hub.sub('key', r), Hub.sub('popup-open', i), Hub.sub('popup-close', i);
  }
  function r(e, t) {
    'esc' === t.key && i();
  }
  ...
  (window.Analyze = {
    ...
    ANALYZE_LAMBDA_URL:
      'https://gmqxehjo54.execute-api.us-west-2.amazonaws.com/production/analyze',
    html: function() {
      if (!!('srcdoc' in document.createElement('iframe'))) {
        ...
        for (
          var e = [
              ...
              "<script>function inspect() { HTMLInspector.inspect({domRoot: document.body,excludeRules: ['unnecessary-elements'],onComplete: function(errors) { var cleanErrors = []; for( var i = 0; i < errors.length; i++) { cleanErrors.push({message: errors[i].message, rule: errors[i].rule}) }; parent.postMessage({type: 'html-errors', errors: cleanErrors}, '*')}});};</script>",
              '<script>window.onload = function() { inspect(); }</script>',
              '<style>',
              this._getCodeToCheck('css'),
              '</style>',
              this._getCodeToCheck('html')
            ],
            t = '',
            n = 0;
          n < e.length;
        ...
        (s.sandbox = 'allow-forms allow-scripts'),
          ...
          window.addEventListener(
            'message',
            Analyze.HTMLErrorPostmessageReceiver,
            !1
          ),
        ...
        $.showMessage(
          "Sorry, we can't analyze safely because your browser doesn't support `srcdoc` ... :(",
          1500
        );
    },
    ...
    showHTMLErrors: function(e) {
      if (e.length > 0) {
        ...
        'none' !== CP.pen.html_pre_processor &&
          (CP.htmlEditor.editor.setOption('readOnly', !0),
        ...
        var c = { message: 'The classes ' },
          u = '';
        if (s) {
          var l = Object.keys(i);
          for (r = 0; r < l.length; r++) u = u + l[r] + ' (' + i[l[r]] + ') ';
          (c.message +=
            u + 'are used in the HTML but not found in any stylesheet.'),
            this._getCSSLibs() > 0 &&
              (c.message +=
        ...
        n += '</ul>';
        var d = 0;
        Analyze.errorStorage.html.lintErrorWidgets.push(
          CP.htmlEditor.editor.addLineWidget(
            d,
            $("<div class='inline-editor-error yellow'>" + n + '</div>')[0],
            { coverGutter: !0, noHScroll: !0, above: !0 }
          )
        ),
    ...
    _cssAnalyzeCallback: function(e) {
      if (0 === e.length) $.showMessage("No errors found! You're good.", 1500);
        ...
        CP.cssEditor.showOriginalCode(),
          'none' !== CP.pen.css_pre_processor &&
            (CP.cssEditor.editor.setOption('readOnly', !0),
        ...
        for (var t = 0; t < e.length; t++) {
          var n = e[t].line - 1;
          0 === n && (n = 1),
            Analyze.errorStorage.css.lintErrorWidgets.push(
              CP.cssEditor.editor.addLineWidget(
                n,
                $(
                  "<div class='inline-editor-error'>" +
                    _.escape(e[t].message) +
                    " (<a target='_blank' href='https://google.com/search?q=CSS Lint " +
                    _.escape(e[t].message) +
                    "'>Google it</a>)</div>"
                )[0],
                { coverGutter: !0, noHScroll: !0 }
              )
            );
        }
        var s = e[0].line - 1;
    ...
    _jsAnalyzeCallback: function(e) {
      if (0 === e.length)
        ...
        CP.jsEditor.showOriginalCode(),
          'none' !== CP.pen.js_pre_processor &&
            (CP.jsEditor.editor.setOption('readOnly', !0),
        ...
        for (var t = 0, n = 0; n < e.length; n++) {
          if (null === e[n]) return;
          (t = e[n].line - 1),
            Analyze.errorStorage.js.lintErrorWidgets.push(
              CP.jsEditor.editor.addLineWidget(
                t,
                $(
                  "<div class='inline-editor-error'>" +
                    e[n].reason +
                    " (<a target='_blank' href='https://google.com/search?q=JS Hint " +
                    e[n].reason +
                    "'>Google it</a>)</div>"
                )[0],
                { coverGutter: !0, noHScroll: !0 }
    ...
    _getCodeToCheck: function(e) {
      ...
      return (
        '' ===
          (t =
            CP.pen[e + '_pre_processor' == 'none'] || 'js' === e
              ? CP.pen[e]
              : CP.penProcessor.getProcessed(e)) && (t = ' '),
        t
      );
    },
    _getCSSLibs: function() {
      for (
        var e = 0, t = CP.pen.getResourcesByType('css'), n = 0;
        n < t.length;
        n++
      )
        t[n].url && '' !== t[n].url && e++;
    ...
    clearAllErrors: function(e) {
      for (
        var t = Analyze.errorStorage[e].lintErrorWidgets, n = 0, s = t.length;
        n < s;
        n++
      )
        t[n].clear();
    ...
    showUnprocessedCodeButton: function(e) {
      var t = { ui: { editorViewSource: {} } };
      (CP.ui.editorViewSource[e] = !0), Hub.pub('ui-change', t);
      var n = $(".view-compiled-button[data-type='" + e + "']")
        .closest('.box')
        .data('preprocessor');
      $(".view-compiled-button[data-type='" + e + "']").text(
        'View Uncompiled ' + n
      ),
    ...
    _getClearErrorsButtonHTML: function(e) {
      var t = { type: e, upCaseType: e.toUpperCase() };
...
var CodeEditorAnalyze = Class.extend({
      ...
      $('#analyze-html')._on('click', this.analyzeHTML, this),
        ...
        $(document)
          .on(
            'click',
            '#clear-html-errors',
            $.proxy(this.clearHTMLErrors, this)
          )
          .on('click', '#clear-css-errors', $.proxy(this.clearCSSErrors, this))
          .on('click', '#clear-js-errors', $.proxy(this.clearJSErrors, this));
    },
  ...
  CMEditorSettings = {
    ...
    getEmmetSnippets: function(e) {
      var t = e.snippets;
      return t
        ? ((t.markupSnippets = this.unescapeSnippet(t.markupSnippets)),
          (t.stylesheetSnippets = this.unescapeSnippet(t.stylesheetSnippets)),
          {
            globals: {
              markup: { snippets: t.markupSnippets },
              stylesheet: { snippets: t.stylesheetSnippets }
            }
          })
        : {
            globals: { markup: { snippets: {} }, stylesheet: { snippets: {} } }
          };
    },
  ...
  BaseEditorKeyBindingsMixin = {
    ...
    _canAdjustRenderedLine: function(e) {
      return (
        (void 0 === TypesUtil ||
          'html' === TypesUtil.cmModeToType(e.getOption('mode'))) &&
        ('undefined' != typeof CP.pen &&
          'tabs' !== CP.pen.editor_settings.indent_with)
      );
    },
  ...
  BaseEditor = Class.extend({
    ...
    _baseBindToHub: function() {
      Hub.sub('page-loading-done', $.proxy(this._onPageLoadingDone, this)),
        ...
        Hub.sub(
          'cm-update-keybindings',
          $.proxy(this._onCMUpdateKeybindingsEvent, this)
        ),
    ...
    _onKey: function(e, t) {
      'esc' === t.key &&
        (this.editor.execCommand('clearSearch'), this.runRefresh(200));
    },
    _onBasePenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.editor_settings.indent_with') &&
        this.editor.setOption(
          'indentWithTabs',
          CMEditorSettings.getIndentWithTabs(t.pen.editor_settings)
        ),
        ObjectUtil.hasNestedValue(t, 'pen.editor_settings.tab_size') &&
          (this.editor.setOption(
            'tabSize',
            CMEditorSettings.getTabSize(t.pen.editor_settings)
          ),
          this.editor.setOption(
            'indentUnit',
            CMEditorSettings.getTabSize(t.pen.editor_settings)
    ...
    _syncWithCollab: function() {
      ...
      (this.firepad = Firepad.fromCodeMirror(
        CP.collabRoom.getFirebaseEditorRef(this.type),
        this.editor,
        {
          richTextShortcuts: !1,
          richTextToolbar: !1,
    ...
    _syncWithProfessor: function() {
      this.firepad = Firepad.fromCodeMirror(
        ProfessorRoom.getFirebaseEditorRef(this.type),
        this.editor,
        {
          richTextShortcuts: !1,
          richTextToolbar: !1,
    ...
    _getEditorConfig: function() {
      var e = _.extend(
        CMEditorSettings.getDefaultEditorConfig(
          this._getEditorConfigDefaultValue(),
          CP.pen.editor_settings,
          window.__mobile
        ),
        this._getEditorTypeSpecificConfig()
      );
      return (
        (e.extraKeys = {
          Tab: 'respectfulTab',
        ...
        'js' !== this.type &&
          !0 === e.emmet_active &&
          (e.extraKeys.Tab = function(e) {
            !0 !== e.execCommand('emmetExpandAbbreviation') &&
              e.execCommand('respectfulTab');
          }),
        e
      );
    },
    _getEditorConfigDefaultValue: function() {
      return 'collab' === window.__pageType || 'professor' === window.__pageType
        ? ''
        : this.value;
    },
    ...
    _bindAutoComplete: function() {
      ...
      !0 === e.autocomplete &&
        'html' !== e.syntax &&
        this.editor.on('inputRead', function(e, t) {
          !e.state.completionActive &&
            '+input' === t.origin &&
            1 === t.text.length &&
            /^[a-zA-Z]+$/.test(t.text[0]) &&
            CodeMirror.commands.autocomplete(e, null, { completeSingle: !1 });
        });
    },
    ...
    _setEditorValue: function(e) {
      'collab' !== window.__pageType &&
        'professor' !== window.__pageType &&
    ...
    _changeMode: function(e) {
      this.editor.setOption(
        'mode',
        EditorModes.getCMMode(e, this._getBasicType())
      );
    },
...
!(function() {
  ...
  function o(e) {
    var t = { console: { consoleData: k.val() } };
    e
      ? ((t.console.command = e), Hub.pub('console-change', t))
      : Hub.pub('console-change', t);
  }
  function r(e, t) {
    ...
    '' !== e &&
      ('clear()' !== e && 'clear();' !== e
        ? (l(e),
          ...
          g(e),
          p(e),
          'professor' === Y && (clearTimeout(G), o(e)),
          y())
        : m());
  }
  function c(e) {
  ...
  function l(e) {
    (R = 0), F.unshift(e), F.length > H && F.pop();
  }
  function d() {
  ...
  function h(e) {
    ...
    t.length &&
      'console' === t[0] &&
      (t[1]['function'] && 'clear' === t[1]['function'] ? m() : f(t[1]));
  }
  function p(e) {
  ...
  function f(e) {
    e.arguments &&
      (e.arguments.join(' ').length > z && (e = W),
      !1 === j ? (B.push(e), B.length > V && (B.shift(), (N = !0))) : _(e));
  }
  function _(e) {
    var t = $(O);
    ...
    if (s > 1) {
      ...
      t.hasClass('error')
        ? t.text(i)
        : CodeMirror.runMode(i, { name: 'javascript', json: !0 }, t.get(0)),
        A.append(t);
    d();
  }
  function g(e) {
  ...
  function C() {
    var e = D.value;
    (D.value = ''), (I = D.scrollHeight), (D.value = e);
  }
  function y() {
    if ('' === $(D).val()) D.rows = 1;
    else {
      var e,
        t = 0 | D.getAttribute('data-min-rows');
      (D.rows = t),
  ...
  function P() {
    (j = !0), !0 === N && (_(J), (N = !1));
    for (var e = 0; e < B.length; e++) _(B[e]);
    (B = []), setTimeout(v, 1);
  }
  function w() {
    j = !1;
  ...
  function S() {
    k.addClass('disabled'), (U = !0);
  }
  function T() {
    k.removeClass('disabled'), (U = !1);
  }
  function E() {
    k.focus();
  }
  function x(e, t) {
    k.val(t.console.consoleData),
      t.console.command && (g(t.console.command), p(t.console.command));
  }
  CP.ConsoleEditor = {};
  var A,
    k,
    M,
    D,
    O = "<pre class='console-message CodeMirror-line'></pre>",
    F = [],
    H = 100,
    R = -1,
    L = '',
    ...
    J = {
      function: 'error',
      arguments: [
        'Logs Trimmed: To keep things fast we only stored the last ' +
          (V - 1) +
          ' messages while the CodePen console was closed, the others will be in the browser console.'
      ],
      complexity: 1
    },
    Y = __pageType,
...
var CSSEditor = BaseEditor.extend({
  ...
  _onPenChange: function(e, t) {
    ObjectUtil.hasNestedValue(t, 'pen.css_pre_processor') &&
      this._preProcessorChanged(t.pen.css_pre_processor);
  },
  _onPageLoadingDone: function() {
    this.mobile &&
      setTimeout(
  ...
  _getEditorTypeSpecificConfig: function() {
    return { mode: this.getMode(), syntax: 'css' };
  },
  ...
  _emmetSupportedSyntaxes: function() {
    return _.difference(
      __preprocessors.css.syntaxes,
      __preprocessors.css.exclude_emmet_syntaxes
    );
  }
});
!(function() {
  ...
  function t(e) {
    ...
    $('.maximize', e).click(function() {
      ...
      $('.fold-all-button', e).on('click', function(e) {
        'collab' === window.__pageType
          ? CP.CodeEditorsFoldView.foldAll(e, t)
          : Hub.pub('fold-all', t);
      }),
      $('.unfold-all-button', e).on('click', function(e) {
        'collab' === window.__pageType
          ? CP.CodeEditorsFoldView.unfoldAll(e, t)
          : Hub.pub('unfold-all', t);
      });
  }
  (CP.editorDropDowns = {}),
...
var EditorModes = {
  ...
  getCMMode: function(e, t) {
    return 'html' === t
      ...
      : 'js' === t
      ? e in this.jsModes
        ? { name: this.jsModes[e], globalVars: !0 }
        : 'text'
      : void 0;
  }
};
  ...
  (function() {
    ...
    function t() {
      if (__user && __item && 1 !== __user.id && __user.id === __item.user_id) {
        ...
        CPLocalStorage.setItem(
          e + '-editor-folding',
          JSON.stringify({ html: t, css: s, js: i })
        );
      }
    }
    function n(e) {
...
var HTMLEditor = BaseEditor.extend({
    ...
    _onPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.html_pre_processor') &&
        this._preProcessorChanged(t.pen.html_pre_processor);
    },
    _getEditorTypeSpecificConfig: function() {
      var e = !0;
      return (
        __pageType && 'embed' === __pageType && (e = !1),
        { mode: this.getMode(), syntax: 'html', profile: 'xhtml', autofocus: e }
      );
    },
    _completeAfter: function(e, t) {
      return (
        (t && !t()) ||
          setTimeout(function() {
            e.state.completionActive || e.showHint({ completeSingle: !1 });
          }, 100),
        CodeMirror.Pass
      );
    },
    ...
    _completeIfInTag: function(e) {
      return this._completeAfter(e, function() {
        ...
        return (
          !!(
            'string' != t.type ||
            (/['"]/.test(t.string.charAt(t.string.length - 1)) &&
              1 != t.string.length)
          ) && CodeMirror.innerMode(e.getMode(), t.state).state.tagName
        );
      });
    },
    _setEditorTypeSpecificOptions: function(e) {
  ...
  JSEditor = BaseEditor.extend({
    ...
    _onPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.js_pre_processor') &&
        this._preProcessorChanged(t.pen.js_pre_processor);
    },
    _getEditorTypeSpecificConfig: function() {
...
!(function() {
  ...
  function s() {
    CP.CodeEditorsResizeEvents._canDrive &&
      d.model.TOP_TYPES.forEach(function(e) {
        var t = $('#box-' + e),
          n = CP.ui.editorSizes[e],
          s = 0 === n;
        t
          .find('.editor-actions-right button')
          .not('.close-editor-button')
          .attr('disabled', s),
          (s = 0 === n || 1 === n),
  ...
  var d, h;
  CP.CodeEditorsResizeEvents = { _canDrive: !0 };
  ...
  (function() {
    function e(e) {
      ...
      if (t)
        for (
          var n = t.substring(1).split('&'), s = 0, i = n.length;
          s < i;
          s++
        ) {
          var o = n[s].split('=');
    ...
    function n() {
      var e = { ui: { editorSizes: CP.ui.editorSizes } };
      Hub.pub('ui-change', e);
    }
    function s() {
      var e = 0;
    ...
    CP.CodeEditorResizeModel = {
      ...
      INITIAL_CONSOLE_SIZES: { 0: 'closed', 1: 1 / 3, 2: 1 },
      init: function() {
        var t = e('editors');
        if (t && '111' !== t && '1110' !== t) {
      ...
      toggle: function(e) {
        t(e), this[0 === CP.ui.editorSizes[e] ? 'open' : 'close'](e);
      },
      close: function(e) {
        t(e);
      ...
      updateEditorSizes: function(e) {
        for (var t in e) CP.ui.editorSizes[t] = e[t];
        n(), Hub.pub('save-editor-sizes');
      },
      getEditorPositions: function() {
        var e = [],
          t = 0;
  ...
  (BarDragger.prototype.staticClick = function(e, t) {
    this.emitEvent('staticClick', [e, t]),
      this.didFirstClick
        ? (this.emitEvent('doubleClick', [e, t]),
  ...
  (function() {
    function e(e, r, a, c) {
      var u = !1;
      for (var l in r)
        if (((o.style[l] = r[l]), !(u = e.style[l] == o.style[l]))) break;
      if (!u) {
        var d = [];
        for (l in r) d.push(l);
        (e.style[n] = d.join('')),
  ...
  (function() {
      ...
      t(),
        ...
        M.each(function(e, t) {
          var n = $(t)
            .find('.box-title')
            .clone();
          n.addClass('box-title--resizer'), D.eq(e).append(n);
        });
    }
    function t() {
      (C = D.width()), (y = D.outerHeight()), (P = F.outerHeight());
    }
    function n(e, t) {
      ...
      (n.index = e),
        n.on('doubleClick', r),
        e > 0 &&
          (n.on('dragStart', s), n.on('dragMove', i), n.on('dragEnd', o));
    }
    function s() {
      d(this);
    }
    ...
    function u(e, t) {
      CP.CodeEditorsResizeView.setEditorSizes(t.ui.editorSizes, !0),
        v(),
        Hub.pub('editor-refresh', { delay: 10 });
    }
    function l() {
      M.width('').height(''),
        A.width('').height(''),
    ...
    function d(e) {
      CP.codeEditorResizeController.events &&
        (CP.codeEditorResizeController.events._canDrive &&
          !T &&
          ((w = b.getEditorPositions()), (S = w[e.index]), (T = e), h()));
    }
    function h() {
      x =
        'top' === CP.ui.layout
    ...
    function f(e) {
      CP.codeEditorResizeController.events._canDrive &&
        ...
        Hub.pub('editor-refresh', { delay: 0 }),
        (T = null),
        (E = null));
    }
    function _(e) {
      var t = b.TOP_TYPES[e.index];
      1 === CP.ui.editorSizes[t]
        ? Hub.pub('editor-reset-sizes')
...
var CodeEditorsTidyController = Class.extend({
  ...
  CodeEditorTidyModel = Class.extend({
    init: function() {
      this.BEAUTIFY_LAMBDA_URL =
        'https://gmqxehjo54.execute-api.us-west-2.amazonaws.com/production/beautify';
    },
    beautify: function(e) {
      ...
      s && (n = t),
        'js' === e &&
          'typescript' === CP.pen.js_pre_processor &&
          (e = 'typescript'),
        'css' === e &&
          (('scss' !== CP.pen.css_pre_processor &&
            'less' !== CP.pen.css_pre_processor) ||
            (e = CP.pen.css_pre_processor)),
        $.post(
          this.BEAUTIFY_LAMBDA_URL,
          {
            type: e,
    ...
    _beautifyLambdaCallback: function(e, t, n) {
      ...
      t
        ? (s.replaceSelection(n, 'around'),
          'js' === e && s.execCommand('indentAuto'))
        : s.setValue(n);
    },
    _getIndentWidth: function() {
      return 'tabs' === CP.pen.editor_settings.indent_with
        ? 1
        : parseInt(CP.pen.editor_settings.tab_size, 10);
    },
  ...
  CodeEditorsTidyView = Class.extend({
    ...
    _syncStateOfTidyButtons: function(e) {
      ObjectUtil.hasNestedValue(e, 'html_pre_processor') &&
        this._hideShowTidyButton(
          e.html_pre_processor,
          ['none'],
          this.$htmlTidyButton
        ),
        ObjectUtil.hasNestedValue(e, 'css_pre_processor') &&
          this._hideShowTidyButton(
            e.css_pre_processor,
            ['none', 'scss', 'less', 'postcss'],
            this.$cssTidyButton
          ),
        ObjectUtil.hasNestedValue(e, 'js_pre_processor') &&
          this._hideShowTidyButton(
            e.js_pre_processor,
  ...
  CodeEditorsCSSTransitionHandler = Class.extend({
    ...
    _bindToDOM: function() {
      ...
      $('#box-html, #box-css #box-js').on(
        this._getBrowserTransitionEventName(),
        e
      );
    },
  ...
  CodeEditorsViewSourceEvents = Class.extend({
    ...
    _toggleViewSource: function(e, t) {
      this._canDrive &&
        this.controller.toggleViewSource({ type: this._getType(t) });
    },
    _getType: function(e) {
      return $(e)
        .data('type')
    ...
    _onPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.html_pre_processor') &&
        this.controller.setViewSourceToFalse({ type: 'html' }),
        ObjectUtil.hasNestedValue(t, 'pen.css_pre_processor') &&
          this.controller.setViewSourceToFalse({ type: 'css' }),
        ObjectUtil.hasNestedValue(t, 'pen.js_pre_processor') &&
          this.controller.setViewSourceToFalse({ type: 'js' });
    },
    _penProcessed: function() {
      for (var e = ['html', 'css', 'js'], t = 0; t < e.length; t++) {
        var n = e[t];
        CP.ui.editorViewSource[n] &&
          (this.controller.toggleViewSource({ type: n }),
          this.controller.toggleViewSource({ type: n }));
      }
    }
  }),
    ...
    syncWithServer: function(e) {
      for (var t in e.ui.editorViewSource)
        (CP.ui.editorViewSource[t] = e.ui.editorViewSource[t]),
          this._publishChangeEvent({ type: t });
    },
  ...
  CodeEditorsViewSourceView = Class.extend({
    ...
    _toggleViewSource: function(e, t) {
      ...
      if (t) {
        n.showSource();
        var s = $(".view-compiled-button[data-type='" + e + "']")
          .closest('.box')
          .data('preprocessor');
        $(".view-compiled-button[data-type='" + e + "']").text(
          'View Uncompiled ' + ('None' !== s ? s : '')
        ),
          $(".view-compiled-button[data-type='" + e + "']").addClass('active'),
          CP.codeEditorTidyController.disable(e, !0);
      } else
        $(".view-compiled-button[data-type='" + e + "']").text(
          'View Compiled ' + e.toUpperCase()
        ),
          n.showOriginalCode(),
          $(".view-compiled-button[data-type='" + e + "']").removeClass(
            'active'
          ),
  ...
  UI = {
    buildDefaultUIData: function() {
      return {
        ...
        editorViewSource: { html: !1, css: !1, js: !1 },
        editorSizes: { html: 1 / 3, css: 1 / 3, js: 1 / 3, console: 'closed' },
        settings: { pane: 'closed', tab: 'details', css: { addons: 'closed' } }
      };
    }
  };
!(function(e) {
  var t = ['html', 'css', 'js'];
  e.constants = { editorTypes: t };
  ...
  (function() {
    ...
    function o(e) {
      return (
        !!e.origin.match(window.__CPDATA.host) &&
        'logged-into-codepen' === e.data.type
      );
    }
    function r(e) {
      return (
        !!e.origin.match(window.__CPDATA.host) &&
        'redirect-to-login' === e.data.type
      );
    }
    function a(e) {
    ...
    function c() {
      $.cookie('always_save_as_anon', 'true', { expires: d, path: '/' });
    }
    function u() {
      return (
        !(window.__user.id > 1) &&
        ('' !== window.__item.slug_hash &&
          (!(window.__item.user_id > 1) &&
            (!$.cookie('always_save_as_anon') && window.__save_as_anon_pen)))
      );
    }
    function l() {
      return (
        !(window.__user.id < 2) &&
        ('' !== window.__item.slug_hash &&
          (!(window.__item.user_id > 1) && window.__save_as_anon_pen))
      );
    }
...
var Pen = Class.extend({
  ...
  _showForkedMessage: function() {
    CPLocalStorage.getItem(this.slug_hash + '-fork') &&
      ($.showMessage('Pen Forked'),
      CPLocalStorage.removeItem(this.slug_hash + '-fork'));
  },
  setItemValue: function(e) {
    var t = this._cloneObject(e);
    for (var n in (t.item && (t.pen = t.item), t.pen))
  ...
  _setValue: function(e, t) {
    if (_.isObject(t) && !_.isArray(t)) for (var n in t) this[e][n] = t[n];
    else this[e] = t;
  ...
  addPackage: function(e, t) {
    (this.npmPackagesUpdatedAt = new Date().getTime()),
      (this.npm_packages[e] = { id: '', name: e, version: t, _destroy: !1 }),
    ...
    this.save_disabled ||
      (this._canSave()
        ? this._shouldForkPen()
          ? this._forkPen()
          : this._savePenToDB()
        : Hub.pub('pen-errors', this.errorCode));
  },
  ...
  saveAsPrivate: function() {
    this._canSave()
      ? ((this['private'] = !0), this._savePenToDB())
      : Hub.pub('pen-errors', this.errorCode);
  },
  MAX_PEN_SIZE: 1e6,
  _canSave: function() {
    return !CP.user.isUserLoggedIn() && this._isProfessorOrCollabSession()
      ? ((this.errorCode = 'anon-cannot-save-during-rt-session'), !1)
      : !(
          JSON.stringify(this.getSaveableCopyOfPen()).length > this.MAX_PEN_SIZE
        ) || ((this.errorCode = 'pen-too-large'), !1);
  },
  ...
  doneSave: function(e) {
    ...
    if (
      ...
      if (this._isProfessorOrCollabSession()) {
        var n = { newPen: !0, url: e.redirect_url, pen: t };
        Hub.pub('pen-saved', n);
      } else
        Hub.pub('save-editor-sizes', e.slug_hash),
          this.slug_hash &&
            CPLocalStorage.setItem(e.slug_hash + '-fork', 'fork'),
  ...
  _getFullRedirectURL: function(e) {
    ...
    return t.length > 1
      ? this._stripQuestionMarkInURL(
          e.redirect_url + '?' + this._stripTemplateQueryPart(t[1])
        )
      : e.redirect_url;
  },
  ...
  erroredSave: function() {
    if (
      ((this.saveAttempts += 1), this.saveAttempts < this.MAX_SAVE_ATTEMPTS)
    ) {
  ...
  isUserPenOwner: function() {
    return (
      '' === this.slug_hash ||
      (CP.profiled.is_team
        ? CP.profiled.id === CP.user.current_team_id
        : CP.user.isAnon()
        ? this.session_hash === CP.user.session_hash
        : CP.profiled.id === CP.user.id)
    );
  },
  ...
  getSaveableCopyOfPen: function() {
    return window._cloneDeep(
      _.reduce(
        this._getDataRelevantAttributes(),
        function(e, t) {
          return (e[t] = this[t]), e;
        },
        {},
...
!(function() {
  ...
  var a = 6e3,
    c = 86400,
    u = 10,
    l = { mostRecentUpdatedAt: 0, updatedAts: [], versions: [] },
    d = _.debounce(s, a, { leading: !1, maxWait: a, trailing: !0 });
  Hub.sub('page-loading-done', r),
    (window.penLocalStorage = { getPenVersionsData: t });
})();
var PenAutosave = Class.extend({
    ...
    init: function() {
      (this._mobile = window.__mobile),
        (this.autoSaveFunc = _.debounce(
          this._saveViaAutoSave,
          this.AUTOSAVE_TIMER,
          { leading: !1, trailing: !0 }
        )),
        this._bindToHub(),
    ...
    _startAutoSave: function() {
      this._penCanBeAutosaved() &&
        this._conditionallyShowAutosavingNowMessage();
    },
    _onLiveChange: function() {
      this._penCanBeAutosaved()
        ? this._handleAutoSave()
        : this._handleNonAutoSave();
    },
    _handleAutoSave: function() {
      this.autoSaveFunc();
    },
    _saveViaAutoSave: function() {
      this._autoSavePenRightNow() &&
        ((CP.pen.autosavingNow = !0), CP.pen.save());
    },
    _autoSavePenRightNow: function() {
      return (
        !$('.history').hasClass('active') &&
        !CP.settingsController.settingsPaneVisible()
      );
    },
    _handleNonAutoSave: function() {
      if (!CP.pen.isUserPenOwner() || CP.pen.save_disabled) return !1;
      (this.liveChangesWOSave += 1),
        $('#save, #update').removeClass('unsaved-wobble unsaved-grow'),
        6 === this.liveChangesWOSave &&
          $('#save, #update').addClass('unsaved-wobble'),
        11 === this.liveChangesWOSave &&
          $('#save, #update').addClass('unsaved-grow'),
        16 === this.liveChangesWOSave &&
          $.showMessage(
            'There have been 15 changes without a save. Remember to save your work!',
            'slow'
          ),
        21 === this.liveChangesWOSave &&
          $('#save, #update').addClass('unsaved-wobble');
    },
    _onSaved: function() {
    ...
    _conditionallyShowAutosavingNowMessage: function() {
      this._showedUserAutoSaveOnMessage ||
        (this._penCanBeAutosaved() && this._showAutoSaveOnMessage());
    },
    ...
    _penCanBeAutosaved: function() {
      return (
        !!this._userInitiatedSavePreviously() &&
        (CP.user.isUserLoggedIn() &&
          CP.pen.editor_settings.auto_save &&
          CP.pen.getActiveSlugHash().length > 0 &&
          !this._mobile)
      );
    },
  ...
  PenDelete = Class.extend({
    ...
    _deletePen: function() {
      $.showModal(
        '/ajax/confirm_pen_delete',
        'modal-warning',
        $.proxy(this._deletePenModalCallback, this)
      );
    },
    ...
    _getURLToReturnTo: function() {
      return (
        CP.profiled.base_url + '/pens/' + this._getProfilePageToReturnTo() + '/'
      );
    },
  ...
  PenResourcesData = {
    ...
    setResource: function(e, t) {
      this._setResourceURL(_.find(this.resources, { view_id: e }), t),
    ...
    getResourcesByType: function(e) {
      return _.select(this.resources, { resource_type: e });
    },
    ...
    _ensureMinNumberOfResourcesForType: function(e) {
      for (
        var t = this.MIN_RESOURCES - this.getResourcesByType(e).length, n = 0;
        n < t;
        n++
      )
        this.resources.push({
    ...
    _ensureResourcesHaveActions: function() {
      _.forEach(this.resources, function(e) {
        _.isUndefined(e.action) &&
          (e.action = 'include_' + e.resource_type + '_url');
      });
    },
    ...
    _quickAddResource: function(e, t) {
      var n = _.find(this.getResourcesByType(e), { url: '' });
    ...
    _updateResourcesOrder: function(e, t) {
      for (var n = 0, s = this.resources.length; n < s; n++)
        this.resources[n].resource_type === e &&
          (this.resources[n].order = t[this.resources[n].view_id]);
      this._storeResourcesByOrder();
    },
    ...
    _deleteResource: function(e) {
      var t = _.findIndex(this.resources, { view_id: e });
    ...
    _publishResourcePenChange: function(e) {
      Hub.pub('pen-change', {
        origin: 'client',
        rebind: e,
        pen: { resources: _.cloneDeep(this.resources) }
      });
    }
  },
  PenSaver = Class.extend({
    ...
    _warnAboutLostChanges: function() {
      window.onbeforeunload = $.proxy(function() {
        if (!this.skipWarning)
          return this._shouldWarnAboutLostWork()
            ? Copy.youHaveUnsavedChanges
            : void 0;
      }, this);
    },
    _shouldWarnAboutLostWork: function() {
      var e = CP.pen.hasPenContentChanged();
      return 'professor' === this.pageType
        ? e && this._isProfessorInProfessorRoom()
        : 'collab' === this.pageType
        ? e && this._isPenOwnerInCollabRoom()
        : e && !CP.pen.redirectingToSavedURL && !CP.pen.save_disabled;
    },
    _isProfessorInProfessorRoom: function() {
      var e = !1;
      return (
        'professor' === this.pageType &&
          'undefined' != typeof CP.professor &&
          (e = !0),
        e
      );
    },
  ...
  LocalDataValidator = {
    ...
    _getValidAttributeValue: function(e, t, n) {
      var s = e[t];
      return 'array' === s['typeof']
        ? this._getValidArrayType(n, s)
        : _.isArray(s['typeof'])
        ? this._getValidArrayAttributeValue(n, s)
        : 'object' === s['typeof']
        ? this._getValidObjectType(n, s)
        : this._getValidSimpleAttributeValue(n, s);
    },
  ...
  PenValidator = Class.extend({
    dataAttributes: {
      ...
      description: { typeof: 'string', default: '' },
      slug_hash: { typeof: 'string', default: '' },
      html: { typeof: 'string', default: '' },
      css: { typeof: 'string', default: '' },
      js: { typeof: 'string', default: '' },
      parent: { typeof: 'number', default: 0 },
      private: { typeof: 'boolean', default: !1 },
      template: { typeof: 'boolean', default: !1 },
      js_module: { typeof: 'boolean', default: !1 },
      npm_packages: { typeof: 'object', default: {} },
      html_pre_processor: {
        typeof: __preprocessors.html.syntaxes,
        default: __preprocessors.html['default']
      },
      html_classes: { typeof: 'string', default: '' },
      head: { typeof: 'string', default: '' },
      css_pre_processor: {
  ...
  Project = Class.extend({
    ...
    getURLSlugHash: function() {
      return this['private']
        ? this.slug_hash_private + '/' + this.slug_hash
        : this.slug_hash;
    },
    getTags: function() {
      return _.uniq(_.clone(this.tags).concat(_.clone(this.newTags)));
    ...
    saveDetails: function() {
      this._updateSaveableTagsPriorToSave(),
        this.put(
          '/projects/project/' + this.slug_hash,
          {
            _isJSON: !0,
            json: {
              payload: {
    ...
    _updateBrowserURL: function() {
      if (window.history.replaceState && CP.item.getActiveSlugHash()) {
        var e = URLBuilder.getItemViewURL(
          'details',
          CP.profiled,
          CP.item.itemType,
          CP.item,
    ...
    forkProject: function() {
      this.post(
        '/projects/fork',
        { _isJSON: !0, json: { source: this.slug_hash } },
  ...
  PenActions = Class.extend({
    ...
    _liveViewPopout: function() {
      window.open($('#live-link').attr('href')),
        CP.CodeEditorsResizeView.setEditorSizes({ editor: '1' });
    }
  }),
...
!(function() {
  function e() {
    'vim' === CP.pen.editor_settings.key_bindings &&
      (CodeMirror.commands.save = function() {
        CP.pen.save();
      });
  }
  function t() {
    $('body').on('click', '.keyboard-commands-button', n), l.on('click', i);
  }
  function n(e) {
    e && e.preventDefault(), d ? i() : s();
  }
  function s() {
    !d &&
      u.length &&
      (u.show(), CP.showPopupOverlay(), (d = !0), Hub.pub('popup-open', h));
  }
  function i() {
    d && u.length && (u.hide(), CP.hidePopupOverlay(), (d = !1));
  }
  function o() {
  ...
  function c() {
    Keytrap.bind(
      ...
      Keytrap.bind(
        'comctrl+shift+.',
        function() {
          CP.htmlEditor.hasFocus() &&
            CP.htmlEditor.editor.execCommand('closeTag');
        },
        !0
      );
  }
      ...
      if (_.contains(['scss', 'sass'], e.css_pre_processor)) {
        ...
        n.test(e.css) &&
          (t.css = {
            ...
            type: 'css',
            message:
              "The function inline-image can not be used on CodePen since it depends on reading images from disk. We've removed it.",
            level: 'warn',
            pretty_name: 'SCSS'
          });
        var s = /image-width\(/i;
        s.test(e.css) &&
          (t.css = {
            ...
            type: 'css',
            message:
              "The function image-width can not be used on CodePen since it depends on reading images from disk. We've removed it.",
            level: 'warn',
            pretty_name: 'SCSS'
          });
        ...
        i.test(e.css) &&
          (t.css = {
            ...
            type: 'css',
            message:
              "The function image-height can not be used on CodePen since it depends on reading images from disk. We've removed it.",
            level: 'warn',
            pretty_name: 'SCSS'
          });
      }
      if ('less' === e.css_pre_processor) {
        ...
        o.test(e.css) &&
          (t.css = {
            ...
            type: 'css',
            message:
              "The function data-uri can not be used because it's insecure. We've removed it from your LESS code.",
            level: 'warn',
            pretty_name: 'LESS'
          });
      }
      if (e.css) {
        ...
        r.test(e.css) &&
          (t.css = {
            ...
            type: 'css',
            message:
              "You don't need to include a style tag. Just put here what you would normally include in the style tag.",
            level: 'warn',
            pretty_name: 'CSS'
          });
      }
    ...
    _regexReplaceHTML: function(e, t, n) {
      for (var s = 0; s < n.length; s++)
        if (n[s].action === t) {
          ...
          o = (o = (o = o.replace(/\//g, '\\/')).replace(/\[/g, '\\[')).replace(
            /\]/g,
            '\\]'
          );
          ...
          e = e.replace(
            r,
            this.getContentToReplaceTemplateText(i, n[s].content)
          );
        }
      return e;
    },
...
!(function() {
  ...
  function t(e) {
    return !_.find(e, { level: 'error' });
  }
  function n(e) {
    clearTimeout(k), s('all'), _.size(e) && o(e);
  }
  function s(e) {
  ...
  function i(e) {
    ...
    if (t) {
      for (var n = A[e].widgets, s = 0, i = n.length; s < i; s++) n[s].clear();
  ...
  function u(e, t) {
    ...
    return (
      e.addLineClass(s, 'background', 'line-highlight'),
      e.addLineWidget(s, n, { coverGutter: !0, noHScroll: !0 })
    );
  }
  function l(e, t) {
    for (var n = 0; n < t.hits.length; n++) {
      var s = t.hits[n];
      if (s.name === e.name)
        return e.version, { name: s.name, version: s.version };
    }
    return null;
  }
  function d(e) {
    ...
    return Promise.all(t).then(function(t) {
      ...
      return { foundPackages: s, missingPackages: n };
    });
  }
  function h(e, t) {
  ...
  function p() {
    CP.pen.setItemValue({
      origin: 'client',
      pen: { js_pre_processor: 'babel' }
    });
  }
  function f(e) {
    e.preventDefault();
    var t = A.js.solution;
    t.errorType === M.dependency &&
      (p(),
      d(t.dependencies).then(function(e) {
        e.missingPackages.length > 0
          ? n(h(t, e.missingPackages))
  ...
  function g(e) {
    e.errorType === M.dependency &&
      d(
        e.dependencies.filter(function(e) {
          return 'peer' === e.type;
        })
      ).then(function(e) {
        e.foundPackages.forEach(function(e) {
  ...
  function m(e) {
    var t = e.dependencies.map(function(e) {
      ...
      n = t[0];
    return t.length > 2
      ? n + ' and ' + (t.length - 1) + " other packages haven't been loaded."
      : 2 === t.length
      ? n + ' and ' + t[1] + " haven't been loaded."
      : n + " hasn't been loaded.";
  }
  function v(e) {
  ...
  function C(e) {
    ...
    return e.errorType === M.dependency
      ? "<div class='inline-editor-error yellow " +
          t +
          "'><div class='inline-error-message'><%= message %> <a href='#' class='js-editor-solution'>Install now?</a></div></div>"
      : "<div class='inline-editor-error " +
          t +
          "'><div class='inline-error-message'><%= message %></div></div>";
  }
  function y(e) {
    var t = v(e);
    return _.template(C(e), { message: P(t) });
  }
  function P(e) {
    return _htmlEntities(e)
      .replace(/&lt;br \/&gt;/g, '<br />')
      .replace(/-&gt;/g, '->');
  }
  function w(e) {
  ...
  var x = ['html', 'css', 'js'],
    A = x.reduce(function(e, t) {
      return (e[t] = { lines: [], solution: null, widgets: [] }), e;
    }, {}),
    k = 0;
  ...
  (function() {
    ...
    (n.prototype.storeCallback = function(e) {
      ...
      return (this.postMessageCallbacks[t] = e), t;
    }),
      (n.prototype.postMessage = function(e, t) {
        (e.callbackId = this.storeCallback(t)), this.worker.postMessage(e);
      }),
      (n.prototype.handleOnmessage = function(e) {
        var t = e.data,
          n = this.postMessageCallbacks[t.callbackId];
        if ('function' != typeof n) throw 'Invalid callback onmessage';
        delete this.postMessageCallbacks[t.callbackId],
          delete t.callbackId,
          n(t);
      }),
      (window.foreman = { createWorker: s });
  })(),
  (function() {
    function e(e) {
      return Object.values(e).reduce(function(e, t) {
        return (e[t.contentType] = t.textOutput), e;
      }, {});
    }
    function t(t, n) {
    ...
    function s(e, s) {
      return { editorHash: t(s.toStore, e), errors: n(e), payload: e };
    }
    function i() {
    ...
    function a(e) {
      P > y
        ? alert("You're session expired. Refresh the page to continue")
        : AJAXUtil.post('/processor_jwts', '', function(t) {
            (window.__jwt = t.payload.jwt), (P += 1), e();
          });
    }
    function c(e) {
      if (!e.success) {
        var t = e.errors;
        if (t.auth_token_expired || t.auth_token_fail) return !0;
      }
      return !1;
    }
    function u(e, t) {
      ...
      for (var n in e) {
        ...
        if (e[n].logs) {
          for (var i = e[n].contentType, o = 0, r = s.length; o < r; o++)
            t.push({ line: s[o].line, message: s[o].message, type: i });
          t = t.concat();
        }
      }
      return t;
    ...
    function h(e) {
      Hub.pub('show-processing-logs', { logs: d(e) });
    }
    function p(e) {
      return e.js && 'buildRequired' === e.js.errorType
        ? e.js.packages.map(function(e) {
            return { built: e.built, name: e.name, version: e.version };
          })
        : [];
    }
    function f(e) {
      e.js &&
        CP.pen.js_module !== e.js.loadAsModule &&
        CP.pen.setItemValue({
          origin: 'client',
          pen: { js_module: e.js.loadAsModule }
        });
    }
    function _(e) {
      var t = p(e);
      (0 === CP.pen.npmPackagesBuilding.length && 0 === t.length) ||
        CP.pen.setItemValue({
          origin: 'client',
          pen: { npmPackagesBuilding: t }
        });
    }
    function g(e, t) {
      var n,
        o = new ProcessedPen(t);
      i()
        .then(function(e) {
          return (
            o.setProcessedValue('resources', e),
    ...
    function m(e) {
      return C.getProcessed(e) || '' === C.getProcessed(e)
        ? C.getProcessed(e)
        : '\ud83d\udc3b Bear with us while we compile your code to ' + e;
    }
    function v() {
      return b
        ? Promise.resolve(b)
        : foreman
            .createWorker(window.__path_to_processor_worker)
            .then(function(e) {
              b = e;
            });
    }
    var b,
      ...
      y = 100,
      P = 0;
    (CP.penProcessor = { getProcessed: m, process: g }), v();
  })(),
  (function() {
    function e(e, t, n) {
    ...
    function s(t, n, s) {
      if (('css' === t || 'js' === t) && s !== undefined) {
        var o = e(r[t], 'name', s);
        o > -1
          ? (r[t].splice(o, 1), r[t].unshift({ name: s, url: n }))
          : r[t].unshift({ name: s, url: n }),
...
var BunkerBox = {
    makeHeadSafe: function(e, t) {
      return (
        (e = e || ''),
        'public' === (t = this._getSafeSandboxType(t)) &&
          (e = e.replace(/<script.+/gim, '')),
    ...
    makeHTMLSafe: function(e, t) {
      return (
        ...
        (e = (e = (e = (e = e.replace(
          /(<.*?\s)(autofocus=("|')autofocus("|')|autofocus)/g,
          '$1'
        )).replace(/iframe.+src=.+(&#)/gim, '')).replace(
          /autoPlay=true/gim,
          'autoPlay=false'
        )).replace(/http-equiv="refresh"/gim, '')),
    ...
    makeJSSafe: function(e, t) {
      return (
        ...
        (t = this._getSafeSandboxType(t)),
        (e = (e = e.replace(
          /location\.replace\s*\(\s*\)/gim,
          'location.removedByCodePen()'
        )).replace(
          /location\.reload\s*\(\s*\)/gim,
          'location.removedByCodePen()'
        )),
        'public' === t &&
          (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace(
            'beforeunloadreplacedbycodepen'
          )).replace(/debugger(\s+)?;/gim, '')).replace(
            /alert/gim,
            ''
          )).replace(/geolocation/gim, '')).replace(
            /audiocontext/gim,
            ''
          )).replace(/getusermedia/gim, '')).replace(
            /initMouseEvent/gim,
            ''
          )).replace(/download/gim, '')).replace(/\.click\(/gim, '')).replace(
            /YT.Player/gim,
            'YT.CodePenRemovedPlayer'
          )),
        this._isSandboxSupported() ||
          (e = (e = (e = (e = (e = e.replace(
            /window(\s+)?\[(\s+)?("|")l/gim,
            ''
          )).replace(/self(\s+)?\[(\s+)?("|")loc/gim, '')).replace(
            /\.submit\(\)/gim,
            ''
          )).replace(/fromCharCode/gim, '')).replace(
            /\blocation(\s+)?=/gim,
            ''
          )),
        e
    ...
    _isSandboxSupported: function() {
      return (
        null === this._sandboxSupported &&
          (this._sandboxSupported = this._determineIfSandboxIsSupported()),
  ...
  IFramePenToHTML = {
    ...
    _getHeadAndCSS: function(e) {
      ...
      return (
        (t += '<head>'),
        (t +=
          "<script src='" + window.__path_to_console_runner_js + "'></script>"),
        (t +=
          "<script src='" + window.__path_to_live_reloader_js + "'></script>"),
        (t += "<meta charset='UTF-8'>"),
        (t += '<meta name="robots" content="noindex">'),
        (t +=
          '<link rel="shortcut icon" type="image/x-icon" href="' +
          window.__favicon_shortcut_icon +
          '" />'),
        (t +=
          '<link rel="mask-icon" type="" href="' +
          window.__favicon_mask_icon +
          '" color="#111" />'),
    ...
    _getCSSStarterStyles: function(e) {
      return 'normalize' === e.css_starter
        ? this._buildCSSLink(window.__pen_normalize_css_url)
        : 'reset' === e.css_starter
        ? this._buildCSSLink(window.__pen_reset_css_url)
        : '';
    },
    _getPrefixesStyles: function(e) {
      return 'prefixfree' === e.css_prefix
        ? this._buildScriptLink(window.__pen_prefix_free_url)
        : '';
    },
    ...
    _getStylesToAddToHead: function(e) {
      return _.reduce(
        ...
        function(e, t) {
          return (
            'include_css_url' === t.action
              ? (e += this._getIncludeCSSURL(t))
              : 'prepend_as_css' === t.action &&
                (e += '\n<style>\n' + t.content + '\n</style>'),
            e
          );
        },
    ...
    _getIncludeCSSURLHref: function(e) {
      return this._urlRefersToPenURL(e.url)
        ? this._ensureEndsInDotType(e.url, 'css')
        : e.url;
    },
    _getJS: function(e) {
    ...
    _getJSScripts: function(e) {
      var t = '';
      return (
        this._includeStopExecutionScript(e) &&
          (t +=
            "<script src='" +
            __path_to_stop_execution_on_timeout +
            "'></script>"),
    ...
    _getPenResourcesAsScripts: function(e) {
      return _.reduce(
        ...
        function(e, t) {
          return (
            'include_js_url' === t.action
              ? (e +=
                  "<script src='" +
                  this._getIncludeJSURLHref(t) +
                  "'></script>")
              : 'prepend_as_js' === t.action &&
    ...
    _getIncludeJSURLHref: function(e) {
      return this._urlRefersToPenURL(e.url)
        ? this._ensureEndsInDotType(e.url, 'js')
        : e.url;
    },
    ...
    _ensureEndsInDotType: function(e, t) {
      var n = (e || '').split('?');
      return new RegExp('.' + t, 'i').exec(n[0])
        ? e
        : ((n[0] = this._removeTraingForwardSlash(n[0]) + '.' + t),
          n.join('?'));
    },
  ...
  (function() {
    ...
    function a(e) {
      return (
        ...
        "' src='" +
        c(e) +
        "' name='CodePen' allowfullscreen='true' sandbox='" +
        o() +
        "' allow='" +
        r() +
        "' allowTransparency='true' allowpaymentrequest='true' class='result-iframe iframe-visual-update' ></iframe>"
      );
    }
    function c(e) {
      return _.template(u(), {
    ...
    function d(e, t, n) {
      AJAXUtil.post(_fullURL('/boomerang'), { key: e, html: t }, n);
    }
    function h(e, t) {
      var n = l();
    ...
    var p = 300;
    window.IFrameRender = { updateIFramePreview: h };
  })(),
  (function() {
    function e(e) {
    ...
    function s(e) {
      for (
        var t = f.split(/\r\n?|\n/), n = e;
        n > -1 && t[n].match(/(break;|shouldStopExecution)/);
    ...
    function i(e) {
      return (
        'Infinite loop found on line ' +
        e +
        '. The line number is approximated so look carefully.'
      );
    }
    function o(e) {
      if (null === y) return (y = _.cloneDeep(e, !0)), void d(e);
      if (r(e))
        try {
          l(e);
        } catch (t) {
    ...
    function r(e) {
      ...
      var t = u(e, y);
      return (y = _.clone(e, !0)), t;
    }
    function a(e) {
      return (
        !!c(e) ||
        (e.css || '').match(/(keyframes|:target|animation|CP_DoFullRefresh)/gi)
      );
    }
    function c(e) {
      var t = e.html || '',
    ...
    function l(e) {
      for (
        var t = document.getElementsByClassName('result-iframe'), n = 0;
        n < t.length;
        n++
      ) {
        var s = { action: g, data: { css: e.css, head: e.head } };
        Hub.pub(g, s), t[n].contentWindow.postMessage(s, '*');
      }
    }
    function d(e) {
      clearTimeout(C),
    ...
    function h(e) {
      (f = IFramePenToHTML.renderPenAsHTML(e)),
        IFrameRender.updateIFramePreview(p, f).then(function(t) {
          var n = { action: m, data: { url: t, head: e.head } };
          Hub.pub(m, n);
        });
    }
    var p = $('#result_div, #result-box'),
      ...
      C = 0,
      y = null;
    t(), (window.PenToPreview = { updateLiveIFrame: o });
  })();
var PenRenderer = Class.extend({
    ...
    init: function() {
      this._bindToHub(),
        (this.processAndRender = _.debounce(
          this._processAndRenderInternal.bind(this),
          this.DEFAULT_TIMEOUT,
          { leading: !1, maxWait: this.MAX_TIMEOUT }
        )),
    ...
    _onPenChange: function(e, t) {
      CP.pen.getAttribute('editor_settings').auto_run &&
        this._penPreviewAttributeChanged(t.pen) &&
    ...
    _renderProcessedPen: function(e) {
      editorErrorHandler.canRenderPen(e.errors) &&
        ((this.renderablePen = e.processedPen.buildRenderableHash()),
  ...
  PenResources = Class.extend({
    ...
    processResourcesAndCallback: function(e, t) {
      ...
      this._canProcessResources() && n.length > 0
        ? this._postPenResources(e, t)
        : t(e.resources);
    },
    _findResourcesNeedingToBeProcess: function(e) {
      return HTMLTemplating.findHTMLTemplatesInPenHTML(e.html).concat(
        this._findResourcesThatNeedToBeProcessed(e.resources)
      );
    },
    ...
    _isURLResourceNeedingProcessing: function(e) {
      return (
        this._urlRefersToPenURL(e) ||
        this._urlRefersToCSSNeedingToBePreprocessed(e) ||
        this._urlRefersToJSNeedingToBePreprocessed(e)
      );
    },
    _urlRefersToPenURL: function(e) {
      return /\S+\/pen\/(\w{5,})/i.test(e);
    ...
    _urlRefersToCSSNeedingToBePreprocessed: function(e) {
      return _.contains(
        __preprocessors.css.preprocessors,
        this._getExtension(e)
      );
    },
    _urlRefersToJSNeedingToBePreprocessed: function(e) {
      return _.contains(
        __preprocessors.js.preprocessors,
        this._getExtension(e)
      );
    },
    ...
    _postPenResources: function(e, t) {
      var n = '/process_resources',
        s = { pen: JSON.stringify(this._getProcessResourcesParams(e)) };
      this.post(
        n,
        s,
        $.proxy(function(e) {
  ...
  ProcessedPen = Class.extend({
    ...
    updateAfterProcessing: function(e, t) {
      this._updateLastSentAttributes(e), this._setProcessedValue(t);
    },
    _setProcessedValue: function(e) {
      constants.editorTypes.forEach(
        function(t) {
    ...
    _cssPreprocessorData: function() {
      ...
      return (
        ...
        (e.textInput = this._mergeCSSWithProcessedResources(
          CP.pen.css,
          this.processed.resources
        )),
        ('scss' !== e.syntax && 'sass' != e.syntax) ||
          (e.version = this._determineSassVersion(e.textInput)),
        'autoprefixer' === CP.pen.css_prefix &&
          (e.options[CP.pen.css_prefix] = !0),
        e
      );
    },
    ...
    _determineSassVersion: function(e) {
      ...
      return /@import\s+('|")?compass('|")?/i.test(t)
        ? this.SASS_WITH_COMPASS
        : 'default';
    },
    _jsPreprocessorData: function() {
      ...
      return Object.assign({}, e, {
        ...
        syntax: CP.pen.js_pre_processor,
        textInput: this._mergeJSWithProcessedResources(
          CP.pen.js,
          this.processed.resources
        )
      });
    ...
    _getJSProcessorOptions: function() {
      ...
      return window.__feature_npm_enabled
        ? Object.assign({}, e, {
    ...
    _getGuardInfiniteLoops: function() {
      var e = CP.pen.js || '';
      return !window.__preprocessors.js.words_we_cannot_instrument.find(
        function(t) {
    ...
    _getJSPresets: function() {
      return CP.pen.js_pre_processor === BABEL
        ? BABEL_PRESETS
        : 'none' === CP.pen.js_pre_processor
        ? BABEL_PRESETS_NONE
        : [];
    ...
    _baseProcessorData: function(e) {
      return { id: e, version: 'default', options: {} };
    },
    ...
    _shouldProcessPayloadType: function(e) {
      return (
        !!e.textInput &&
        (('none' !== e.syntax || 'html' !== e.contentType) &&
          ('none' !== e.syntax ||
            'css' !== e.contentType ||
    ...
    _diff: function(e, t) {
      ...
      for (var o in t) {
        var r = e[o] || {},
          a = t[o];
        this._shouldProcessPayloadType(a)
          ? this._isEqual(i, a, r)
            ? (s[o] = a.textInput)
            : (n[o] = a)
          : (s[o] = a.textInput);
      }
      return { toSend: n, toStore: s };
    },
    _mergeHTMLWithProcessedResources: function(e) {
      return e
        ? HTMLTemplating.regexReplaceHTMLBeforeProcessing(
            e,
            this.processed.resources
          )
        : e;
    ...
    _getProcessedHTML: function() {
      return HTMLTemplating.regexReplaceHTMLAfterProcessing(
        this.processed.html,
        this.processed.resources
      );
    },
    ...
    _getStyles: function() {
      return this._getIncludesAndPrependToResources(
        this.processed.resources,
        'css'
      );
    },
    _getScripts: function() {
      var e = this._getIncludesAndPrependToResources(
        this.processed.resources,
        'js'
      );
    ...
    _getIncludesAndPrependToResources: function(e, t) {
      return _.sortBy(
        _.select(this._matchByURLAndMixin(e, t), function(e) {
          return (
            _isValidURL(e.url) &&
            (e.action === 'include_' + t + '_url' ||
              e.action === 'prepend_as_' + t)
          );
        }),
        'order'
      );
    ...
    _matchByURLAndMixin: function(e, t) {
      return _.map(
        this._selectRenderableResources(t),
        function(n) {
          var s = this._findMatchByURLAndResourceType(e, n);
          return s
            ? _.assign({}, s, n, { action: s.action, content: s.content })
  ...
  BaseSettingsEvents = Class.extend({
    ...
    _buildBasicData: function(e) {
      return { origin: 'client', pen: e };
    }
  }),
  BaseSettingsModel = Class.extend({ init: function() {} }),
  ...
  BehaviorEvents = BaseSettingsEvents.extend({
    ...
    _onServerPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.editor_settings') &&
        this._setItemValueFromServer(t);
    },
    _setAutoSave: function(e, t) {
      this._canDrive &&
        this._setItemValue(
          this._buildSettingsPenData('auto_save', t.is(':checked'))
        );
    },
    _setAutoRun: function(e, t) {
      this._canDrive &&
        this._setItemValue(
          this._buildSettingsPenData('auto_run', t.is(':checked'))
        );
    },
    _setIndentWith: function() {
      this._canDrive &&
        this._setItemValue(
          this._buildSettingsPenData(
            'indent_with',
            $("input[name='indent-with']:checked").val()
          )
        );
    },
    _onTabSizeChange: function(e, t) {
      this._canDrive &&
        this._setItemValue(
          this._buildSettingsPenData('tab_size', this._validTabSize(t.val()))
        );
    },
  ...
  BehaviorView = Class.extend({
    ...
    _handlePenChange: function(e) {
      ObjectUtil.hasNestedValue(e, 'editor_settings.auto_run') &&
        this._setAutoRun(e.editor_settings.auto_run),
        ObjectUtil.hasNestedValue(e, 'editor_settings.auto_save') &&
          this._setAutoSave(e.editor_settings.auto_save),
        ObjectUtil.hasNestedValue(e, 'editor_settings.indent_with') &&
          this._setIndentWith(e.editor_settings.indent_with),
        ObjectUtil.hasNestedValue(e, 'editor_settings.tab_size') &&
          this._setTabSize(e.editor_settings.tab_size);
    },
    _setAutoRun: function(e) {
      e
        ? (this.$autoRun.prop('checked', !0),
          this.$body.removeClass('show-run-button'))
        : (this.$autoRun.prop('checked', !1),
    ...
    _setIndentWith: function(e) {
      'tabs' === e
        ? (this.$indentWithTabs.prop('checked', !0),
          this.$indentWithSpaces.prop('checked', !1))
        : (this.$indentWithTabs.prop('checked', !1),
...
window.CSSSettingsEvents = BaseSettingsEvents.extend({
  ...
  _onServerUIChange: function(e, t) {
    ObjectUtil.hasNestedValue(t, 'ui.settings.css.addons') &&
      this.controller.syncWithServer(t);
  },
  _onServerPenChange: function(e, t) {
    (ObjectUtil.hasNestedValue(t, 'pen.css_pre_processor') ||
      ObjectUtil.hasNestedValue(t, 'pen.css_prefix') ||
      ObjectUtil.hasNestedValue(t, 'pen.css_starter')) &&
      this._setItemValueFromServer(t);
  },
  _selectPreProcessor: function(e, t) {
    this._canDrive &&
      (this._setItemValue({ css_pre_processor: t.val() }),
      this.controller.hideAddons({ origin: 'client' }));
  },
  _selectStartCSS: function(e, t) {
    this._canDrive && this._setItemValue({ css_starter: t.val() });
  },
  _selectCSSPrefix: function(e, t) {
    this._canDrive && this._setItemValue({ css_prefix: t.val() });
  },
  _getAllUIElements: function() {
    return [
      this.$cssPreProcessor,
      this.$starterCSS,
      this.$cssPrefix,
      this.$cssNeedAnAddon
    ];
  ...
  _onClickNeedAnAddonButton: function() {
    this._canDrive &&
      ('open' == CP.ui.settings.css.addons
        ? this.controller.hideAddons({ origin: 'client' })
        : this.controller.showAddons({ origin: 'client' }));
  }
});
var CSSSettingsModel = BaseSettingsModel.extend({
    ...
    _pubUIChange: function(e) {
      Hub.pub('ui-change', {
        origin: e.origin,
        ui: { settings: { css: { addons: CP.ui.settings.css.addons } } }
      });
    }
  }),
  CSSSettingsView = BaseSettingsView.extend({
    ...
    _updateUI: function(e) {
      ObjectUtil.hasNestedValue(e, 'css_pre_processor') &&
        this._setPreProcessor(e),
        ObjectUtil.hasNestedValue(e, 'css_starter') &&
          this._selectCSSStarter(e),
        ObjectUtil.hasNestedValue(e, 'css_prefix') && this._selectCSSPrefix(e);
    },
    _onUIChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'ui.settings.css.addons') &&
        this._updateAddons(t.ui.settings.css.addons);
    },
    ...
    _addClassesToBoxCSS: function(e) {
      this.$boxCSSEl.data(
        'preprocessor',
        __preprocessors.css.pretty_syntaxes[e.css_pre_processor]
      ),
        this.$boxCSSEl
          .removeClass(__preprocessors.css.syntaxes.join(' '))
          .removeClass(__preprocessors.css.prefixes.join(' '))
          .addClass(e.css_pre_processor),
        $('.css-editor-title')
          .removeClass(__preprocessors.css.syntaxes.join(' '))
          .removeClass(__preprocessors.css.prefixes.join(' '))
          .addClass(e.css_pre_processor);
    ...
    _updateAddons: function(e) {
      'open' === e
        ? this.$addOns.removeClass('hide')
        : this.$addOns.addClass('hide');
    },
    _selectCSSStarter: function(e) {
      $("#startercss-options-form input[value='" + e.css_starter + "']").prop(
        'checked',
        !0
      );
    },
    _selectCSSPrefix: function(e) {
      $("#prefix-options-form input[value='" + e.css_prefix + "']").prop(
        'checked',
        !0
      ),
    ...
    _filterAddOns: function() {
      ...
      if ('' !== e) {
        ...
        for (var t = 0; t < this.$addOnItems.length; t++)
          if (
            this.$addOnItems[t].innerHTML.indexOf(e) > -1 &&
            ($(this.$addOnItems[t]).show(),
  ...
  HTMLSettingsEvents = BaseSettingsEvents.extend({
    ...
    _onServerPenChange: function(e, t) {
      (ObjectUtil.hasNestedValue(t, 'pen.html_pre_processor') ||
        ObjectUtil.hasNestedValue(t, 'pen.head') ||
        ObjectUtil.hasNestedValue(t, 'pen.html_classes')) &&
        this._setItemValueFromServer(t);
    },
    _selectPreProcessor: function(e, t) {
      this._canDrive && this._setItemValue({ html_pre_processor: t.val() });
    },
    _setHead: function(e, t) {
      this._canDrive && this._setItemValue({ head: t.val() });
    },
    _setHTMLClasses: function(e, t) {
      this._canDrive && this._setItemValue({ html_classes: t.val() });
    },
    _addCommonMetaTag: function() {
      this._canDrive &&
        this._setItemValue({ head: this._getHeadWithMetaTag() });
    },
  ...
  HTMLSettingsView = BaseSettingsView.extend({
    ...
    _updateUI: function(e) {
      ObjectUtil.hasNestedValue(e, 'html_pre_processor') &&
        this._setPreProcessor(e.html_pre_processor),
        ObjectUtil.hasNestedValue(e, 'head') && this._setHead(e.head),
        ObjectUtil.hasNestedValue(e, 'html_classes') &&
          this._setHTMLClasses(e.html_classes);
    },
    _setHead: function(e) {
      this.$head.val() !== e && this.$head.val(e),
        -1 !== e.indexOf('http://')
          ? this.$headWrapper.addClass('insecure-resource')
          : this.$headWrapper.removeClass('insecure-resource');
    },
    ...
    _addClassBoxHTML: function(e) {
      this.$boxHTML.data(
        'preprocessor',
        __preprocessors.html.pretty_syntaxes[e]
      ),
        this.$boxHTML
          .removeClass(__preprocessors.html.syntaxes.join(' '))
          .addClass(e),
        $('.html-editor-title')
          .removeClass(__preprocessors.html.syntaxes.join(' '))
          .addClass(e);
  ...
  InfoEvents = Class.extend({
    ...
    _setTitle: function() {
      CP.item.setItemValue({
        origin: 'client',
        item: { title: this.$title.val() }
      });
    },
    _setDescription: function() {
      CP.item.setItemValue({
        origin: 'client',
        item: { description: this.$description.val() }
      });
    },
    _setPrivacy: function() {
      CP.item.setItemValue({
        origin: 'client',
        item: { private: this.$privateCkbx.is(':checked') }
      });
    },
    _setPasswordUsage: function() {
      CP.item.setItemValue({
        origin: 'client',
        item: { password_used: this.$passwordCkbx.is(':checked') }
      });
    },
    _setTemplate: function() {
      CP.item.setItemValue({
        origin: 'client',
        item: { template: this.$templateCkbx.is(':checked') }
      });
    }
  }),
  InfoView = Class.extend({
    ...
    _onPenChange: function(e, t) {
      this._showPenHasUnsavedChanges(),
        ...
        ObjectUtil.hasNestedValue(t, 'pen.private') &&
          this._togglePasswordArea(t),
        ObjectUtil.hasNestedValue(t, 'pen.password_used') &&
          this._togglePasswordInput(t),
    ...
    _togglePasswordArea: function(e) {
      e.pen['private']
        ? this.$passwordArea.removeClass('hide')
        : this.$passwordArea.addClass('hide');
    },
    ...
    _updateTemplate: function(e) {
      this.$templateCkbx.is(':checked') !== e.pen.template &&
        this.$templateCkbx.attr('checked', e.pen.template);
    },
    ...
    _onPenSaved: function(e, t) {
      this._isNewPenInProfessorOrCollab(t)
        ? $.showMessage(_.template(Copy.penForked, t), 8e3)
        : (this._hidePenHasUnsavedChanges(),
  ...
  JSSettingsEvents = BaseSettingsEvents.extend({
    ...
    _onServerPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'item.js_pre_processor') &&
        this._setItemValueFromServer(t);
    },
    _selectPreProcessor: function(e, t) {
      this._canDrive && this._setItemValue({ js_pre_processor: t.val() });
    },
    _getAllUIElements: function() {
  ...
  JSSettingsView = BaseSettingsView.extend({
    ...
    _updateUI: function(e) {
      ObjectUtil.hasNestedValue(e, 'js_pre_processor') &&
        this._setPreProcessor(e.js_pre_processor),
        ObjectUtil.hasNestedValue(e, 'npm_packages') &&
          this._setDisabledPreprocessorSelect(e.npm_packages);
    },
    ...
    _addProcessorClassBoxJS: function(e) {
      this.$boxJS.data('preprocessor', __preprocessors.js.pretty_syntaxes[e]),
        this.$boxJS
          .removeClass(__preprocessors.js.syntaxes.join(' '))
          .addClass(e),
        $('.js-editor-title')
          .removeClass(__preprocessors.js.syntaxes.join(' '))
          .addClass(e);
  ...
  npmSettingsEvents = BaseSettingsEvents.extend({
    ...
    _bindToDOM: function() {
      $('#npm-packages').on(
        'click',
        '.remove-npm-package',
        this._handleRemovePackageClick.bind(this)
      );
    },
    _bindToHub: function() {
    ...
    _onServerPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'item.packages') &&
        this._setItemValueFromServer(t);
    },
    _handleRemovePackageClick: function(e) {
      ...
      var t = $(e.target)
        .closest('.npm-row')
        .data('name');
      return this.controller.removePackage(t), !1;
    },
            ...
            templates: {
              suggestion: function(e) {
                return (
                  ...
                  $.fn.autocomplete.escapeHighlightedString(
                    e._highlightResult.name.value
                  ) +
                  "</div><div class='package-description'>" +
                  $.fn.autocomplete.escapeHighlightedString(e.description) +
                  "</div><div class='package-version'>" +
                  $.fn.autocomplete.escapeHighlightedString(e.version) +
                  '</div>'
                );
              },
  ...
  npmSettingsView = BaseSettingsView.extend({
    ...
    init: function() {
      this._super(),
        ...
        (this._templateHTML = document.querySelector(
    ...
    _onPenChange: function(e, t) {
      ObjectUtil.hasNestedValue(t, 'pen.npm_packages') &&
        this._updatePackagesUI(t.pen.npm_packages),
        ObjectUtil.hasNestedValue(t.pen, 'js_pre_processor') &&
          this._setStateOfTab(t.pen.js_pre_processor);
    },
    _setStateOfTab: function(e) {
      'none' === e || 'babel' === e
        ? this.$settingsTab.removeClass('npm-settings-disabled')
        : this.$settingsTab.addClass('npm-settings-disabled');
    },
...
(window.ResourcesEvents = Class.extend({
  ...
  _bindToDOM: function() {
    $('#add-' + this.type + '-resource')._on(
      'click',
      this._onAddResourceClick,
      this
    ),
      $('#' + this.type + '-external-resources')
        .on(
          'click',
          '.remove-external-url',
          $.proxy(this._onDeleteResource, this)
        )
        .on(
          'keydown',
          this._getResourcesSelector(),
          $.proxy(this._onChangeResource, this)
        )
        .on(
          'change',
          this._getResourcesSelector(),
      ...
      window.__mobile ||
        (this._makeResourcesSortable(),
        (this.$searchInput = $('#external-' + this.type + '-search')));
  },
  _getResourcesSelector: function() {
    return (
      'input.' + this.type + "-resource[name='external-" + this.type + "']"
    );
  },
  _bindToHub: function() {
    Hub.sub('server-pen-change', $.proxy(this._onServerPenChange, this));
  ...
  _onServerPenChange: function(e, t) {
    ObjectUtil.hasNestedValue(t, 'pen.resources') &&
      this.controller.setItemValueFromServer(t);
  },
  ...
  _updateResourcesOrder: function() {
    this._canDrive &&
      this.controller.updateResourcesOrder(
        this.type,
        this._getViewIDsToOrders()
      );
  },
  _checkResourcesSecurity: function(e) {
    var t = $('#external-resource-input-' + e),
      n = t.closest('.external-resource-url-row');
    'http:' === t.val().substr(0, 5)
      ? n.addClass('insecure-resource')
      : n.removeClass('insecure-resource'),
      CP.HelpFlyouts.init();
  },
  _getViewIDsToOrders: function() {
    return _.reduce(
      this._getInputsByType(),
      function(e, t, n) {
  ...
  _getInputsByType: function() {
    return _.select($('#' + this.type + '-external-resources input'), function(
      e
    ) {
      return $(e).attr('id');
    });
  ...
  _onChangeResource: function(e) {
    if (this._canDrive) {
      ...
      this.controller.setResource(t, $(e.target).val()),
        $('.open-external-url[data-view-id=' + t + ']').attr(
          'href',
          $(e.target).val()
        ),
  ...
  _onDeleteResource: function(e) {
    return (
      e.preventDefault(),
      this._canDrive &&
        (this.controller.deleteResource(this._getElementViewID(e.target)),
        this._updateResourcesOrder()),
      !1
    );
  },
  ...
  (window.ResourcesView = Class.extend({
    ...
    _initDOM: function() {
      (this.$resources = $('#' + this.type + '-external-resources')),
        ...
        this._appendRecentResourcesToUI(
          CP.PenRecentResourcesManager.getRecentPenResources(this.type)
        );
    },
    _bindToHub: function() {
      Hub.sub('pen-change', $.proxy(this._onPenChange, this));
    ...
    _syncNumberOfDOMElementsWithResources: function(e) {
      ...
      else if (n < 0) for (n *= -1; n--; ) $(t.last()).remove();
    },
    _syncTheDOMValuesWithResources: function(e) {
      _.forEach(
        this._getExistingExternalsDivs(),
        function(t, n) {
          t = $(t);
          var s = e[n];
          if (s.view_id === t.attr('data-view-id')) {
            $('#external-resource-input-view-link-' + s.view_id).attr(
              'href',
              s.url
            );
    ...
    _divHTML: function(e, t) {
      return _.template(this._getTemplate(), {
        url: e.url,
        insecure_resource:
          'http:' === e.url.substr(0, 5) ? 'insecure-resource' : '',
        view_id: e.view_id,
    ...
    _getTemplate: function() {
      return (
        '' === this._template &&
          (this._template = $(
            '#' + this.type + '-external-resources-template'
          ).html()),
        this._template
      );
    },
    _getPlaceholderForInput: function(e, t) {
      return t % 2 == 0
        ? 'css' === e
          ? 'https://yourwebsite.com/style.css'
...
var SearchFilter = {
  ...
  _onSearchChange: function(e, t) {
    ...
    '' === n
      ? $('.single-asset').removeClass('hide')
      : ($('.single-asset').addClass('hide'),
        $(".single-asset[data-searchable-name*='" + n + "']")
          .closest('.single-asset')
          .removeClass('hide'));
  }
};
!(function() {
  ...
  function n(n, s, i) {
    t(e(n, s), n, function(e, t) {
      i(
        'success' === t
          ? { success: !0, file: n, fileName: s }
          : { success: !1, file: n, error: t.text }
      );
    });
  }
  function s(e, t, n) {
...
var ScreenshotUpload = {
  ...
  bindUIActions: function() {
    ...
    (this.uploading = this.screenshotWrap.find('.uploading-message')),
      ...
      this.theBody._on('dragover', function(e) {
        e.currentTarget === ScreenshotUpload.theBody[0] &&
          ScreenshotUpload.testIfContainsFiles(e) &&
          ScreenshotUpload.highlightDropArea();
      }),
      ...
      this.screenshotWrap.on('click', '#delete-screenshot', function(t) {
        t.preventDefault(),
          $.showModal(
            '/ajax/confirm_custom_screenshot_delete',
            'modal-warning',
            function() {
  ...
  processFile: function(e) {
    ...
    if (t.type.match('image.*')) {
      ...
      this.readImage(t, function(e) {
        'string' != typeof e
          ? $.showMessage("Oops! We couldn't upload that image. Try again.")
          : (n._showSavingMessage(), n._signScreenshotAndUpload(e, t));
      });
    } else
  ...
  _showSavedMessage: function() {
    $.showMessage(
      'Pen Screenshot is saved. It may take a minute to update everywhere.'
    );
  },
  ...
  dataURItoBlob: function(e) {
    for (
      ...
      s[i] = t.charCodeAt(i);
    return new Blob([n], { type: 'image/jpeg' });
  },
  ...
  saveScreenshot: function(e) {
    var t = this,
      n = { item_type: 'pen', item_id: CP.pen.slug_hash };
    null === CP.pen.custom_screenshot
      ? this.post('/custom_screenshot', n, function(n) {
          t._successfulUpdate(n, e);
        })
      : this.put('/custom_screenshot/' + CP.pen.custom_screenshot, n, function(
          n
        ) {
          t._successfulUpdate(n, e);
        });
  ...
  deleteScreenshot: function() {
    this.del(
      '/custom_screenshot/' + CP.pen.custom_screenshot,
      { item_type: 'pen', item_id: CP.pen.slug_hash },
      function(e) {
        $.hideModal(),
  ...
  _showUploadingMessage: function(e) {
    e
      ? this.uploading.css({ opacity: 1, visibility: 'visible' })
      : this.uploading.css({ opacity: 0, visibility: 'hidden' });
  }
};
...
!(function() {
  ...
  function r(e) {
    if (b.length) {
      ...
      $('#edit-settings').length & !t &&
        (t = $('#edit-settings')[0].contains(e.target)),
  ...
  function u(e, t) {
    (ObjectUtil.hasNestedValue(t, 'ui.settings.pane') ||
      ObjectUtil.hasNestedValue(t, 'ui.settings.tab')) &&
      p.syncWithServer(t);
  }
  function l() {
    p.hideSettingsPane();
  ...
  var p,
    f = $('button.settings-nub'),
    g = $('#settings-tabs'),
    m = $('#close-settings'),
    v = $('#popup-overlay'),
    b = $('#item-settings-modal'),
    C = $('.edit-details-reminder'),
    y = $('.edit-tags-reminder');
  (CP.SettingsEvents = {}),
  ...
  (function() {
    ...
    CP.SettingsModel = {
      ...
      getState: function() {
        return {
          ui: {
            settings: { pane: CP.ui.settings.pane, tab: CP.ui.settings.tab }
          }
        };
      },
      settingsPaneVisible: function() {
  ...
  (function() {
    ...
    function t(e, t) {
      ObjectUtil.hasNestedValue(t, 'ui.settings.pane') && n(t.ui.settings.pane),
        ObjectUtil.hasNestedValue(t, 'ui.settings.tab') &&
          ('details' === t.ui.settings.tab &&
            0 === $('.settings-tab-details').length &&
            (t.ui.settings.tab = 'html'),
          r(t.ui.settings));
    }
    function n(e) {
      'open' === e ? s() : i();
...
var PenTagsController = Class.extend({
  ...
  PenTagsEvents = Class.extend({
    ...
    _bindToDOM: function() {
      this.$body.on(
        'click',
        '#active-tags span span.tag-x',
        $.proxy(this._handleTagDelete, this)
      ),
  ...
  PenTagsModel = Class.extend({
    ...
    addNewTags: function(e) {
      CP.item.setItemValue({
        origin: 'client',
        pen: { newTags: this._validNewTags(e) }
      });
    },
    ...
    deleteTag: function(e) {
      CP.item.setItemValue({
        origin: 'client',
        action: 'delete-tag',
        pen: { tags: _.without(CP.pen.tags, e) }
      }),
        CP.item.setItemValue({
          origin: 'client',
          action: 'delete-tag',
          pen: { newTags: _.without(CP.pen.newTags, e) }
        });
    }
  }),
  PenTagsView = Class.extend({
    ...
    _onPenChange: function(e, t) {
      'pen' in t &&
        ('tags' in t.pen && this._updateActiveTagsHTML(this.model.getTags()),
        'newTags' in t.pen &&
          (this._updatePenTagsVal(t),
          this._updateActiveTagsHTML(this.model.getTags())));
    },
    ...
    _warnAboutTooManyTags: function(e) {
      e.length >= this.MAX_TAGS
        ? this.$maxTagsLabel.addClass('at-capacity')
        : this.$maxTagsLabel.removeClass('at-capacity');
    }
  }),
  ...
  ProjectTagsModel = Class.extend({
    ...
    addNewTags: function(e) {
      CP.item.setItemValue({
        origin: 'client',
        item: { newTags: this._validNewTags(e) }
      });
    },
    _validNewTags: function(e) {
      return _.uniq(
    ...
    deleteTag: function(e) {
      CP.item.setItemValue({
        origin: 'client',
        action: 'delete-tag',
        item: { tags: _.without(CP.item.tags, e) }
      }),
        CP.item.setItemValue({
          origin: 'client',
          action: 'delete-tag',
          item: { newTags: _.without(CP.item.newTags, e) }
        });
    }
  }),
  ProjectTagsView = Class.extend({
    ...
    _updateProjectTagsVal: function(e) {
      'delete-tag' === e.action &&
        this.$projectTags.val(e.project.newTags.join(','));
    },
    _warnAboutTooManyTags: function(e) {
      e.length >= this.MAX_TAGS
        ? this.$maxTagsLabel.addClass('at-capacity')
  ...
  ShareGist = Class.extend({
    ...
    _doneCreateGist: function(e) {
      if (
        (e.reauth &&
          $.showModal('/ajax/reauthenticate_github', 'modal-error', function() {
        ...
        var t = _.template(Copy.gistCreated, { url: e.url });
  ...
  ShareSMS = Class.extend({
    ...
    _bindToDOM: function() {
      $('body').on(
        'submit',
        '#send-to-phone-form',
        $.proxy(this.sendSMS, this)
      );
    },
    _loadSMSPhoneNumberFromCookie: function() {
      $.cookie('sms_phone_number') &&
        $('#send-to-phone').val($.cookie('sms_phone_number'));
    },
    sendSMS: function(e) {
      e.preventDefault(), $('#sms-send-button').prop('disabled', !0);
      var t = {
    ...
    _doneSendSMS: function(e) {
      this._clearSMSErrors(),
        ...
        $.showMessage(
          _.template(Copy.smsSentTo, { phone_number: e.phone_number }),
          'slow'
        );
    },
    _setSMSPhoneNumberCookie: function(e) {
      var t = { expires: 30, domain: document.location.host, path: '/' };
    ...
    _clearSMSErrors: function() {
      $('#sms-phone').removeClass('error'), $('.error-message').remove();
    }
  }),
      ...
      if ('anon' !== __user.username) {
        ...
        return (
          this.$downloadExportIFrame
            ? this.$downloadExportIFrame.attr('src', t)
            : (this.$downloadExportIFrame = $('<iframe>', {
...
var Copy = {
    autoSavingNow:
      "Autosave enabled. <a href='https://blog.codepen.io/documentation/editor/autosave/' target='_blank'>?</a>",
    penUpdated: 'Pen saved.',
    penForked:
      "We forked this Pen. It's saved to your account, but you can <a href='<%= url %>' target='_blank'>view it here.</a>",
    waitingForGist: 'Creating GitHub Gist. Please be patient and stay awesome.',
    gistCreated:
      "Thanks for staying awesome. <a href='<%= url %>' target='_blank'> Here's a link to your Gist.</a>",
    youHaveUnsavedChanges:
      'You have NOT saved your Pen. Stop and save if you want to keep your Pen.',
    youHaveUnsavedSettings:
      'You have unsaved settings changes, are you sure you want to leave without saving?',
    collectionSavedPenAdded:
      "Your Collection '<%= name %>' was created and this Pen was added to it. <a href='<%= url %>'>View Collection</a>.",
    penAddToCollection:
      "This Pen was added to the '<%= name %>' Collection. <a href='<%= url %>'>View Collection</a>.",
    smsSentTo: 'Text sent to phone <%= phone_number %>.',
    studentWatching: 'Student Watching',
    studentsWatching: 'Students Watching',
    unsubcribedFromCommentNotifications:
      "You've been unsubscribed from comments for this Pen",
    subscribedToCommentNotifications:
      "You've been subscribed to comments for this Pen",
    ...
    errors: {
      ...
      'unable-to-save-try-again':
        'Unable to save Pen. Trying again for the <%= time %> time. Please be patient.',
      'unable-to-save-ever':
        'Unable to save pen. Please contact support@codepen.io.',
      'disabled-cookies':
        'You will not be able to see live changes to a Pen while cookies are disabled',
      'pen-too-large':
        'This Pen is larger than the 1 megabyte limit. Try removing data from this Pen and trying again.'
    }
  },
  CPFactory = {
    buildDataObjects: function() {
      (CP.profiled = new Profiled()),
        ...
        'pen' === CP.item.itemType
          ? ((CP.pen = new Pen()),
            (CP.item = CP.pen),
            (CP.penSaver = new PenSaver()),
            (CP.penAutosave = new PenAutosave()),
            (CP.ui = UI.buildDefaultUIData()))
          : 'project' === CP.item.itemType &&
            ((CP.item = new Project()), (CP.ui = UI.buildDefaultUIData()));
    },
    ...
    _buildSettingsObjects: function() {
      (CP.htmlSettingsController = new HTMLSettingsController(CP.pen)),
        ...
        window.__feature_npm_enabled &&
          (CP.npmSettingsController = new npmSettingsController(CP.pen));
    },
...
var HandleIFrameClicks = {
    ...
    _cleanURL: function(e) {
      ...
      return (t = (t = (t = (t = this._sanitizeURL(t)).replace(
        /(java|vb)?script/gim,
        ''
      )).replace(/eval/gim, '')).split('?')[0]);
    },
    _getIFrameURLRemoved: function(e) {
      return e.replace(
        /http(s)?:\/\/(s\.)?codepen\.(dev|io)\/(boomerang\/\S+|\S+\/fullpage)\/\w+(\.html)?/m,
        ''
      );
    },
  ...
  TimeUtil = {
    countToString: function(e) {
      var t = { 1: 'first', 2: 'second', 3: 'third', 4: 'fourth', 5: 'fifth' };
      return e in t ? t[e] : e;
    }
  },
  TypesUtil = {
...
if (
  ((window.__CPTypesUtil = TypesUtil),
  (function() {
    function e(e) {
      if ('string' == typeof e) {
...
!(function() {
  ...
  function u() {
    oe || (Hub.pub('console-opened'), I.show(), b(), (oe = !0));
  }
  function l() {
    oe && (Hub.pub('console-closed'), I.hide(), (oe = !1));
  }
  function d(e) {
    Hub.pub('editor-sizes-change', { console: e });
  }
  function h() {
  ...
  function v() {
    (G = U.width()), (J = L.width()), (Y = F.outerWidth());
  }
  function b() {
    (K = ee = j.height()),
      (X = I.height()),
      ...
      Z ||
        (Z =
          I.find('.editor-resizer').outerHeight() +
          I.find('.powers').outerHeight());
  }
  function C() {
  ...
  function P() {
    if (oe) {
      var e = (X - Z) / (K - Z);
      (e = Math.min(1, e)), (X = Math.min(K, X)), c(e);
    }
  }
  function w(e, t, n) {
  ...
  function S() {
    'function' == typeof Comment.tweakCommentsSize &&
      Comment.tweakCommentsSize(),
      Hub.pub('editor-refresh', { delay: 0 });
    var e = {
      editor:
        'top' === CP.ui.layout
    ...
    oe && (e.console = ae), Hub.pub('editor-sizes-change', e);
  }
  function T() {
  ...
  function E(e, t, n) {
    if (CP.EditorLayout._canDrive) {
      var s = q - n.y;
      (s = Math.max(Z, s)), c(((s = Math.min(K, s)) - Z) / (K - Z)), x(n);
    }
  }
  function x(e) {
    if ('top' === CP.ui.layout) {
      var t = ee + e.y - X;
      t >= 0 ||
        ((Q = Math.min(W + t, Q)), U.height(Q), (K = Math.max(K, ee - t)));
    }
  }
  function A() {
    CP.EditorLayout._canDrive &&
      Hub.pub('editor-sizes-change', { console: ae });
  }
  function k() {
  ...
  (CP.EditorLayout.init = function() {
    ...
    (CP.EditorLayout.toggleConsole = function() {
      'closed' === CP.ui.editorSizes.console
        ? (Hub.pub('ui-console-opened'), this.openConsole())
        : this.closeConsole();
    }),
...
var ViewSwitcher = {
  ...
  changeLayout: function(e) {
    this.changeUILayout(e),
      $.cookie('__cp_layout', e, { expires: 30, path: '/' });
  },
  ...
  setUpDrawer: function() {
    ...
    $.get(e, function(e) {
      ...
      $.when(
        ...
        Comment.init(), Drawer.openDrawer();
      });
    });
  },
  onKey: function(e, t) {
...
Drawer.init(),
  (function() {
    ...
    function s() {
      if (!p) {
        var e = _.template(
          '<%= username %>/embed/mini/builder/<%= slugHash %>/',
          {
            username: CP.profiled.base_url,
            slugHash: CP.pen.getActiveSlugHash()
          }
        );
        $.when(AJAXUtil.get(e, {}, $.noop))
          .done(i)
          .fail(AJAXUtil.showStandardErrorMessage)
          .always(function() {
            p = !1;
          }),
          (p = !0);
  ...
  (function() {
    ...
    function i() {
      o.id &&
        CP.user.paid &&
        CP.user.ownsItem(o) &&
        (Hub.sub('pen-saved', n), Hub.sub(c, s), Hub.sub(u, s));
    }
    var o = window.__item,
      r = 0,
      a = 500,
    ...
    })(
      {
        ...
        3: [
          function(e, t, n) {
            (n.node = function(e) {
              return (
                e !== undefined && e instanceof HTMLElement && 1 === e.nodeType
              );
            }),
        ...
        5: [
          function(e, t) {
            function n(e, t) {
              ...
              for (
                var n = e.parentNode.querySelectorAll(t), s = 0;
                s < n.length;
                ++s
              )
                if (n[s] == e) return !0;
                ...
                h = (function(e) {
                  ...
                  return (
                    ...
                    (t.prototype.listenClick = function(e) {
                      var t = this;
                      this.listener = (0, d['default'])(e, 'click', function(
                        e
                      ) {
                        return t.onClick(e);
                      });
  ...
  (window.Assets = {
    ...
    _testIfContainsFiles: function(e) {
      return (
        !!e.dataTransfer.types && _.contains(e.dataTransfer.types, 'Files')
      );
    },
    ...
    processFile: function(e) {
      (this.numFiles = e.length),
        (this.errors = []),
        e.length > this.MAX_FILES
          ? this._showTooManyFilesMessage()
          : this._filesTooBig(e)
          ? this._showFileTooBigMessage()
          : this._filesHaveBadFileExtension(e)
          ? this._showBadFileExtensionMessage()
          : AssetsData.anyDuplicates(e)
          ? this._askUserIfTheyWantToOverwriteFiles(e)
          : this._signAssetsAndUpload(e, 'noduplicates');
    },
    _askUserIfTheyWantToOverwriteFiles: function(e) {
      var t = this;
      $.showModal(
        '/ajax/assets/overwrite_or_update_assets',
        'modal-error',
        function() {
    ...
    _signAssetsAndUpload: function(e, t) {
      ...
      for (var n = 0; n < e.length; n++) {
        ...
        a &&
          ('ovewrite' === t
            ? (o = a.id)
            : 'makeunique' === t && (r = AssetsData.buildUniqueName(a.name)));
        var c = this;
        S3.uploadAccountAssetFileToS3(s, r, function(e) {
          e.success
            ? c._doneUploadingAccountAssetToS3(e, o)
            : c._assetUploadFailed(e);
        });
      }
    },
    _doneUploadingAccountAssetToS3: function(e, t) {
      var n =
        t > 0
          ? '/uploaded_assets/account_asset/' + t
          : '/uploaded_assets/account_asset';
      AJAXUtil[t > 0 ? 'put' : 'post'](
        n,
        this._getAccountAssetPostParams(e.file, e.fileName),
        $.proxy(this._uploadComplete, this),
        $.proxy(this._assetUploadFailed, this)
      );
    },
  ...
  (window.Asset = Class.extend({
    ...
    save: function(e) {
      this.put(
        '/uploaded_assets/account_asset/' + this.id,
        { text: e, update_type: 'text', response_type: window.__pageType },
        this._doneSave
      );
    },
    ...
    delete: function(e) {
      var t = '/uploaded_assets/account_asset/' + this.id,
        n = this;
      this.del(t, { response_type: window.__pageType }, function(t) {
        n._doneDelete(t, e);
      });
    },
...
!(function() {
    ...
    for (var n in t)
      (e += '<li><h2>' + n + '</h2>'),
        t[n].forEach(function(t) {
          e +=
            '<span class="design-asset-copy-as" data-clipboard-text="' +
            t +
  ...
  (function() {
    ...
    function n() {
      $('#design-assets-header').on('click', function() {
        $('body').hasClass('layout-side') &&
          $('#design-modal-tabs').slideToggle();
      }),
  ...
  (function() {
    function e() {
      $('.design-asset-icon-list > li').each(function(e, t) {
        $(t)
          .attr('data-clipboard-text', $.trim(t.innerHTML))
          .addClass('design-asset-copy-as');
      });
    }
    (CP.IconPicker = {}),
  ...
  (function() {
    function e() {
      $('.design-asset-pattern-list > li').each(function(e, t) {
        $(t)
          .attr('data-clipboard-text', $(t).attr('style'))
          .addClass('design-asset-copy-as');
      });
    }
    (CP.PatternPicker = {}),
  ...
  (function() {
    function e() {
      t(
        'https://api.unsplash.com/photos/random/?count=' + i + '&client_id=' + o
      );
    }
    function t(e) {
      $.ajax({ url: e, type: 'GET' }).done(function(e) {
        s(e);
      });
    }
    function n() {
    ...
    function s(e) {
      for (
        var t, n = '', s = (t = e.results ? e.results : e).length - 1;
        s >= 0;
        s--
      )
        n += r(t[s]);
...
var MinipageAssets = {
  ...
  _openAssetsArea: function() {
    ...
    this.isAssetsReady
      ...
      : $.get('/ajax/assets/bin', function(t) {
  ...
  addAsExternalStylesheet: function(e, t) {
    CP.cssSettingsController.resourcesController.quickAddResource(
      'css',
      $(t)
        .closest('.single-asset')
        .data('asset-url')
  ...
  addAsExternalScript: function(e, t) {
    CP.jsSettingsController.resourcesController.quickAddResource(
      'js',
      $(t)
        .closest('.single-asset')
        .data('asset-url')
  ...
  deleteFile: function(e, t) {
    ...
    var n = this,
      s = $(t).data('asset-id');
    $.showModal(
      '/ajax/assets/confirm_asset_delete',
      'modal-warning',
      function() {
  ...
  _addNewAssetHTML: function(e) {
    var t,
      n = this;
    this._assetElExist(e)
      ? $('#asset-' + e.asset.id).slideUp(function() {
  ...
  _removeListItem: function(e) {
    ...
    0 === t.siblings().length &&
      t
        .parent()
        .append(
          "<li class='no-files'>There are no files of this type&nbsp;yet.</li>"
        ),
...
var TeamRoomNotifications = Class.extend({
  init: function(e, t) {
    (this.user = e),
      (this.rtData = t),
      (this._debouncedCanCollabOnTeam = _.debounce(
        this._showCanCollabOnTeamPenMessage,
        2500
      )),
      (this._debouncedCanCollabSingle = _.debounce(
        this._showCanCollabOnSingleUserMessage,
        2500
      )),
  ...
  _shouldJoinRoom: function(e) {
    return (
      'editor' === e.role &&
      e.pen.slugHash &&
      (this.user.current_team_id > 0 || !0 === this.user.paid)
    );
  },
  _onConnect: function() {
  ...
  _amCollabingOnPen: function(e) {
    this.user.id !== e.data.user.id
      ? this._debouncedCanCollabOnTeam(e)
      : this._debouncedCanCollabSingle(e);
  },
  ...
  _showCanCollabOnTeamPenMessage: function(e) {
    var t =
        "<%= name %> is also working on this pen. Try Collab Mode with your team member <a href='<%= url %>' target='_blank'>here</a>.",
      n = document.location.href.replace(/\/pen\//, '/collab/'),
      s = _.template(t, { name: e.data.user.name, url: n });
    $.showMessage(s, 'until-dismiss');
  },
  _showCanCollabOnSingleUserMessage: function(e) {
    var t =
        "Looks like this Pen is open in another window. You can use <a href='<%= url %>' target='_blank'>Collab mode</a> to make sure you don't override your work.",
      n = document.location.href.replace(/\/pen\//, '/collab/'),
      s = _.template(t, { name: e.data.user.name, url: n });
    $.showMessage(s, 'until-dismiss');
  },
...
'undefined' == typeof window.Copy && (window.Copy = {}),
  _.extend(window.Copy, {
    ...
    collectionSavedPenAdded:
      "Your Collection '<%= name %>' was created and this Pen was added to it. <a href='<%= url %>'>View collection</a>.",
    collectionCreated:
      "Your Collection '<%= name %>' was created. <a href='<%= url %>'>View collection</a>.",
  ...
  (function() {
    ...
    function r(e) {
      ...
      return (
        e.collection['private'] && (t = e.collection.slug_hash_private),
  ...
  (function() {
    ...
    function n(e) {
      return _.extend(e, { slug_hash: CP.collection.selectedPenSlugHash });
    }
    function s() {
      a({ private: d() });
    }
    ...
    (CP.collection = {}),
      ...
      (CP.collection.save = function(s) {
        CP.collection.VM.slug_hash.length > 0
          ? e(CP.collection.VM, s)
          : t(n(CP.collection.VM), s);
      });
  })(),
  (function() {
    function e(e, t) {
      CP.TextFormatter.put('/text_formatter/text', { text: e }, t);
    }
    (CP.TextFormatter = {}),
  ...
  (function() {
    function e() {
      O.on('click', '.edit-collection', s)
        .on('click', '#add-new-collection-button', n)
        .on('click', '#create-new-collection', n)
        .on('change', '.collection-choice', t)
        .on('submit', '#edit-collection-form', a)
        .on('submit', '#add-new-collection-form', a)
        .on('click', '#add-new-collection-form .ios-toggle', o)
        .on('click', '#edit-collection-form .ios-toggle', r),
        F.on('click', m);
    }
    function t(e) {
      v(e) === j && ((M = !0), i(b(e)));
    ...
    function m(e) {
      e && e.preventDefault(),
        V && (CP.hidePopupOverlay(), A.remove(), (V = !1));
    }
    function v(e) {
      return $(e.target)
        .find('option:selected')
    ...
    function y(e, t) {
      ...
      return (
        D || (n = M ? Copy.collectionSavedPenAdded : Copy.collectionCreated),
        _.template(n, {
          originalId: e,
          name: t.name,
    ...
    function P(e, t) {
      ...
      (CP.collection.selectedPenSlugHash = t),
        (n = e
          ? '/collections/' + e + '/edit?slug_hash=' + t
          : '/collections/new'),
        $.ajax({ url: n, success: c });
    }
    function w(e, t) {
    ...
    function T(e) {
      (!0 === e['private'] ? H : R).append(
        $('<option></option>')
          .attr('value', e.slug_hash)
          .text(e.name)
      ),
        I.val('__choose__');
    }
    ...
    function x() {
      CP.collection.VM['private'] &&
        U.prepend(
          "<span class='private-icon left'><svg class='icon-lock'><use xlink:href='#lock'></use></svg></span>"
        );
    }
    ...
    var A,
      ...
      O = $('body'),
      F = $('#popup-overlay'),
      H = $('.collection-options-public'),
      R = $('.collection-options-private'),
      L = $('#collection-name'),
      U = $('#collection-desc'),
      I = $('.collection-choice'),
      j = '__add__',
  ...
  (function() {
    ...
    function t() {
      $('#bsa-footer').length &&
        $.ajax({
          url:
            'https://srv.buysellads.com/ads/CKYDVK7U.json?callback=CPAdsinsertAd&forcenads=1&forwardedip=' +
            __remote_addr,
          dataType: 'jsonp'
        });
    }
