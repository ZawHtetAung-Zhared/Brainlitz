...
export class CalendarComponent implements OnInit {
  ...
  checkPermission() {
    ...
    if (this.permissionType != null) {
      this.calendarPermission = this.calendarPermission.filter(
        value => -1 !== this.permissionType.indexOf(value)
      );

      this.calendarDemo['createCalendar'] = this.calendarPermission.includes(
        'CREATECALENDAR'
      )
        ? 'CREATECALENDAR'
        : '';
      this.calendarDemo['addHoliday'] = this.calendarPermission.includes(
        'ADDHOLIDAY'
      )
        ? 'ADDHOLIDAY'
        : '';
      this.calendarDemo['editHoliday'] = this.calendarPermission.includes(
        'EDITHOLIDAY'
      )
        ? 'EDITHOLIDAY'
        : '';
      this.calendarDemo['deleteHoliday'] = this.calendarPermission.includes(
        'DELETEHOLIDAY'
      )
        ? 'DELETEHOLIDAY'
        : '';
  ...
  createCalendar(formData) {
    ...
    this._service
      .createHolidaysCalendar(this.regionID, this.locationID, dataObj)
      .subscribe(
        (res: any) => {
  ...
  editSingleCalendar(id) {
    ...
    //this.blockUI.start('Loading...');
    this._service.updateCalendar(this.calendarid, calendarObj).subscribe(
      (res: any) => {
        //this.blockUI.stop();
  ...
  getAllHolidaysCalendar(limit, skip) {
    //this.blockUI.start('Loading...');
    this._service.getAllHolidaysCalendar(this.regionID, limit, skip).subscribe(
      (res: any) => {
        setTimeout(() => {
  ...
  deleteCalendar(id) {
    ...
    this._service.deleteCalendar(id).subscribe(
      (res: any) => {
        console.log(res);
  ...
  getSingleCalendar(calendarId) {
    ...
    //this.blockUI.start('Loading...');
    this._service.getSingleCalendar(calendarId).subscribe(
      (res: any) => {
        //this.blockUI.stop();
  ...
  getAllHolidays() {
    this._service.getAllHolidays(this.regionID).subscribe(
      (res: any) => {
  ...
  editCalendar(content, id) {
    ...
    this._service.getSingleCalendar(id).subscribe((res: any) => {
  ...
  updateCalendar(formData) {
    ...
    //this.blockUI.start('Loading...');
    this.modalReference.close();
    this._service.updateSignleCalendar(this.editId, dataObj).subscribe(
      (res: any) => {
        console.log(res);
        //this.blockUI.stop();
  ...
  createHoliday() {
    ...
    this._service
      .createHolidays(this.regionID, this.locationID, object)
      .subscribe(
        (res: any) => {
          console.log(res);
          ...
          console.log(calendarObj);
          this._service.updateCalendar(this.currentID, calendarObj).subscribe(
            (res: any) => {
              console.log('res', res);
              this.model = {};
  ...
  editHolidays(id, content) {
    ...
    console.log(content);
    console.log(id);
    this._service.getSingleHoliday(id).subscribe((res: any) => {
  ...
  updateHolidays() {
    ...
    console.log('~calendarid~', this.calendarid);
    this._service
      .updateHoliday(this.model._id, this.locationID, object)
      .subscribe(
        (res: any) => {
          console.log(res);
          // this.holidayTemp.push(res.id);
  ...
  deleteHoliday(id) {
    ...
    this.modalReference.close();
    console.log('~calendarid~', this.calendarid);
    this._service.deleteHoliday(this.model._id, this.locationID).subscribe(
      (res: any) => {
        console.log(res);
        this.getSingleCalendar(this.currentID);
        this.model = {};
